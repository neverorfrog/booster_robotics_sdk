...
#ifndef _FAST_DDS_GENERATED_IMUSTATE_H_
#define _FAST_DDS_GENERATED_IMUSTATE_H_
...
#error Generated ImuState is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
#endif // GEN_API_VER
// ----------------------------------- Pub Sub Type -------------------------------------
...
#endif // _FAST_DDS_GENERATED_IMUSTATE_H_
