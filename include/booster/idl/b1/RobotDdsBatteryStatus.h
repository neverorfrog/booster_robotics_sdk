...
#ifndef _FAST_DDS_GENERATED_BOOSTER_MSG_ROBOTBATTERYSTATUS_H_
#define _FAST_DDS_GENERATED_BOOSTER_MSG_ROBOTBATTERYSTATUS_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(ROBOTBATTERYSTATUS_SOURCE)
#define ROBOTBATTERYSTATUS_DllAPI __declspec( dllexport )
#else
#define ROBOTBATTERYSTATUS_DllAPI __declspec( dllimport )
#endif // ROBOTBATTERYSTATUS_SOURCE
#else
#define ROBOTBATTERYSTATUS_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define ROBOTBATTERYSTATUS_DllAPI
#endif // _WIN32
...
/*!
 * @brief This class represents the structure RobotDdsBatteryStatus defined by the user in the IDL file.
...
public:
     ...
     * @param x Reference to the object booster::msg::RobotDdsBatteryStatus that will be copied.
     */
     ...
     * @param x booster::msg::RobotDdsBatteryStatus object to compare.
     */
    eProsima_user_DllExport bool operator ==(
            const RobotDdsBatteryStatus& x) const;
     ...
     */
    eProsima_user_DllExport void status_level(
            int32_t _status_level);
...
#endif // _FAST_DDS_GENERATED_BOOSTER_MSG_ROBOTBATTERYSTATUS_H_
