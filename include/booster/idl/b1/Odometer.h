...
#ifndef _FAST_DDS_GENERATED_BOOSTER_MSG_ODOMETER_H_
#define _FAST_DDS_GENERATED_BOOSTER_MSG_ODOMETER_H_
...
#error Generated Odometer is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
#endif // GEN_API_VER
...
/*!
 * @brief This class represents the structure Odometer defined by the user in the IDL file.
 * @ingroup Odometer
 */
...
public:
     ...
     * @param x Reference to the object booster::msg::Odometer that will be copied.
     */
     ...
     * @param x Reference to the object booster::msg::Odometer that will be copied.
     */
    eProsima_user_DllExport Odometer &operator=(
        const Odometer &x);
     ...
     * @param x booster::msg::Odometer object to compare.
     */
    eProsima_user_DllExport bool operator==(
        const Odometer &x) const;
...
#endif // _FAST_DDS_GENERATED_BOOSTER_MSG_ODOMETER_H_
