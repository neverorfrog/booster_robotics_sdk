...
/*!
 * @brief This class represents the structure MagneticField defined by the user in the
 * IDL file.
...
class MagneticField : public eprosima::fastdds::dds::TopicDataType {
 public:
   ...
   */
  eProsima_user_DllExport MagneticField(const MagneticField& x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object sensor_msgs::msg::MagneticField that will be copied.
   */
  eProsima_user_DllExport MagneticField(MagneticField&& x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object sensor_msgs::msg::MagneticField that will be copied.
   */
  eProsima_user_DllExport MagneticField& operator=(const MagneticField& x);

  /*!
   * @brief Move assignment.
   * @param x Reference to the object sensor_msgs::msg::MagneticField that will be copied.
   */
  eProsima_user_DllExport MagneticField& operator=(MagneticField&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x sensor_msgs::msg::MagneticField object to compare.
   */
  eProsima_user_DllExport bool operator==(const MagneticField& x) const;
   ...
   */
  eProsima_user_DllExport void magnetic_field(geometry_msgs::msg::Vector3&& _magnetic_field);
  ...
  eProsima_user_DllExport void magnetic_field_covariance(
      const double__9& _magnetic_field_covariance);
   ...
   */
  eProsima_user_DllExport void magnetic_field_covariance(double__9&& _magnetic_field_covariance);
   ...
   */
  eProsima_user_DllExport const double__9& magnetic_field_covariance() const;
   ...
   */
  eProsima_user_DllExport double__9& magnetic_field_covariance();

 private:
  std_msgs::msg::Header m_header;
  geometry_msgs::msg::Vector3 m_magnetic_field;
  double__9 m_magnetic_field_covariance;
 ...
 public:
  ...
  eProsima_user_DllExport ~MagneticField() override;
