...
/*!
 * @brief This class represents the structure PointCloud defined by the user in the
 * IDL file.
 * @ingroup PointCloud
 */
class PointCloud : public eprosima::fastdds::dds::TopicDataType {
 public:
   ...
   * @param x Reference to the object sensor_msgs::msg::PointCloud that will be copied.
   */
  eProsima_user_DllExport PointCloud(PointCloud&& x) noexcept;
   ...
   * @param x Reference to the object sensor_msgs::msg::PointCloud that will be copied.
   */
  eProsima_user_DllExport PointCloud& operator=(PointCloud&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x sensor_msgs::msg::PointCloud object to compare.
   */
  eProsima_user_DllExport bool operator==(const PointCloud& x) const;
 ...
 public:
  ...
  eProsima_user_DllExport ~PointCloud() override;
