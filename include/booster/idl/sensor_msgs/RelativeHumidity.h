...
/*!
 * @brief This class represents the structure RelativeHumidity defined by the user in the
 * IDL file.
...
class RelativeHumidity : public eprosima::fastdds::dds::TopicDataType {
 public:
   ...
   */
  eProsima_user_DllExport RelativeHumidity(const RelativeHumidity& x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object sensor_msgs::msg::RelativeHumidity that will be copied.
   */
  eProsima_user_DllExport RelativeHumidity(RelativeHumidity&& x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object sensor_msgs::msg::RelativeHumidity that will be copied.
   */
  eProsima_user_DllExport RelativeHumidity& operator=(const RelativeHumidity& x);

  /*!
   * @brief Move assignment.
   * @param x Reference to the object sensor_msgs::msg::RelativeHumidity that will be copied.
   */
  eProsima_user_DllExport RelativeHumidity& operator=(RelativeHumidity&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x sensor_msgs::msg::RelativeHumidity object to compare.
   */
  eProsima_user_DllExport bool operator==(const RelativeHumidity& x) const;
   ...
   */
  eProsima_user_DllExport void relative_humidity(double _relative_humidity);
   ...
   */
  eProsima_user_DllExport void variance(double _variance);
 ...
 public:
  ...
  eProsima_user_DllExport ~RelativeHumidity() override;
