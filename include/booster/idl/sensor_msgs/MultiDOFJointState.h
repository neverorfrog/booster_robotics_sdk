...
/*!
 * @brief This class represents the structure MultiDOFJointState defined by the user in the
 * IDL file.
...
class MultiDOFJointState : public eprosima::fastdds::dds::TopicDataType {
 public:
   ...
   */
  eProsima_user_DllExport MultiDOFJointState(const MultiDOFJointState& x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object sensor_msgs::msg::MultiDOFJointState that will be copied.
   */
  eProsima_user_DllExport MultiDOFJointState(MultiDOFJointState&& x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object sensor_msgs::msg::MultiDOFJointState that will be copied.
   */
  eProsima_user_DllExport MultiDOFJointState& operator=(const MultiDOFJointState& x);

  /*!
   * @brief Move assignment.
   * @param x Reference to the object sensor_msgs::msg::MultiDOFJointState that will be copied.
   */
  eProsima_user_DllExport MultiDOFJointState& operator=(MultiDOFJointState&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x sensor_msgs::msg::MultiDOFJointState object to compare.
   */
  eProsima_user_DllExport bool operator==(const MultiDOFJointState& x) const;
 ...
 public:
  ...
  eProsima_user_DllExport ~MultiDOFJointState() override;
