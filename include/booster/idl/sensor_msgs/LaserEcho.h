...
/*!
 * @brief This class represents the structure LaserEcho defined by the user in the
 * IDL file.
 * @ingroup LaserEcho
 */
class LaserEcho : public eprosima::fastdds::dds::TopicDataType {
 public:
   ...
   */
  eProsima_user_DllExport LaserEcho(const LaserEcho& x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object sensor_msgs::msg::LaserEcho that will be copied.
   */
  eProsima_user_DllExport LaserEcho(LaserEcho&& x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object sensor_msgs::msg::LaserEcho that will be copied.
   */
  eProsima_user_DllExport LaserEcho& operator=(const LaserEcho& x);

  /*!
   * @brief Move assignment.
   * @param x Reference to the object sensor_msgs::msg::LaserEcho that will be copied.
   */
  eProsima_user_DllExport LaserEcho& operator=(LaserEcho&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x sensor_msgs::msg::LaserEcho object to compare.
   */
  eProsima_user_DllExport bool operator==(const LaserEcho& x) const;
 ...
 public:
  ...
  eProsima_user_DllExport ~LaserEcho() override;
