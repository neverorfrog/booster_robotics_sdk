...
/*!
 * @brief This class represents the structure Temperature defined by the user in the
 * IDL file.
 * @ingroup Temperature
 */
class Temperature : public eprosima::fastdds::dds::TopicDataType {
 public:
   ...
   * @param x Reference to the object sensor_msgs::msg::Temperature that will be copied.
   */
  eProsima_user_DllExport Temperature(Temperature&& x) noexcept;
   ...
   * @param x Reference to the object sensor_msgs::msg::Temperature that will be copied.
   */
  eProsima_user_DllExport Temperature& operator=(Temperature&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x sensor_msgs::msg::Temperature object to compare.
   */
  eProsima_user_DllExport bool operator==(const Temperature& x) const;
   ...
   */
  eProsima_user_DllExport void temperature(double _temperature);
 ...
 public:
  ...
  eProsima_user_DllExport ~Temperature() override;
