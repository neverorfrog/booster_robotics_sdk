...
#ifndef _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_GETDOAANGLEREQUEST_H_
#define _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_GETDOAANGLEREQUEST_H_
...
#error \
    Generated GetDoaAngleRequest is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(GETDOAANGLEREQUEST_SOURCE)
#define GETDOAANGLEREQUEST_DllAPI __declspec(dllexport)
#else
#define GETDOAANGLEREQUEST_DllAPI __declspec(dllimport)
#endif  // GETDOAANGLEREQUEST_SOURCE
#else
#define GETDOAANGLEREQUEST_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define GETDOAANGLEREQUEST_DllAPI
#endif  // _WIN32
...
/*!
 * @brief This class represents the structure GetDoaAngleRequest defined by the
 * user in the IDL file.
 * @ingroup GetDoaAngleRequest
 */
class GetDoaAngleRequest : public booster_eprosima::fastdds::dds::TopicDataType {
 public:
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object booster_msgs::audio::GetDoaAngleRequest
   * that will be copied.
   */
  eProsima_user_DllExport GetDoaAngleRequest(const GetDoaAngleRequest& x);
   ...
   * that will be copied.
   */
  eProsima_user_DllExport GetDoaAngleRequest(GetDoaAngleRequest&& x) noexcept;
   ...
   * that will be copied.
   */
  eProsima_user_DllExport GetDoaAngleRequest& operator=(
      const GetDoaAngleRequest& x);
   ...
   */
  eProsima_user_DllExport GetDoaAngleRequest& operator=(
      GetDoaAngleRequest&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x booster_msgs::audio::GetDoaAngleRequest object to compare.
   */
  eProsima_user_DllExport bool operator==(const GetDoaAngleRequest& x) const;
 ...
 public:
  typedef GetDoaAngleRequest type;

  eProsima_user_DllExport GetDoaAngleRequest();

  eProsima_user_DllExport ~GetDoaAngleRequest() override;
...
#endif  // _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_GETDOAANGLEREQUEST_H_
