...
#ifndef _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_INITRECORDERRESPONSE_H_
#define _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_INITRECORDERRESPONSE_H_
...
#error \
    Generated InitRecorderResponse is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(INITRECORDERRESPONSE_SOURCE)
#define INITRECORDERRESPONSE_DllAPI __declspec(dllexport)
#else
#define INITRECORDERRESPONSE_DllAPI __declspec(dllimport)
#endif  // INITRECORDERRESPONSE_SOURCE
#else
#define INITRECORDERRESPONSE_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define INITRECORDERRESPONSE_DllAPI
#endif  // _WIN32
...
/*!
 * @brief This class represents the structure InitRecorderResponse defined by
 * the user in the IDL file.
 * @ingroup InitRecorderResponse
 */
class InitRecorderResponse : public booster_eprosima::fastdds::dds::TopicDataType {
 public:
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object booster_msgs::audio::InitRecorderResponse
   * that will be copied.
   */
  eProsima_user_DllExport InitRecorderResponse(const InitRecorderResponse& x);
   ...
   * that will be copied.
   */
  eProsima_user_DllExport InitRecorderResponse(
      InitRecorderResponse&& x) noexcept;
   ...
   * that will be copied.
   */
  eProsima_user_DllExport InitRecorderResponse& operator=(
      const InitRecorderResponse& x);
   ...
   * @param x booster_msgs::audio::InitRecorderResponse object to compare.
   */
  eProsima_user_DllExport bool operator==(const InitRecorderResponse& x) const;
 ...
 public:
  typedef InitRecorderResponse type;

  eProsima_user_DllExport InitRecorderResponse();

  eProsima_user_DllExport ~InitRecorderResponse() override;
...
#endif  // _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_INITRECORDERRESPONSE_H_
