...
#ifndef _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_SESSIONMETA_H_
#define _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_SESSIONMETA_H_
...
#error \
    Generated SessionMeta is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(SESSIONMETA_SOURCE)
#define SESSIONMETA_DllAPI __declspec(dllexport)
#else
#define SESSIONMETA_DllAPI __declspec(dllimport)
#endif  // SESSIONMETA_SOURCE
#else
#define SESSIONMETA_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define SESSIONMETA_DllAPI
#endif  // _WIN32
...
/*!
 * @brief This class represents the structure SessionMeta defined by the user in
 * the IDL file.
 * @ingroup SessionMeta
 */
class SessionMeta : public booster_eprosima::fastdds::dds::TopicDataType {
 public:
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object booster_msgs::audio::SessionMeta that will
   * be copied.
   */
  eProsima_user_DllExport SessionMeta(const SessionMeta& x);
   ...
   * be copied.
   */
  eProsima_user_DllExport SessionMeta(SessionMeta&& x) noexcept;
   ...
   * be copied.
   */
  eProsima_user_DllExport SessionMeta& operator=(const SessionMeta& x);
   ...
   * be copied.
   */
  eProsima_user_DllExport SessionMeta& operator=(SessionMeta&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x booster_msgs::audio::SessionMeta object to compare.
   */
  eProsima_user_DllExport bool operator==(const SessionMeta& x) const;
 ...
 public:
  typedef SessionMeta type;

  eProsima_user_DllExport SessionMeta();

  eProsima_user_DllExport ~SessionMeta() override;
...
#endif  // _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_SESSIONMETA_H_
