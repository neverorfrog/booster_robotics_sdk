...
#ifndef _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_SENDPCMDATA_H_
#define _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_SENDPCMDATA_H_
...
#error \
    Generated SendPcmData is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(SENDPCMDATA_SOURCE)
#define SENDPCMDATA_DllAPI __declspec(dllexport)
#else
#define SENDPCMDATA_DllAPI __declspec(dllimport)
#endif  // SENDPCMDATA_SOURCE
#else
#define SENDPCMDATA_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define SENDPCMDATA_DllAPI
#endif  // _WIN32
...
/*!
 * @brief This class represents the structure SendPcmDataRequest defined by the
 * user in the IDL file.
 * @ingroup SendPcmData
 */
class SendPcmDataRequest : public booster_eprosima::fastdds::dds::TopicDataType {
 public:
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object booster_msgs::audio::SendPcmDataRequest
   * that will be copied.
   */
  eProsima_user_DllExport SendPcmDataRequest(const SendPcmDataRequest& x);
   ...
   * that will be copied.
   */
  eProsima_user_DllExport SendPcmDataRequest(SendPcmDataRequest&& x) noexcept;
   ...
   * that will be copied.
   */
  eProsima_user_DllExport SendPcmDataRequest& operator=(
      const SendPcmDataRequest& x);
   ...
   */
  eProsima_user_DllExport SendPcmDataRequest& operator=(
      SendPcmDataRequest&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x booster_msgs::audio::SendPcmDataRequest object to compare.
   */
  eProsima_user_DllExport bool operator==(const SendPcmDataRequest& x) const;
   ...
   */
  eProsima_user_DllExport void session_id(int64_t _session_id);

  /*!
   * @brief This function returns the value of member session_id
   * @return Value of member session_id
   */
  eProsima_user_DllExport int64_t session_id() const;

  /*!
   * @brief This function returns a reference to member session_id
   * @return Reference to member session_id
   */
  eProsima_user_DllExport int64_t& session_id();

  /*!
   * @brief This function copies the value in member pcm_bytes
   * @param _pcm_bytes New value to be copied in member pcm_bytes
   */
  eProsima_user_DllExport void pcm_bytes(
      const std::vector<uint8_t>& _pcm_bytes);

  /*!
   * @brief This function moves the value in member pcm_bytes
   * @param _pcm_bytes New value to be moved in member pcm_bytes
   */
  eProsima_user_DllExport void pcm_bytes(std::vector<uint8_t>&& _pcm_bytes);

  /*!
   * @brief This function returns a constant reference to member pcm_bytes
   * @return Constant reference to member pcm_bytes
   */
  eProsima_user_DllExport const std::vector<uint8_t>& pcm_bytes() const;

  /*!
   * @brief This function returns a reference to member pcm_bytes
   * @return Reference to member pcm_bytes
   */
  eProsima_user_DllExport std::vector<uint8_t>& pcm_bytes();

 private:
  std::string m_client_id;
  std::string m_request_id;
  int64_t m_session_id{0};
  std::vector<uint8_t> m_pcm_bytes;

 public:
  typedef SendPcmDataRequest type;

  eProsima_user_DllExport SendPcmDataRequest();

  eProsima_user_DllExport ~SendPcmDataRequest() override;
...
typedef booster_msgs::audio::ServiceResult SendPcmDataResponse;

}  // namespace audio

}  // namespace booster_msgs

#endif  // _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_SENDPCMDATA_H_
