...
/*!
 * @file GetSystemVolumeResponse.h
...
#ifndef _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_GETSYSTEMVOLUMERESPONSE_H_
#define _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_GETSYSTEMVOLUMERESPONSE_H_
...
#error \
    Generated GetSystemVolumeResponse is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(GETSYSTEMVOLUMERESPONSE_SOURCE)
#define GETSYSTEMVOLUMERESPONSE_DllAPI __declspec(dllexport)
#else
#define GETSYSTEMVOLUMERESPONSE_DllAPI __declspec(dllimport)
#endif  // GETSYSTEMVOLUMERESPONSE_SOURCE
#else
#define GETSYSTEMVOLUMERESPONSE_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define GETSYSTEMVOLUMERESPONSE_DllAPI
#endif  // _WIN32
...
/*!
 * @brief This class represents the structure GetSystemVolumeResponse defined by
 * the user in the IDL file.
 * @ingroup GetSystemVolumeResponse
 */
class GetSystemVolumeResponse : public booster_eprosima::fastdds::dds::TopicDataType {
 public:
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object
   * booster_msgs::audio::GetSystemVolumeResponse that will be copied.
   */
  eProsima_user_DllExport GetSystemVolumeResponse(
      const GetSystemVolumeResponse& x);
   ...
   */
  eProsima_user_DllExport GetSystemVolumeResponse(
      GetSystemVolumeResponse&& x) noexcept;
   ...
   * booster_msgs::audio::GetSystemVolumeResponse that will be copied.
   */
  eProsima_user_DllExport GetSystemVolumeResponse& operator=(
      const GetSystemVolumeResponse& x);
   ...
   * @param x booster_msgs::audio::GetSystemVolumeResponse object to compare.
   */
  eProsima_user_DllExport bool operator==(
      const GetSystemVolumeResponse& x) const;
 ...
 public:
  typedef GetSystemVolumeResponse type;

  eProsima_user_DllExport GetSystemVolumeResponse();

  eProsima_user_DllExport ~GetSystemVolumeResponse() override;
...
#endif  // _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_GETSYSTEMVOLUMERESPONSE_H_
