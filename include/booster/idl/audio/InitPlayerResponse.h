...
#ifndef _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_INITPLAYERRESPONSE_H_
#define _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_INITPLAYERRESPONSE_H_
...
#error \
    Generated InitPlayerResponse is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(INITPLAYERRESPONSE_SOURCE)
#define INITPLAYERRESPONSE_DllAPI __declspec(dllexport)
#else
#define INITPLAYERRESPONSE_DllAPI __declspec(dllimport)
#endif  // INITPLAYERRESPONSE_SOURCE
#else
#define INITPLAYERRESPONSE_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define INITPLAYERRESPONSE_DllAPI
#endif  // _WIN32
...
/*!
 * @brief This class represents the structure InitPlayerResponse defined by the
 * user in the IDL file.
 * @ingroup InitPlayerResponse
 */
class InitPlayerResponse : public booster_eprosima::fastdds::dds::TopicDataType {
 public:
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object booster_msgs::audio::InitPlayerResponse
   * that will be copied.
   */
  eProsima_user_DllExport InitPlayerResponse(const InitPlayerResponse& x);
   ...
   * that will be copied.
   */
  eProsima_user_DllExport InitPlayerResponse(InitPlayerResponse&& x) noexcept;
   ...
   * that will be copied.
   */
  eProsima_user_DllExport InitPlayerResponse& operator=(
      const InitPlayerResponse& x);
   ...
   */
  eProsima_user_DllExport InitPlayerResponse& operator=(
      InitPlayerResponse&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x booster_msgs::audio::InitPlayerResponse object to compare.
   */
  eProsima_user_DllExport bool operator==(const InitPlayerResponse& x) const;
 ...
 public:
  typedef InitPlayerResponse type;

  eProsima_user_DllExport InitPlayerResponse();

  eProsima_user_DllExport ~InitPlayerResponse() override;
...
#endif  // _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_INITPLAYERRESPONSE_H_
