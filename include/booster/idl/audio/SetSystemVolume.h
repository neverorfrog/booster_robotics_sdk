...
#ifndef _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_SETSYSTEMVOLUME_H_
#define _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_SETSYSTEMVOLUME_H_
...
#error \
    Generated SetSystemVolume is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(SETSYSTEMVOLUME_SOURCE)
#define SETSYSTEMVOLUME_DllAPI __declspec(dllexport)
#else
#define SETSYSTEMVOLUME_DllAPI __declspec(dllimport)
#endif  // SETSYSTEMVOLUME_SOURCE
#else
#define SETSYSTEMVOLUME_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define SETSYSTEMVOLUME_DllAPI
#endif  // _WIN32
...
/*!
 * @brief This class represents the structure SetSystemVolumeRequest defined by
 * the user in the IDL file.
 * @ingroup SetSystemVolume
 */
class SetSystemVolumeRequest : public booster_eprosima::fastdds::dds::TopicDataType {
 public:
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object
   * booster_msgs::audio::SetSystemVolumeRequest that will be copied.
   */
  eProsima_user_DllExport SetSystemVolumeRequest(
      const SetSystemVolumeRequest& x);
   ...
   */
  eProsima_user_DllExport SetSystemVolumeRequest(
      SetSystemVolumeRequest&& x) noexcept;
   ...
   * booster_msgs::audio::SetSystemVolumeRequest that will be copied.
   */
  eProsima_user_DllExport SetSystemVolumeRequest& operator=(
      const SetSystemVolumeRequest& x);
   ...
   * @param x booster_msgs::audio::SetSystemVolumeRequest object to compare.
   */
  eProsima_user_DllExport bool operator==(
      const SetSystemVolumeRequest& x) const;
 ...
 public:
  typedef SetSystemVolumeRequest type;

  eProsima_user_DllExport SetSystemVolumeRequest();

  eProsima_user_DllExport ~SetSystemVolumeRequest() override;
...
typedef booster_msgs::audio::ServiceResult SetSystemVolumeResponse;

}  // namespace audio

}  // namespace booster_msgs

#endif  // _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_SETSYSTEMVOLUME_H_
