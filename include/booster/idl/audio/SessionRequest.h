...
#ifndef _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_SESSIONREQUEST_H_
#define _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_SESSIONREQUEST_H_
...
#error \
    Generated SessionRequest is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(SESSIONREQUEST_SOURCE)
#define SESSIONREQUEST_DllAPI __declspec(dllexport)
#else
#define SESSIONREQUEST_DllAPI __declspec(dllimport)
#endif  // SESSIONREQUEST_SOURCE
#else
#define SESSIONREQUEST_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define SESSIONREQUEST_DllAPI
#endif  // _WIN32
...
/*!
 * @brief This class represents the structure SessionRequest defined by the user
 * in the IDL file.
 * @ingroup SessionRequest
 */
class SessionRequest : public booster_eprosima::fastdds::dds::TopicDataType {
 public:
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object booster_msgs::audio::SessionRequest that
   * will be copied.
   */
  eProsima_user_DllExport SessionRequest(const SessionRequest& x);
   ...
   * will be copied.
   */
  eProsima_user_DllExport SessionRequest(SessionRequest&& x) noexcept;
   ...
   * will be copied.
   */
  eProsima_user_DllExport SessionRequest& operator=(const SessionRequest& x);
   ...
   * will be copied.
   */
  eProsima_user_DllExport SessionRequest& operator=(
      SessionRequest&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x booster_msgs::audio::SessionRequest object to compare.
   */
  eProsima_user_DllExport bool operator==(const SessionRequest& x) const;
 ...
 public:
  typedef SessionRequest type;

  eProsima_user_DllExport SessionRequest();

  eProsima_user_DllExport ~SessionRequest() override;
...
#endif  // _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_SESSIONREQUEST_H_
