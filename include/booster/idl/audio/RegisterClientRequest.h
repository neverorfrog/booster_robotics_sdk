...
#ifndef _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_REGISTERCLIENTREQUEST_H_
#define _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_REGISTERCLIENTREQUEST_H_
...
#error \
    Generated RegisterClientRequest is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(REGISTERCLIENTREQUEST_SOURCE)
#define REGISTERCLIENTREQUEST_DllAPI __declspec(dllexport)
#else
#define REGISTERCLIENTREQUEST_DllAPI __declspec(dllimport)
#endif  // REGISTERCLIENTREQUEST_SOURCE
#else
#define REGISTERCLIENTREQUEST_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define REGISTERCLIENTREQUEST_DllAPI
#endif  // _WIN32
...
/*!
 * @brief This class represents the structure RegisterClientRequest defined by
 * the user in the IDL file.
 * @ingroup RegisterClientRequest
 */
class RegisterClientRequest : public booster_eprosima::fastdds::dds::TopicDataType {
 public:
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object booster_msgs::audio::RegisterClientRequest
   * that will be copied.
   */
  eProsima_user_DllExport RegisterClientRequest(const RegisterClientRequest& x);
   ...
   * that will be copied.
   */
  eProsima_user_DllExport RegisterClientRequest(
      RegisterClientRequest&& x) noexcept;
   ...
   * that will be copied.
   */
  eProsima_user_DllExport RegisterClientRequest& operator=(
      const RegisterClientRequest& x);
   ...
   * @param x booster_msgs::audio::RegisterClientRequest object to compare.
   */
  eProsima_user_DllExport bool operator==(const RegisterClientRequest& x) const;
 ...
 public:
  typedef RegisterClientRequest type;

  eProsima_user_DllExport RegisterClientRequest();

  eProsima_user_DllExport ~RegisterClientRequest() override;
...
#endif  // _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_REGISTERCLIENTREQUEST_H_
