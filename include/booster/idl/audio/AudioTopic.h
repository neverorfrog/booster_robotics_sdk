...
#ifndef _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_AUDIOTOPIC_H_
#define _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_AUDIOTOPIC_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(AUDIOTOPIC_SOURCE)
#define AUDIOTOPIC_DllAPI __declspec( dllexport )
#else
#define AUDIOTOPIC_DllAPI __declspec( dllimport )
#endif // AUDIOTOPIC_SOURCE
#else
...
public:
     ...
     * @param x Reference to the object booster_msgs::audio::AudioTopicHeader that will be copied.
     */
    eProsima_user_DllExport AudioTopicHeader(
            const AudioTopicHeader& x);
     ...
     */
    eProsima_user_DllExport AudioTopicHeader(
            AudioTopicHeader&& x) noexcept;

    /*!
     * @brief Copy assignment.
     * @param x Reference to the object booster_msgs::audio::AudioTopicHeader that will be copied.
     */
    eProsima_user_DllExport AudioTopicHeader& operator =(
            const AudioTopicHeader& x);
     ...
     * @param x booster_msgs::audio::AudioTopicHeader object to compare.
     */
    eProsima_user_DllExport bool operator ==(
            const AudioTopicHeader& x) const;
    ...
    /*!
     * @brief This function sets a value in member session_type
     * @param _session_type New value for member session_type
     */
    eProsima_user_DllExport void session_type(
            booster_msgs::audio::SessionType _session_type);

    /*!
     * @brief This function returns the value of member session_type
     * @return Value of member session_type
     */
    eProsima_user_DllExport booster_msgs::audio::SessionType session_type() const;

    /*!
     * @brief This function returns a reference to member session_type
     * @return Reference to member session_type
     */
    eProsima_user_DllExport booster_msgs::audio::SessionType& session_type();
...
private:
    ...
    booster_msgs::audio::SessionType m_session_type{booster_msgs::audio::PLAYER_SESSION};
    int64_t m_session_id{0};
    int64_t m_timestamp_ms{0};

        public:

            typedef AudioTopicHeader type;

            eProsima_user_DllExport AudioTopicHeader();

            eProsima_user_DllExport ~AudioTopicHeader() override;
...
#endif // _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_AUDIOTOPIC_H_
