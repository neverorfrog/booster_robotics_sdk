...
#ifndef _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_GETSYSTEMMUTEREQUEST_H_
#define _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_GETSYSTEMMUTEREQUEST_H_
...
#error \
    Generated GetSystemMuteRequest is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(GETSYSTEMMUTEREQUEST_SOURCE)
#define GETSYSTEMMUTEREQUEST_DllAPI __declspec(dllexport)
#else
#define GETSYSTEMMUTEREQUEST_DllAPI __declspec(dllimport)
#endif  // GETSYSTEMMUTEREQUEST_SOURCE
#else
#define GETSYSTEMMUTEREQUEST_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define GETSYSTEMMUTEREQUEST_DllAPI
#endif  // _WIN32
...
/*!
 * @brief This class represents the structure GetSystemMuteRequest defined by
 * the user in the IDL file.
 * @ingroup GetSystemMuteRequest
 */
class GetSystemMuteRequest : public booster_eprosima::fastdds::dds::TopicDataType {
 public:
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object booster_msgs::audio::GetSystemMuteRequest
   * that will be copied.
   */
  eProsima_user_DllExport GetSystemMuteRequest(const GetSystemMuteRequest& x);
   ...
   * that will be copied.
   */
  eProsima_user_DllExport GetSystemMuteRequest(
      GetSystemMuteRequest&& x) noexcept;
   ...
   * that will be copied.
   */
  eProsima_user_DllExport GetSystemMuteRequest& operator=(
      const GetSystemMuteRequest& x);
   ...
   * @param x booster_msgs::audio::GetSystemMuteRequest object to compare.
   */
  eProsima_user_DllExport bool operator==(const GetSystemMuteRequest& x) const;
 ...
 public:
  typedef GetSystemMuteRequest type;

  eProsima_user_DllExport GetSystemMuteRequest();

  eProsima_user_DllExport ~GetSystemMuteRequest() override;
...
#endif  // _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_GETSYSTEMMUTEREQUEST_H_
