...
#ifndef _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_GETSYSTEMVOLUMEREQUEST_H_
#define _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_GETSYSTEMVOLUMEREQUEST_H_
...
#error \
    Generated GetSystemVolumeRequest is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(GETSYSTEMVOLUMEREQUEST_SOURCE)
#define GETSYSTEMVOLUMEREQUEST_DllAPI __declspec(dllexport)
#else
#define GETSYSTEMVOLUMEREQUEST_DllAPI __declspec(dllimport)
#endif  // GETSYSTEMVOLUMEREQUEST_SOURCE
#else
#define GETSYSTEMVOLUMEREQUEST_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define GETSYSTEMVOLUMEREQUEST_DllAPI
#endif  // _WIN32
...
/*!
 * @brief This class represents the structure GetSystemVolumeRequest defined by
 * the user in the IDL file.
 * @ingroup GetSystemVolumeRequest
 */
class GetSystemVolumeRequest : public booster_eprosima::fastdds::dds::TopicDataType {
 public:
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object
   * booster_msgs::audio::GetSystemVolumeRequest that will be copied.
   */
  eProsima_user_DllExport GetSystemVolumeRequest(
      const GetSystemVolumeRequest& x);
   ...
   */
  eProsima_user_DllExport GetSystemVolumeRequest(
      GetSystemVolumeRequest&& x) noexcept;
   ...
   * booster_msgs::audio::GetSystemVolumeRequest that will be copied.
   */
  eProsima_user_DllExport GetSystemVolumeRequest& operator=(
      const GetSystemVolumeRequest& x);
   ...
   * @param x booster_msgs::audio::GetSystemVolumeRequest object to compare.
   */
  eProsima_user_DllExport bool operator==(
      const GetSystemVolumeRequest& x) const;
 ...
 public:
  typedef GetSystemVolumeRequest type;

  eProsima_user_DllExport GetSystemVolumeRequest();

  eProsima_user_DllExport ~GetSystemVolumeRequest() override;
...
#endif  // _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_GETSYSTEMVOLUMEREQUEST_H_
