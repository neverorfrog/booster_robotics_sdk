...
#ifndef _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_SETPLAYERVOLUME_H_
#define _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_SETPLAYERVOLUME_H_
...
#error \
    Generated SetPlayerVolume is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(SETPLAYERVOLUME_SOURCE)
#define SETPLAYERVOLUME_DllAPI __declspec(dllexport)
#else
#define SETPLAYERVOLUME_DllAPI __declspec(dllimport)
#endif  // SETPLAYERVOLUME_SOURCE
#else
#define SETPLAYERVOLUME_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define SETPLAYERVOLUME_DllAPI
#endif  // _WIN32
...
/*!
 * @brief This class represents the structure SetPlayerVolumeRequest defined by
 * the user in the IDL file.
 * @ingroup SetPlayerVolume
 */
class SetPlayerVolumeRequest : public booster_eprosima::fastdds::dds::TopicDataType {
 public:
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object
   * booster_msgs::audio::SetPlayerVolumeRequest that will be copied.
   */
  eProsima_user_DllExport SetPlayerVolumeRequest(
      const SetPlayerVolumeRequest& x);
   ...
   */
  eProsima_user_DllExport SetPlayerVolumeRequest(
      SetPlayerVolumeRequest&& x) noexcept;
   ...
   * booster_msgs::audio::SetPlayerVolumeRequest that will be copied.
   */
  eProsima_user_DllExport SetPlayerVolumeRequest& operator=(
      const SetPlayerVolumeRequest& x);
   ...
   * @param x booster_msgs::audio::SetPlayerVolumeRequest object to compare.
   */
  eProsima_user_DllExport bool operator==(
      const SetPlayerVolumeRequest& x) const;
 ...
 public:
  typedef SetPlayerVolumeRequest type;

  eProsima_user_DllExport SetPlayerVolumeRequest();

  eProsima_user_DllExport ~SetPlayerVolumeRequest() override;
...
typedef booster_msgs::audio::ServiceResult SetPlayerVolumeResponse;

}  // namespace audio

}  // namespace booster_msgs

#endif  // _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_SETPLAYERVOLUME_H_
