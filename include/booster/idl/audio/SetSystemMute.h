...
#ifndef _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_SETSYSTEMMUTE_H_
#define _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_SETSYSTEMMUTE_H_
...
#error \
    Generated SetSystemMute is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(SETSYSTEMMUTE_SOURCE)
#define SETSYSTEMMUTE_DllAPI __declspec(dllexport)
#else
#define SETSYSTEMMUTE_DllAPI __declspec(dllimport)
#endif  // SETSYSTEMMUTE_SOURCE
#else
#define SETSYSTEMMUTE_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define SETSYSTEMMUTE_DllAPI
#endif  // _WIN32
...
/*!
 * @brief This class represents the structure SetSystemMuteRequest defined by
 * the user in the IDL file.
 * @ingroup SetSystemMute
 */
class SetSystemMuteRequest : public booster_eprosima::fastdds::dds::TopicDataType {
 public:
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object booster_msgs::audio::SetSystemMuteRequest
   * that will be copied.
   */
  eProsima_user_DllExport SetSystemMuteRequest(const SetSystemMuteRequest& x);
   ...
   * that will be copied.
   */
  eProsima_user_DllExport SetSystemMuteRequest(
      SetSystemMuteRequest&& x) noexcept;
   ...
   * that will be copied.
   */
  eProsima_user_DllExport SetSystemMuteRequest& operator=(
      const SetSystemMuteRequest& x);
   ...
   * @param x booster_msgs::audio::SetSystemMuteRequest object to compare.
   */
  eProsima_user_DllExport bool operator==(const SetSystemMuteRequest& x) const;
 ...
 public:
  typedef SetSystemMuteRequest type;

  eProsima_user_DllExport SetSystemMuteRequest();

  eProsima_user_DllExport ~SetSystemMuteRequest() override;
...
typedef booster_msgs::audio::ServiceResult SetSystemMuteResponse;

}  // namespace audio

}  // namespace booster_msgs

#endif  // _FAST_DDS_GENERATED_BOOSTER_MSGS_AUDIO_SETSYSTEMMUTE_H_
