...
/*!
 * @brief This class represents the structure MultiArrayDimension defined by the user in the
 * IDL file.
...
class MultiArrayDimension : public eprosima::fastdds::dds::TopicDataType {
 public:
   ...
   */
  eProsima_user_DllExport MultiArrayDimension(const MultiArrayDimension& x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object std_msgs::msg::MultiArrayDimension that will be copied.
   */
  eProsima_user_DllExport MultiArrayDimension(MultiArrayDimension&& x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object std_msgs::msg::MultiArrayDimension that will be copied.
   */
  eProsima_user_DllExport MultiArrayDimension& operator=(const MultiArrayDimension& x);

  /*!
   * @brief Move assignment.
   * @param x Reference to the object std_msgs::msg::MultiArrayDimension that will be copied.
   */
  eProsima_user_DllExport MultiArrayDimension& operator=(MultiArrayDimension&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x std_msgs::msg::MultiArrayDimension object to compare.
   */
  eProsima_user_DllExport bool operator==(const MultiArrayDimension& x) const;
 ...
 public:
  ...
  eProsima_user_DllExport ~MultiArrayDimension() override;
