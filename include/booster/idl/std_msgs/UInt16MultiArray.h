...
/*!
 * @brief This class represents the structure UInt16MultiArray defined by the user in the
 * IDL file.
...
class UInt16MultiArray : public eprosima::fastdds::dds::TopicDataType {
 public:
   ...
   */
  eProsima_user_DllExport UInt16MultiArray(const UInt16MultiArray& x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object std_msgs::msg::UInt16MultiArray that will be copied.
   */
  eProsima_user_DllExport UInt16MultiArray(UInt16MultiArray&& x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object std_msgs::msg::UInt16MultiArray that will be copied.
   */
  eProsima_user_DllExport UInt16MultiArray& operator=(const UInt16MultiArray& x);

  /*!
   * @brief Move assignment.
   * @param x Reference to the object std_msgs::msg::UInt16MultiArray that will be copied.
   */
  eProsima_user_DllExport UInt16MultiArray& operator=(UInt16MultiArray&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x std_msgs::msg::UInt16MultiArray object to compare.
   */
  eProsima_user_DllExport bool operator==(const UInt16MultiArray& x) const;
 ...
 public:
  ...
  eProsima_user_DllExport ~UInt16MultiArray() override;
