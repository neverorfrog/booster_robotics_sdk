...
/*!
 * @brief This class represents the structure UInt8MultiArray defined by the user in the
 * IDL file.
...
class UInt8MultiArray : public eprosima::fastdds::dds::TopicDataType {
 public:
   ...
   */
  eProsima_user_DllExport UInt8MultiArray(const UInt8MultiArray& x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object std_msgs::msg::UInt8MultiArray that will be copied.
   */
  eProsima_user_DllExport UInt8MultiArray(UInt8MultiArray&& x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object std_msgs::msg::UInt8MultiArray that will be copied.
   */
  eProsima_user_DllExport UInt8MultiArray& operator=(const UInt8MultiArray& x);

  /*!
   * @brief Move assignment.
   * @param x Reference to the object std_msgs::msg::UInt8MultiArray that will be copied.
   */
  eProsima_user_DllExport UInt8MultiArray& operator=(UInt8MultiArray&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x std_msgs::msg::UInt8MultiArray object to compare.
   */
  eProsima_user_DllExport bool operator==(const UInt8MultiArray& x) const;
 ...
 public:
  ...
  eProsima_user_DllExport ~UInt8MultiArray() override;
