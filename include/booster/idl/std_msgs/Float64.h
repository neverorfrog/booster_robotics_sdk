...
/*!
 * @brief This class represents the structure Float64 defined by the user in the
 * IDL file.
 * @ingroup Float64
 */
class Float64 : public eprosima::fastdds::dds::TopicDataType {
 public:
   ...
   */
  eProsima_user_DllExport Float64(const Float64& x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object std_msgs::msg::Float64 that will be copied.
   */
  eProsima_user_DllExport Float64(Float64&& x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object std_msgs::msg::Float64 that will be copied.
   */
  eProsima_user_DllExport Float64& operator=(const Float64& x);

  /*!
   * @brief Move assignment.
   * @param x Reference to the object std_msgs::msg::Float64 that will be copied.
   */
  eProsima_user_DllExport Float64& operator=(Float64&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x std_msgs::msg::Float64 object to compare.
   */
  eProsima_user_DllExport bool operator==(const Float64& x) const;
   ...
   */
  eProsima_user_DllExport void data(double _data);
 ...
 public:
  ...
  eProsima_user_DllExport ~Float64() override;
