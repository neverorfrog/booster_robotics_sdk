...
/*!
 * @brief This class represents the structure Empty defined by the user in the
 * IDL file.
 * @ingroup Empty
 */
class Empty : public eprosima::fastdds::dds::TopicDataType {
 public:
   ...
   */
  eProsima_user_DllExport Empty(const Empty& x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object std_msgs::msg::Empty that will be copied.
   */
  eProsima_user_DllExport Empty(Empty&& x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object std_msgs::msg::Empty that will be copied.
   */
  eProsima_user_DllExport Empty& operator=(const Empty& x);

  /*!
   * @brief Move assignment.
   * @param x Reference to the object std_msgs::msg::Empty that will be copied.
   */
  eProsima_user_DllExport Empty& operator=(Empty&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x std_msgs::msg::Empty object to compare.
   */
  eProsima_user_DllExport bool operator==(const Empty& x) const;
   ...
   */
  eProsima_user_DllExport void structure_needs_at_least_one_member(uint8 _structure_needs_at_least_one_member);
   ...
   */
  eProsima_user_DllExport uint8 structure_needs_at_least_one_member() const;
   ...
   */
  eProsima_user_DllExport uint8& structure_needs_at_least_one_member();
 ...
 public:
  ...
  eProsima_user_DllExport ~Empty() override;
