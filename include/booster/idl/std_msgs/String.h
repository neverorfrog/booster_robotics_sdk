...
/*!
 * @brief This class represents the structure String defined by the user in the
 * IDL file.
 * @ingroup String
 */
class String : public eprosima::fastdds::dds::TopicDataType {
 public:
  /*!
 ...
 public:
  ...
  eProsima_user_DllExport ~String() override;
