...
/*!
 * @brief This class represents the structure Int16 defined by the user in the
 * IDL file.
 * @ingroup Int16
 */
class Int16 : public eprosima::fastdds::dds::TopicDataType {
 public:
   ...
   */
  eProsima_user_DllExport Int16(const Int16& x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object std_msgs::msg::Int16 that will be copied.
   */
  eProsima_user_DllExport Int16(Int16&& x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object std_msgs::msg::Int16 that will be copied.
   */
  eProsima_user_DllExport Int16& operator=(const Int16& x);

  /*!
   * @brief Move assignment.
   * @param x Reference to the object std_msgs::msg::Int16 that will be copied.
   */
  eProsima_user_DllExport Int16& operator=(Int16&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x std_msgs::msg::Int16 object to compare.
   */
  eProsima_user_DllExport bool operator==(const Int16& x) const;
   ...
   */
  eProsima_user_DllExport void data(int16 _data);

  /*!
   * @brief This function returns the value of member data
   * @return Value of member data
   */
  eProsima_user_DllExport int16 data() const;

  /*!
   * @brief This function returns a reference to member data
   * @return Reference to member data
   */
  eProsima_user_DllExport int16& data();
 ...
 public:
  ...
  eProsima_user_DllExport ~Int16() override;
