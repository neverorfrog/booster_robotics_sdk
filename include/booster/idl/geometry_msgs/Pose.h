...
/*!
 * @brief This class represents the structure Pose defined by the user in the
 * IDL file.
 * @ingroup Pose
 */
class Pose : public booster_eprosima::fastdds::dds::TopicDataType {
 public:
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object geometry_msgs::msg::Pose that will be
   * copied.
   */
