...
/*!
 * @brief This class represents the structure QuaternionStamped defined by the user in the
 * IDL file.
...
class QuaternionStamped : public eprosima::fastdds::dds::TopicDataType {
 public:
   ...
   */
  eProsima_user_DllExport QuaternionStamped(const QuaternionStamped& x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object geometry_msgs::msg::QuaternionStamped that will be copied.
   */
  eProsima_user_DllExport QuaternionStamped(QuaternionStamped&& x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object geometry_msgs::msg::QuaternionStamped that will be copied.
   */
  eProsima_user_DllExport QuaternionStamped& operator=(const QuaternionStamped& x);

  /*!
   * @brief Move assignment.
   * @param x Reference to the object geometry_msgs::msg::QuaternionStamped that will be copied.
   */
  eProsima_user_DllExport QuaternionStamped& operator=(QuaternionStamped&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x geometry_msgs::msg::QuaternionStamped object to compare.
   */
  eProsima_user_DllExport bool operator==(const QuaternionStamped& x) const;
   ...
   */
  eProsima_user_DllExport void quaternion(geometry_msgs::msg::Quaternion&& _quaternion);
 ...
 public:
  ...
  eProsima_user_DllExport ~QuaternionStamped() override;
