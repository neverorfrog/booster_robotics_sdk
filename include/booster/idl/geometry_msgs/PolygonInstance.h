...
/*!
 * @brief This class represents the structure PolygonInstance defined by the user in the
 * IDL file.
...
class PolygonInstance : public eprosima::fastdds::dds::TopicDataType {
 public:
   ...
   */
  eProsima_user_DllExport PolygonInstance(const PolygonInstance& x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object geometry_msgs::msg::PolygonInstance that will be copied.
   */
  eProsima_user_DllExport PolygonInstance(PolygonInstance&& x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object geometry_msgs::msg::PolygonInstance that will be copied.
   */
  eProsima_user_DllExport PolygonInstance& operator=(const PolygonInstance& x);

  /*!
   * @brief Move assignment.
   * @param x Reference to the object geometry_msgs::msg::PolygonInstance that will be copied.
   */
  eProsima_user_DllExport PolygonInstance& operator=(PolygonInstance&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x geometry_msgs::msg::PolygonInstance object to compare.
   */
  eProsima_user_DllExport bool operator==(const PolygonInstance& x) const;
   ...
   */
  eProsima_user_DllExport void id(int64 _id);

  /*!
   * @brief This function returns the value of member id
   * @return Value of member id
   */
  eProsima_user_DllExport int64 id() const;

  /*!
   * @brief This function returns a reference to member id
   * @return Reference to member id
   */
  eProsima_user_DllExport int64& id();
 ...
 public:
  ...
  eProsima_user_DllExport ~PolygonInstance() override;
