...
/*!
 * @brief This class represents the structure Point defined by the user in the
 * IDL file.
 * @ingroup Point
 */
class Point : public booster_eprosima::fastdds::dds::TopicDataType {
 public:
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object geometry_msgs::msg::Point that will be
   * copied.
   */
