...
/*!
 * @brief This class represents the structure Pose2D defined by the user in the
 * IDL file.
 * @ingroup Pose2D
 */
class Pose2D : public eprosima::fastdds::dds::TopicDataType {
 public:
  /*!
   ...
   * @param x Reference to the object geometry_msgs::msg::Pose2D that will be copied.
   */
  eProsima_user_DllExport Pose2D(Pose2D&& x) noexcept;
   ...
   * @param x Reference to the object geometry_msgs::msg::Pose2D that will be copied.
   */
  eProsima_user_DllExport Pose2D& operator=(Pose2D&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x geometry_msgs::msg::Pose2D object to compare.
   */
  eProsima_user_DllExport bool operator==(const Pose2D& x) const;
   ...
   */
  eProsima_user_DllExport void theta(double _theta);
 ...
 public:
  ...
  eProsima_user_DllExport ~Pose2D() override;
