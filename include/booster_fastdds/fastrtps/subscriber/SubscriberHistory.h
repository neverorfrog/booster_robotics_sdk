...
#ifndef BOOSTER_FASTDDS_SUBSCRIBERHISTORY_H_
#define BOOSTER_FASTDDS_SUBSCRIBERHISTORY_H_
...
#include <booster_fastdds/fastrtps/common/KeyedChanges.h>
...
#endif /* BOOSTER_FASTDDS_SUBSCRIBERHISTORY_H_ */
