...
//
#ifndef BOOSTER_FASTDDS_XML_PROFILE_MANAGER_H_
#define BOOSTER_FASTDDS_XML_PROFILE_MANAGER_H_
...
#include <booster_fastdds/fastrtps/types/DynamicPubSubType.h>
#include <booster_fastdds/fastrtps/types/DynamicTypeBuilder.h>
#include <booster_fastdds/fastrtps/types/DynamicTypeBuilderFactory.h>
#include <booster_fastdds/fastrtps/xmlparser/XMLParser.h>
...
public:
     ...
     */
    BOOSTER_RTPS_DllAPI static void loadDefaultXMLFile();
     ...
     */
    BOOSTER_RTPS_DllAPI static XMLP_ret loadXMLFile(
     ...
     *         XMLP_ret::XML_ERROR in other case.
     */
    BOOSTER_RTPS_DllAPI static XMLP_ret loadXMLString(
            const char* data,
            size_t length);
     ...
     *         XMLP_ret::XML_ERROR in other case.
     */
    BOOSTER_RTPS_DllAPI static XMLP_ret loadXMLNode(
            booster_tinyxml2::XMLDocument& doc);
     ...
     */
    BOOSTER_RTPS_DllAPI static void library_settings(
     ...
     */
    BOOSTER_RTPS_DllAPI static const LibrarySettingsAttributes& library_settings();
     ...
     */
    BOOSTER_RTPS_DllAPI static XMLP_ret fillParticipantAttributes(
            const std::string& profile_name,
            ParticipantAttributes& atts,
            bool log_error = true);

    //!Fills participant_attributes with the default values.
    BOOSTER_RTPS_DllAPI static void getDefaultParticipantAttributes(
     ...
     * @return XMLP_ret::XML_OK on success, XMLP_ret::XML_ERROR in other case.
     */
    BOOSTER_RTPS_DllAPI static XMLP_ret fillDomainParticipantFactoryQos(
            const std::string& profile_name,
     ...
     * @param qos Structure to be filled.
     */
    BOOSTER_RTPS_DllAPI static void getDefaultDomainParticipantFactoryQos(
            fastdds::dds::DomainParticipantFactoryQos& qos);
     ...
     * @return XMLP_ret::XML_OK on success, XMLP_ret::XML_ERROR in other case. Defaults true.
     */
    BOOSTER_RTPS_DllAPI static XMLP_ret fillPublisherAttributes(
            const std::string& profile_name,
            PublisherAttributes& atts,
            bool log_error = true);

    //!Fills publisher_attributes with the default values.
    BOOSTER_RTPS_DllAPI static void getDefaultPublisherAttributes(
     ...
     * @return XMLP_ret::XML_OK on success, XMLP_ret::XML_ERROR in other case.
     */
    BOOSTER_RTPS_DllAPI static XMLP_ret fillTopicAttributes(
            const std::string& profile_name,
            TopicAttributes& atts);

    //!Fills topic_attributes with the default values.
    BOOSTER_RTPS_DllAPI static void getDefaultTopicAttributes(
            TopicAttributes& topic_attributes);

    //!Add a new dynamic type instance along with its name.
    BOOSTER_RTPS_DllAPI static bool insertDynamicTypeByName(
            const std::string& type_name,
            p_dynamictypebuilder_t type);

    //!Retrieves a transport instance by its name.
    BOOSTER_RTPS_DllAPI static p_dynamictypebuilder_t getDynamicTypeByName(
            const std::string& type_name);
     ...
     * @return XMLP_ret::XML_OK on success, XMLP_ret::XML_ERROR in other case.
     */
    BOOSTER_RTPS_DllAPI static XMLP_ret fillRequesterAttributes(
            const std::string& profile_name,
     ...
     * @return XMLP_ret::XML_OK on success, XMLP_ret::XML_ERROR in other case.
     */
    BOOSTER_RTPS_DllAPI static XMLP_ret fillReplierAttributes(
            const std::string& profile_name,
     ...
     */
    BOOSTER_RTPS_DllAPI static void DeleteInstance()
    {
     ...
     */
    BOOSTER_RTPS_DllAPI static types::DynamicPubSubType* CreateDynamicPubSubType(
            const std::string& type_name)
    {
     ...
     */
    BOOSTER_RTPS_DllAPI static void DeleteDynamicPubSubType(
...
private:
    ...
    BOOSTER_RTPS_DllAPI static XMLP_ret extractProfiles(
            up_base_node_t properties,
            const std::string& filename);

    BOOSTER_RTPS_DllAPI static XMLP_ret extractDomainParticipantFactoryProfile(
            up_base_node_t& profile,
            const std::string& filename);

    BOOSTER_RTPS_DllAPI static XMLP_ret extractParticipantProfile(
            up_base_node_t& profile,
            const std::string& filename);

    BOOSTER_RTPS_DllAPI static XMLP_ret extractPublisherProfile(
            up_base_node_t& profile,
            const std::string& filename);

    BOOSTER_RTPS_DllAPI static XMLP_ret extractSubscriberProfile(
            up_base_node_t& profile,
            const std::string& filename);

    BOOSTER_RTPS_DllAPI static XMLP_ret extractTopicProfile(
            up_base_node_t& profile,
            const std::string& filename);

    BOOSTER_RTPS_DllAPI static XMLP_ret extractRequesterProfile(
            up_base_node_t& profile,
            const std::string& filename);

    BOOSTER_RTPS_DllAPI static XMLP_ret extractReplierProfile(
            up_base_node_t& profile,
            const std::string& filename);
...
#endif // ifndef BOOSTER_FASTDDS_XML_PROFILE_MANAGER_H_
