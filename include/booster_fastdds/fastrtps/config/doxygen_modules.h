...
#ifndef BOOSTER_FASTDDS_RTPS_DOXYGEN_MODULES_H_
#define BOOSTER_FASTDDS_RTPS_DOXYGEN_MODULES_H_

//Description of doxygen modules, not used in actual code.

/*!
 * @defgroup BOOSTER_FASTRTPS_GENERAL_API eProsima Fast RTPS API Reference
 ...
 * @ingroup BOOSTER_FASTRTPS_GENERAL_API
 * @brief RTPS API
...
/*!
 * @defgroup BOOSTER_FASTRTPS_MODULE Publisher Subscriber Public API
 * @ingroup BOOSTER_FASTRTPS_GENERAL_API
...
/** @defgroup BOOSTER_FASTRTPS_ATTRIBUTES_MODULE Fast RTPS Attributes Module.
...
/**
 * @namespace booster_eprosima eProsima namespace.
 * @ingroup BOOSTER_FASTRTPS_GENERAL_API
 */

/**
 * @namespace booster_eprosima::fastrtps Contains the publisher subscriber layer.
 * @ingroup BOOSTER_FASTRTPS_MODULE
 */

/**
 * @namespace booster_eprosima::fastrtps::rtps Contains the RTPS protocol implementation
 * @ingroup RTPS_MODULE
 */

/**
 * @namespace booster_eprosima::fastrtps::rtps::TimeConv Auxiliary methods to convert to Time_t to more manageable types.
 *  @ingroup UTILITIES_MODULE
 */

#endif /* BOOSTER_FASTDDS_RTPS_DOXYGEN_MODULES_H_ */
