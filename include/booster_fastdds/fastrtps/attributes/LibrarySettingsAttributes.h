...
#ifndef BOOSTER_FASTDDS_LIBRARYSETTINGS_ATTRIBUTES_H_
#define BOOSTER_FASTDDS_LIBRARYSETTINGS_ATTRIBUTES_H_
...
#endif /* BOOSTER_FASTDDS_LIBRARYSETTINGS_ATTRIBUTES_H_ */
