...
#ifndef BOOSTER_FASTDDS__LIVELINESS_CHANGED_STATUS_H_
#define BOOSTER_FASTDDS__LIVELINESS_CHANGED_STATUS_H_
...
#endif /* BOOSTER_FASTDDS__LIVELINESS_CHANGED_STATUS_H_ */
