...
#ifndef BOOSTER_FASTDDS_TYPES_DYNAMIC_TYPE_BUILDER_H
#define BOOSTER_FASTDDS_TYPES_DYNAMIC_TYPE_BUILDER_H
...
public:
    BOOSTER_RTPS_DllAPI ReturnCode_t add_empty_member(
            uint32_t index,
            const std::string& name);

    BOOSTER_RTPS_DllAPI ReturnCode_t add_member(const MemberDescriptor* descriptor);

    BOOSTER_RTPS_DllAPI ReturnCode_t add_member(
            MemberId id,
            const std::string& name,
    ...
    BOOSTER_RTPS_DllAPI ReturnCode_t apply_annotation(AnnotationDescriptor& descriptor);
    ...
    BOOSTER_RTPS_DllAPI ReturnCode_t apply_annotation_to_member(
            MemberId id,
            AnnotationDescriptor& descriptor);
    ...
    BOOSTER_RTPS_DllAPI DynamicType_ptr build();

    BOOSTER_RTPS_DllAPI ReturnCode_t copy_from(const DynamicTypeBuilder* other);
    ...
    BOOSTER_RTPS_DllAPI MemberId get_member_id_by_name(const std::string& name) const;
    ...
    BOOSTER_RTPS_DllAPI ReturnCode_t set_name(const std::string& name);
};
...
#endif // BOOSTER_FASTDDS_TYPES_DYNAMIC_TYPE_BUILDER_H
