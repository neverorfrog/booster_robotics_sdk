...
#ifndef BOOSTER_FASTDDS__TYPEIDENTIFIER_H_
#define BOOSTER_FASTDDS__TYPEIDENTIFIER_H_

#include <booster_fastdds/fastrtps/types/TypesBase.h>
#include <booster_fastdds/fastrtps/types/TypeIdentifierTypes.h>
#include <stdint.h>
#include <array>
#include <string>
#include <vector>
...
public:
     ...
     */
    BOOSTER_RTPS_DllAPI TypeIdentifier();
     ...
     * @param x Reference to the object TypeIdentifier that will be copied.
     */
    BOOSTER_RTPS_DllAPI TypeIdentifier& operator =(
            const TypeIdentifier& x);
     ...
     */
    BOOSTER_RTPS_DllAPI void string_sdefn(
     ...
     */
    BOOSTER_RTPS_DllAPI const StringSTypeDefn& string_sdefn() const;
     ...
     * @exception booster_eprosima::fastcdr::BadParamException This exception is thrown if the requested union member is not the current selection.
     */
    BOOSTER_RTPS_DllAPI const StringLTypeDefn& string_ldefn() const;
     ...
     * @exception booster_eprosima::fastcdr::BadParamException This exception is thrown if the requested union member is not the current selection.
     */
    BOOSTER_RTPS_DllAPI const PlainSequenceSElemDefn& seq_sdefn() const;
     ...
     * @exception booster_eprosima::fastcdr::BadParamException This exception is thrown if the requested union member is not the current selection.
     */
    BOOSTER_RTPS_DllAPI const PlainSequenceLElemDefn& seq_ldefn() const;
     ...
     * @exception booster_eprosima::fastcdr::BadParamException This exception is thrown if the requested union member is not the current selection.
     */
    BOOSTER_RTPS_DllAPI const PlainArraySElemDefn& array_sdefn() const;
     ...
     * @exception booster_eprosima::fastcdr::BadParamException This exception is thrown if the requested union member is not the current selection.
     */
    BOOSTER_RTPS_DllAPI const PlainArrayLElemDefn& array_ldefn() const;
     ...
     * @exception booster_eprosima::fastcdr::BadParamException This exception is thrown if the requested union member is not the current selection.
     */
    BOOSTER_RTPS_DllAPI const PlainMapSTypeDefn& map_sdefn() const;
     ...
     * @exception booster_eprosima::fastcdr::BadParamException This exception is thrown if the requested union member is not the current selection.
     */
    BOOSTER_RTPS_DllAPI const PlainMapLTypeDefn& map_ldefn() const;
     ...
     * @exception booster_eprosima::fastcdr::BadParamException This exception is thrown if the requested union member is not the current selection.
     */
    BOOSTER_RTPS_DllAPI StronglyConnectedComponentId sc_component_id() const;
     ...
     * @exception booster_eprosima::fastcdr::BadParamException This exception is thrown if the requested union member is not the current selection.
     */
    BOOSTER_RTPS_DllAPI const octet* equivalence_hash() const;
     ...
     * @exception booster_eprosima::fastcdr::BadParamException This exception is thrown if the requested union member is not the current selection.
     */
    BOOSTER_RTPS_DllAPI const ExtendedTypeDefn& extended_defn() const;
     ...
     * @exception booster_eprosima::fastcdr::BadParamException This exception is thrown if the requested union member is not the current selection.
     */
    BOOSTER_RTPS_DllAPI ExtendedTypeDefn& extended_defn();
     ...
     */
    BOOSTER_FASTDDS_SER_METHOD_DEPRECATED(3, "booster_eprosima::fastrtps::types::TypeIdentifier::getCdrSerializedSize()",
     ...
     */
    BOOSTER_FASTDDS_SER_METHOD_DEPRECATED(3, "booster_eprosima::fastrtps::types::TypeIdentifier::serialize()",
     ...
     * @param cdr CDR serialization object.
     */
    BOOSTER_FASTDDS_SER_METHOD_DEPRECATED(3, "booster_eprosima::fastrtps::types::TypeIdentifier::deserialize()",
     ...
     */
    BOOSTER_RTPS_DllAPI std::string equivalence_hash_to_string() const;
...
#endif // BOOSTER_FASTDDS__TYPEIDENTIFIER_H_
