...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTRTPS_TYPES_DYNAMICDATAHELPER_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTRTPS_TYPES_DYNAMICDATAHELPER_HPP_
...
#include <booster_fastdds/fastrtps/types/DynamicTypeMember.h>
...
public:
    ...
    BOOSTER_RTPS_DllAPI static void print(
            const DynamicData_ptr& data);

    BOOSTER_RTPS_DllAPI static std::ostream& print(
            std::ostream& output,
            const DynamicData_ptr& data);
...
#endif // BOOSTER_FASTDDS__BOOSTER_FASTRTPS_TYPES_DYNAMICDATAHELPER_HPP_
