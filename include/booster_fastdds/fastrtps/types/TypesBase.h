...
#ifndef BOOSTER_FASTDDS_TYPES_BASE_H
#define BOOSTER_FASTDDS_TYPES_BASE_H
...
using booster_eprosima::fastrtps::rtps::octet;
...
// First 4 bytes of BoosterFastddsMD5 of of a member name converted to bytes
...
class BOOSTER_RTPS_DllAPI ReturnCode_t
{
    uint32_t value_;
...
constexpr uint32_t BOOSTER_FASTDDS_MEMBER_ID_INVALID {0X0FFFFFFF};
#define BOOSTER_FASTDDS_INDEX_INVALID UINT32_MAX
...
#endif // BOOSTER_FASTDDS_TYPES_BASE_H
