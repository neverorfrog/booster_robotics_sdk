...
#ifndef BOOSTER_FASTDDS_TYPES_DYNAMIC_DATA_PTR_H
#define BOOSTER_FASTDDS_TYPES_DYNAMIC_DATA_PTR_H
...
public:
    ...
    BOOSTER_RTPS_DllAPI DynamicData_ptr()
    {
    }

    BOOSTER_RTPS_DllAPI explicit DynamicData_ptr(
            DynamicData* pData);
    ...
    BOOSTER_RTPS_DllAPI DynamicData_ptr& operator =(
...
#endif // BOOSTER_FASTDDS_TYPES_DYNAMIC_DATA_PTR_H
