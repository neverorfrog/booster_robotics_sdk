...
#ifndef BOOSTER_FASTDDS__TYPEOBJECTHASHID_H_
#define BOOSTER_FASTDDS__TYPEOBJECTHASHID_H_
...
// First 14 bytes of BoosterFastddsMD5 of the serialized TypeObject using XCDR
...
#endif // BOOSTER_FASTDDS__TYPEOBJECTHASHID_H_
