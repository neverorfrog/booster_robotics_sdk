...
#ifndef BOOSTER_FASTDDS_DOMAIN_H_
#define BOOSTER_FASTDDS_DOMAIN_H_
...
public:
     ...
     */
    BOOSTER_RTPS_DllAPI DEPRECATED static Participant* createParticipant(
     ...
     */
    BOOSTER_RTPS_DllAPI static Publisher* createPublisher(
            Participant* part,
     ...
     */
    BOOSTER_RTPS_DllAPI static Subscriber* createSubscriber(
            Participant* part,
     ...
     */
    BOOSTER_RTPS_DllAPI static bool removeParticipant(
            Participant* part);
     ...
     * @return True if correctly removed.
     */
    BOOSTER_RTPS_DllAPI static bool removePublisher(
            Publisher* pub);
     ...
     * @return True if correctly removed.
     */
    BOOSTER_RTPS_DllAPI static bool removeSubscriber(
            Subscriber* sub);
     ...
     */
    BOOSTER_RTPS_DllAPI static bool getRegisteredType(
            Participant* part,
            const char* typeName,
     ...
     */
    BOOSTER_RTPS_DllAPI static bool registerType(
            Participant* part,
            fastdds::dds::TopicDataType* type);
     ...
     * @return True if correctly registered.
     */
    BOOSTER_RTPS_DllAPI static bool registerDynamicType(
            Participant* part,
     ...
     */
    BOOSTER_RTPS_DllAPI static bool unregisterType(
            Participant* part,
            const char* typeName);
     ...
     */
    BOOSTER_RTPS_DllAPI static void stopAll();
     ...
     */
    BOOSTER_RTPS_DllAPI static bool loadXMLProfilesFile(
     ...
     * @return True if correctly loaded.
     */
    BOOSTER_RTPS_DllAPI static bool loadXMLProfilesString(
            const char* data,
            size_t length);
...
#endif /* BOOSTER_FASTDDS_DOMAIN_H_ */
