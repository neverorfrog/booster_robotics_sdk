...
#ifndef BOOSTER_FASTDDS_BOOSTER_FASTRTPS_UTILS_COLLECTIONS_BOOSTER_FOONATHAN_MEMORY_HELPERS_HPP_
#define BOOSTER_FASTDDS_BOOSTER_FASTRTPS_UTILS_COLLECTIONS_BOOSTER_FOONATHAN_MEMORY_HELPERS_HPP_

#include <booster_fastdds/foonathan/memory/memory_pool.hpp>
#include <booster_fastdds/foonathan/memory/detail/debug_helpers.hpp>
...
{
    BOOSTER_FASTDDS_DEPRECATED_UNTIL(3, "booster_eprosima::fastrtps::memory_pool_block_size", "You should not use this method")
    namespace fm = booster_foonathan::memory;
...
#endif // if BOOSTER_FOONATHAN_MEMORY_DEBUG_DOUBLE_DEALLOC_CHECK
#ifdef BOOSTER_FOONATHAN_MEMORY_MEMORY_POOL_HAS_MIN_BLOCK_SIZE
           + fm::detail::memory_block_stack::implementation_offset();                         // Room for padding
#else
           + fm::detail::memory_block_stack::implementation_offset;                           // Room for padding
#endif  // BOOSTER_FOONATHAN_MEMORY_MEMORY_POOL_HAS_MIN_BLOCK_SIZE
}

}  // namespace fastrtps
}  // namespace booster_eprosima

#endif /* BOOSTER_FASTDDS_BOOSTER_FASTRTPS_UTILS_COLLECTIONS_BOOSTER_FOONATHAN_MEMORY_HELPERS_HPP_ */
