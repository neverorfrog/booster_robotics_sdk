...
#ifndef BOOSTER_FASTDDS_STRINGMATCHING_H_
#define BOOSTER_FASTDDS_STRINGMATCHING_H_
 ...
 */
class BOOSTER_RTPS_DllAPI StringMatching
{
public:
...
#endif // ifndef BOOSTER_FASTDDS_STRINGMATCHING_H_
