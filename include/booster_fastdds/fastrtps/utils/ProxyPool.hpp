...
#ifndef BOOSTER_FASTDDS_BOOSTER_FASTRTPS_UTILS_PROXY_POOL_HPP_
#define BOOSTER_FASTDDS_BOOSTER_FASTRTPS_UTILS_PROXY_POOL_HPP_
...
#endif /* BOOSTER_FASTDDS_BOOSTER_FASTRTPS_UTILS_PROXY_POOL_HPP_ */
