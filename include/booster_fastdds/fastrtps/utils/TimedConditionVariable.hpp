...
#ifndef BOOSTER_FASTDDS__UTILS_TIMEDCONDITIONVARIABLE_HPP_
#define BOOSTER_FASTDDS__UTILS_TIMEDCONDITIONVARIABLE_HPP_
...
/*
 ...
 #if BOOSTER_FASTDDS_HAVE_STRICT_REALTIME && defined(_WIN32)
 ...
 #elif BOOSTER_FASTDDS_HAVE_STRICT_REALTIME && defined(__unix__)
 */
#if BOOSTER_FASTDDS_HAVE_STRICT_REALTIME && defined(__unix__)
#include <pthread.h>
...
#endif // if BOOSTER_FASTDDS_HAVE_STRICT_REALTIME && defined(__unix__)
...
#if BOOSTER_FASTDDS_HAVE_STRICT_REALTIME && (/*defined(_WIN32) ||*/ defined(__unix__))
...
#endif // BOOSTER_FASTDDS_HAVE_STRICT_REALTIME && (/*defined(_WIN32)*/ || defined(__unix__))

}  // namespace fastrtps
}  // namespace booster_eprosima

#endif // BOOSTER_FASTDDS__UTILS_TIMEDCONDITIONVARIABLE_HPP_
