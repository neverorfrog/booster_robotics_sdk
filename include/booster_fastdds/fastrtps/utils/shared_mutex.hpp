...
#ifndef BOOSTER_FASTDDS__UTILS_SHARED_MUTEX_HPP_
#define BOOSTER_FASTDDS__UTILS_SHARED_MUTEX_HPP_
...
// Detect if the shared_lock feature is available
    ...
    !(defined(BOOSTER_FASTDDS_HAVE_CXX17) && BOOSTER_FASTDDS_HAVE_CXX17) &&  __cplusplus < 201703 )
...
#ifndef BOOSTER_FASTDDS_USE_THIRDPARTY_SHARED_MUTEX
#   if defined(_MSC_VER) && _MSVC_LANG < 202302L
#       pragma message("warning: BOOSTER_FASTDDS_USE_THIRDPARTY_SHARED_MUTEX not defined. By default use framework version.")
#   else
#       warning "BOOSTER_FASTDDS_USE_THIRDPARTY_SHARED_MUTEX not defined. By default use framework version."
#   endif // if defined(_MSC_VER) && _MSVC_LANG < 202302L
#   define BOOSTER_FASTDDS_USE_THIRDPARTY_SHARED_MUTEX 0
#endif // ifndef BOOSTER_FASTDDS_USE_THIRDPARTY_SHARED_MUTEX
...
// Detect if the share_mutex feature is available or if the user forces it
    ...
    (~BOOSTER_FASTDDS_USE_THIRDPARTY_SHARED_MUTEX + 1) || \
    /* deprecated procedure if the good one is not available*/ \
    ( !(defined(__has_include) && __has_include(<version>)) && \
    !(defined(BOOSTER_FASTDDS_HAVE_CXX17) && BOOSTER_FASTDDS_HAVE_CXX17) &&  __cplusplus < 201703 )
...
#endif // BOOSTER_FASTDDS__UTILS_SHARED_MUTEX_HPP_
