...
#ifndef BOOSTER_FASTDDS_IPFINDER_H_
#define BOOSTER_FASTDDS_IPFINDER_H_
...
public:
    ...
    BOOSTER_RTPS_DllAPI static bool getIPs(
     ...
     */
    BOOSTER_RTPS_DllAPI static bool getAllMACAddress(
...
#endif /* BOOSTER_FASTDDS_IPFINDER_H_ */
