...
/*
 ...
 - BOOSTER_FASTRTPS_VERSION_MAJOR
 - BOOSTER_FASTRTPS_VERSION_MINOR
*/
	...
	&& defined(BOOSTER_FASTRTPS_VERSION_MAJOR) \
	&& defined(BOOSTER_FASTRTPS_VERSION_MINOR)
        #pragma comment(lib, BOOSTER_EPROSIMA_LIB_PREFIX BOOSTER_EPROSIMA_STRINGIZE(BOOSTER_EPROSIMA_LIB_NAME) BOOSTER_EPROSIMA_LIB_DEBUG_TAG "-" BOOSTER_EPROSIMA_STRINGIZE(BOOSTER_FASTRTPS_VERSION_MAJOR) "." BOOSTER_EPROSIMA_STRINGIZE(BOOSTER_FASTRTPS_VERSION_MINOR) ".lib")
    #else
