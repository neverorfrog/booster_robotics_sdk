 ...
 *
 */
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_WRITERATTRIBUTES_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_WRITERATTRIBUTES_H_
...
public:
    ...
    WriterAttributes()
        ...
        , liveliness_announcement_period(BOOSTER_FASTDDS_TIME_T_INFINITE_SECONDS, BOOSTER_FASTDDS_TIME_T_INFINITE_NANOSECONDS)
        , mode(SYNCHRONOUS_WRITER)
        , disable_heartbeat_piggyback(false)
        , disable_positive_acks(false)
        , keep_duration(BOOSTER_FASTDDS_TIME_T_INFINITE_SECONDS, BOOSTER_FASTDDS_TIME_T_INFINITE_NANOSECONDS)
    {
    ...
    //! Flow controller name. Default: fastdds::rtps::BOOSTER_FASTDDS_FLOW_CONTROLLER_DEFAULT.
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_WRITERATTRIBUTES_H_ */
