...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_SERVERATTRIBUTES_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_SERVERATTRIBUTES_H_
...
public:
    ...
    BOOSTER_RTPS_DllAPI inline bool operator ==(
    ...
    BOOSTER_RTPS_DllAPI void clear()
    {
    ...
    BOOSTER_RTPS_DllAPI fastrtps::rtps::GUID_t GetParticipant() const;

    BOOSTER_RTPS_DllAPI fastrtps::rtps::GUID_t GetPDPReader() const;
    BOOSTER_RTPS_DllAPI fastrtps::rtps::GUID_t GetPDPWriter() const;

#ifndef DOXYGEN_SHOULD_SKIP_THIS
    BOOSTER_FASTDDS_DEPRECATED_UNTIL(3, "booster_eprosima::fastrtps::rtps:GetEDPPublicationsReader()",
            "Not implemented nor used functions.")
    BOOSTER_RTPS_DllAPI fastrtps::rtps::GUID_t GetEDPPublicationsReader() const;
    BOOSTER_FASTDDS_DEPRECATED_UNTIL(3, "booster_eprosima::fastrtps::rtps:GetEDPSubscriptionsWriter()",
            "Not implemented nor used functions.")
    BOOSTER_RTPS_DllAPI fastrtps::rtps::GUID_t GetEDPSubscriptionsWriter() const;

    BOOSTER_FASTDDS_DEPRECATED_UNTIL(3, "booster_eprosima::fastrtps::rtps:GetEDPPublicationsWriter()",
            "Not implemented nor used functions.")
    BOOSTER_RTPS_DllAPI fastrtps::rtps::GUID_t GetEDPPublicationsWriter() const;
    BOOSTER_FASTDDS_DEPRECATED_UNTIL(3, "booster_eprosima::fastrtps::rtps:GetEDPSubscriptionsReader()",
            "Not implemented nor used functions.")
    BOOSTER_RTPS_DllAPI fastrtps::rtps::GUID_t GetEDPSubscriptionsReader() const;
#endif // ifndef DOXYGEN_SHOULD_SKIP_THIS

    BOOSTER_RTPS_DllAPI inline bool ReadguidPrefix(
            const char* pfx)
    {
    ...
    // the template parameter is the locator kind (e.g. BOOSTER_FASTDDS_LOCATOR_KIND_UDPv4)
...
{
    BOOSTER_RTPS_DllAPI static const charT* list_separator;
    BOOSTER_RTPS_DllAPI static const charT* locator_separator;
};
 ...
 */
BOOSTER_RTPS_DllAPI bool load_environment_server_info(
 ...
 */
BOOSTER_RTPS_DllAPI const std::string& ros_discovery_server_env();
 ...
 */
BOOSTER_RTPS_DllAPI bool ros_super_client_env();
 ...
 */
BOOSTER_RTPS_DllAPI bool get_server_client_default_guidPrefix(
        int id,
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_SERVERATTRIBUTES_H_ */
