...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_SOCKET_TRANSPORT_DESCRIPTOR_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_SOCKET_TRANSPORT_DESCRIPTOR_H_
...
{
    //! Constructor
    BOOSTER_RTPS_DllAPI SocketTransportDescriptor(
    ...
    //! Copy assignment
    BOOSTER_RTPS_DllAPI SocketTransportDescriptor& operator =(
            const SocketTransportDescriptor& t) = default;

    //! Destructor
    virtual BOOSTER_RTPS_DllAPI ~SocketTransportDescriptor() = default;

    virtual BOOSTER_RTPS_DllAPI uint32_t min_send_buffer_size() const override
    {
...
#endif //BOOSTER_FASTDDS__BOOSTER_FASTDDS_SOCKET_TRANSPORT_DESCRIPTOR_H_
