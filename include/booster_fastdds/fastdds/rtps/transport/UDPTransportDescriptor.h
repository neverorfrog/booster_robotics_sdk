...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_UDP_TRANSPORT_DESCRIPTOR_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_UDP_TRANSPORT_DESCRIPTOR_
...
struct UDPTransportDescriptor : public SocketTransportDescriptor
{
    ...
    //! Constructor
    BOOSTER_RTPS_DllAPI UDPTransportDescriptor();
    ...
    //! Copy assignment
    BOOSTER_RTPS_DllAPI UDPTransportDescriptor& operator =(
            const UDPTransportDescriptor& t) = default;
...
#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_UDP_TRANSPORT_DESCRIPTOR_
