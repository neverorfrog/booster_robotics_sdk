...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_TRANSPORT_CHAININGTRANSPORT_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_TRANSPORT_CHAININGTRANSPORT_H_
...
public:
    ...
    //!  Constructor
    BOOSTER_RTPS_DllAPI ChainingTransport(
    ...
    //! Destructor
    BOOSTER_RTPS_DllAPI virtual ~ChainingTransport() = default;
     ...
     */
    BOOSTER_RTPS_DllAPI bool IsInputChannelOpen(
     ...
     */
    BOOSTER_RTPS_DllAPI bool IsLocatorSupported(
            const fastrtps::rtps::Locator_t& loc) const override
    {
     ...
     */
    BOOSTER_RTPS_DllAPI fastrtps::rtps::Locator_t RemoteToMainLocal(
            const fastrtps::rtps::Locator_t& loc) const override
    {
     ...
     */
    BOOSTER_RTPS_DllAPI bool OpenInputChannel(
     ...
     */
    BOOSTER_RTPS_DllAPI bool OpenOutputChannel(
     ...
     */
    BOOSTER_RTPS_DllAPI bool CloseInputChannel(
            const fastrtps::rtps::Locator_t& loc) override
    {
     ...
     */
    BOOSTER_RTPS_DllAPI fastrtps::rtps::LocatorList_t NormalizeLocator(
     ...
     */
    BOOSTER_RTPS_DllAPI bool is_local_locator(
     ...
     */
    BOOSTER_RTPS_DllAPI bool is_localhost_allowed() const override
    {
     ...
     */
    BOOSTER_RTPS_DllAPI bool DoInputLocatorsMatch(
     ...
     */
    BOOSTER_RTPS_DllAPI void select_locators(
     ...
     */
    BOOSTER_RTPS_DllAPI void AddDefaultOutputLocator(
     ...
     */
    BOOSTER_RTPS_DllAPI bool getDefaultMetatrafficMulticastLocators(
     ...
     */
    BOOSTER_RTPS_DllAPI bool getDefaultMetatrafficUnicastLocators(
            fastrtps::rtps::LocatorList_t& locators,
     ...
     */
    BOOSTER_RTPS_DllAPI bool getDefaultUnicastLocators(
            fastrtps::rtps::LocatorList_t& locators,
     ...
     */
    BOOSTER_RTPS_DllAPI bool fillMetatrafficMulticastLocator(
     ...
     */
    BOOSTER_RTPS_DllAPI bool fillMetatrafficUnicastLocator(
            fastrtps::rtps::Locator_t& locator,
            uint32_t metatraffic_unicast_port) const override
    {
     ...
     */
    BOOSTER_RTPS_DllAPI bool configureInitialPeerLocator(
            fastrtps::rtps::Locator_t& locator,
     ...
     */
    BOOSTER_RTPS_DllAPI bool fillUnicastLocator(
            fastrtps::rtps::Locator_t& locator,
    ...
    BOOSTER_RTPS_DllAPI bool transform_remote_locator(
     ...
     */
    BOOSTER_RTPS_DllAPI uint32_t max_recv_buffer_size() const override
    {
     ...
     */
    BOOSTER_RTPS_DllAPI virtual bool send(
     ...
     */
    BOOSTER_RTPS_DllAPI virtual void receive(
    ...
    BOOSTER_RTPS_DllAPI void update_network_interfaces() override
    {
     ...
     */
    BOOSTER_RTPS_DllAPI bool is_locator_allowed(
            const fastrtps::rtps::Locator_t& locator) const override
    {
...
#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_TRANSPORT_CHAININGTRANSPORT_H_
