...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_SHAREDMEM_TRANSPORT_DESCRIPTOR_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_SHAREDMEM_TRANSPORT_DESCRIPTOR_
 ...
 * The kind value for SharedMemTransportDescriptor is given by booster_eprosima::fastrtps::rtps::BOOSTER_FASTDDS_LOCATOR_KIND_SHM.
 *
...
struct SharedMemTransportDescriptor : public PortBasedTransportDescriptor
{
    ...
    //! Constructor
    BOOSTER_RTPS_DllAPI SharedMemTransportDescriptor();
    ...
    //! Copy assignment
    BOOSTER_RTPS_DllAPI SharedMemTransportDescriptor& operator =(
            const SharedMemTransportDescriptor& t) = default;

    //! Return the size of the shared memory segment
    BOOSTER_RTPS_DllAPI uint32_t segment_size() const
    {
        return segment_size_;
    }

    //! Set the size of the shared memory segment
    BOOSTER_RTPS_DllAPI void segment_size(
    ...
    BOOSTER_RTPS_DllAPI void max_message_size(
    ...
    BOOSTER_RTPS_DllAPI uint32_t port_queue_capacity() const
    {
        return port_queue_capacity_;
    }

    //! Set the size of the listening port (in messages)
    BOOSTER_RTPS_DllAPI void port_queue_capacity(
    ...
    BOOSTER_RTPS_DllAPI uint32_t healthy_check_timeout_ms() const
    {
        return healthy_check_timeout_ms_;
    }

    //! Set the timeout for the health check of ports (ms)
    BOOSTER_RTPS_DllAPI void healthy_check_timeout_ms(
    ...
    BOOSTER_RTPS_DllAPI std::string rtps_dump_file() const
    {
        return rtps_dump_file_;
    }

    //! Set the full path of the protocol dump file
    BOOSTER_RTPS_DllAPI void rtps_dump_file(
    ...
    BOOSTER_RTPS_DllAPI ThreadSettings dump_thread() const
    {
        return dump_thread_;
    }

    //! Set the thread settings for the transport dump thread
    BOOSTER_RTPS_DllAPI void dump_thread(
...
#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_SHAREDMEM_TRANSPORT_DESCRIPTOR_
