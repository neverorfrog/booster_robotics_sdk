...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_TCPV4_TRANSPORT_DESCRIPTOR_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_TCPV4_TRANSPORT_DESCRIPTOR_
 ...
 * The kind value for TCPv4TransportDescriptor is given by \c booster_eprosima::fastrtps::rtps::BOOSTER_FASTDDS_LOCATOR_KIND_TCPv4.
 *
...
struct TCPv4TransportDescriptor : public TCPTransportDescriptor
{
    ...
    //! Constructor
    BOOSTER_RTPS_DllAPI TCPv4TransportDescriptor();
    ...
    //! Copy assignment
    BOOSTER_RTPS_DllAPI TCPv4TransportDescriptor& operator =(
            const TCPv4TransportDescriptor& t);
...
#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_TCPV4_TRANSPORT_DESCRIPTOR_
