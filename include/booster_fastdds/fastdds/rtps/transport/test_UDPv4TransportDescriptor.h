...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_TEST_UDPV4_TRANSPORT_DESCRIPTOR_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_TEST_UDPV4_TRANSPORT_DESCRIPTOR_
...
struct test_UDPv4TransportDescriptor : public SocketTransportDescriptor
{
    ...
    //! Constructor
    BOOSTER_RTPS_DllAPI test_UDPv4TransportDescriptor();
    ...
    //! Copy assignment
    BOOSTER_RTPS_DllAPI test_UDPv4TransportDescriptor& operator =(
            const test_UDPv4TransportDescriptor& t) = delete;
...
#endif // BOOSTER_FASTDDS_TEST_UDPV4_TRANSPORT_DESCRIPTOR_
