...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_TCP_TRANSPORT_DESCRIPTOR_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_TCP_TRANSPORT_DESCRIPTOR_H_
...
struct TCPTransportDescriptor : public SocketTransportDescriptor
{
    ...
    BOOSTER_FASTDDS_TODO_BEFORE(3, 0, "Eliminate tcp_negotiation_timeout, variable not in use.")
    uint32_t tcp_negotiation_timeout;

    //! Enables the TCP_NODELAY socket option
    bool enable_tcp_nodelay;

    BOOSTER_FASTDDS_TODO_BEFORE(3, 0, "Eliminate wait_for_tcp_negotiation, variable not in use.")
    ...
    //! Constructor
    BOOSTER_RTPS_DllAPI TCPTransportDescriptor();
    ...
    //! Copy assignment
    BOOSTER_RTPS_DllAPI TCPTransportDescriptor& operator =(
            const TCPTransportDescriptor& t);
...
#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_TCP_TRANSPORT_DESCRIPTOR_H_
