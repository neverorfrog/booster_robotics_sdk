...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_RPTS_ELEM_FRAGNUM_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_RPTS_ELEM_FRAGNUM_H_
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_RPTS_ELEM_FRAGNUM_H_ */
