...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_ELEM_LOCATOR_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_ELEM_LOCATOR_H_

#include <booster_fastdds/fastrtps/fastrtps_dll.h>

#include <booster_fastdds/fastdds/rtps/common/Types.h>
#include <booster_fastdds/fastrtps/utils/IPLocator.h>
...
#define BOOSTER_FASTDDS_LOCATOR_INVALID(loc)  {loc.kind = BOOSTER_FASTDDS_LOCATOR_KIND_INVALID; loc.port = BOOSTER_FASTDDS_LOCATOR_PORT_INVALID; \
                               BOOSTER_FASTDDS_LOCATOR_ADDRESS_INVALID(loc.address); \
}
/// Invalid locator kind
#define BOOSTER_FASTDDS_LOCATOR_KIND_INVALID -1

/// Set locator IP address to 0
#define BOOSTER_FASTDDS_LOCATOR_ADDRESS_INVALID(a) {std::memset(a, 0x00, 16 * sizeof(octet));}

/// Invalid locator port
#define BOOSTER_FASTDDS_LOCATOR_PORT_INVALID 0

/// Reserved locator kind
#define BOOSTER_FASTDDS_LOCATOR_KIND_RESERVED 0
/// UDP over IPv4 locator kind
#define BOOSTER_FASTDDS_LOCATOR_KIND_UDPv4 1
/// UDP over IPv6 locator kind
#define BOOSTER_FASTDDS_LOCATOR_KIND_UDPv6 2
/// TCP over IPv4 kind
#define BOOSTER_FASTDDS_LOCATOR_KIND_TCPv4 4
/// TCP over IPv6 locator kind
#define BOOSTER_FASTDDS_LOCATOR_KIND_TCPv6 8
/// Shared memory locator kind
#define BOOSTER_FASTDDS_LOCATOR_KIND_SHM 16
 ...
 */
class BOOSTER_RTPS_DllAPI Locator_t
{
public:
     ...
     *
     * BOOSTER_FASTDDS_LOCATOR_KIND_UDPv4
     *
     * BOOSTER_FASTDDS_LOCATOR_KIND_UDPv6
     *
     * BOOSTER_FASTDDS_LOCATOR_KIND_TCPv4
     *
     * BOOSTER_FASTDDS_LOCATOR_KIND_TCPv6
     *
     * BOOSTER_FASTDDS_LOCATOR_KIND_SHM
     */
    int32_t kind;
    /// Network port
    uint32_t port;
    ...
    /// Default constructor
    Locator_t()
        : kind(BOOSTER_FASTDDS_LOCATOR_KIND_UDPv4)
    {
        port = 0;
        BOOSTER_FASTDDS_LOCATOR_ADDRESS_INVALID(address);
    }
...
inline bool IsAddressDefined(
        const Locator_t& loc)
{
    if (loc.kind == BOOSTER_FASTDDS_LOCATOR_KIND_UDPv4 || loc.kind == BOOSTER_FASTDDS_LOCATOR_KIND_TCPv4) // WAN addr in TCPv4 is optional, isn't?
    {
    ...
    else if (loc.kind == BOOSTER_FASTDDS_LOCATOR_KIND_UDPv6 || loc.kind == BOOSTER_FASTDDS_LOCATOR_KIND_TCPv6)
    {
...
/**
 * @brief Auxiliary method to check that locator kind is not BOOSTER_FASTDDS_LOCATOR_KIND_INVALID (-1).
 *
 * @param loc Locator to be checked.
 * @return true if the locator kind is not BOOSTER_FASTDDS_LOCATOR_KIND_INVALID.
 * @return false otherwise.
 */
        ...
        const Locator_t& loc)
{
    ...
    switch (loc.kind)
    {
        case BOOSTER_FASTDDS_LOCATOR_KIND_TCPv4:
        {
            output << "TCPv4:[";
            break;
        }
        case BOOSTER_FASTDDS_LOCATOR_KIND_UDPv4:
        {
            output << "UDPv4:[";
            break;
        }
        case BOOSTER_FASTDDS_LOCATOR_KIND_TCPv6:
        {
            output << "TCPv6:[";
            break;
        }
        case BOOSTER_FASTDDS_LOCATOR_KIND_UDPv6:
        {
            output << "UDPv6:[";
            break;
        }
        case BOOSTER_FASTDDS_LOCATOR_KIND_SHM:
        {
            output << "SHM:[";
            break;
        }
    ...
    // Stream address
    if (loc.kind == BOOSTER_FASTDDS_LOCATOR_KIND_UDPv4 || loc.kind == BOOSTER_FASTDDS_LOCATOR_KIND_TCPv4)
    {
    ...
    else if (loc.kind == BOOSTER_FASTDDS_LOCATOR_KIND_SHM)
    {
        if (loc.address[0] == 'M')
        {
            output << "M";
    ...
    // Stream port
    if (loc.kind == BOOSTER_FASTDDS_LOCATOR_KIND_TCPv4 || loc.kind == BOOSTER_FASTDDS_LOCATOR_KIND_TCPv6)
    {
        ...
        Locator_t& loc)
{
    ...
    if (s)
    {
        ...
        try
        {
            ...
            if (str_kind == "SHM")
            {
                kind = BOOSTER_FASTDDS_LOCATOR_KIND_SHM;
            }
            else if (str_kind == "TCPv4")
            {
                kind = BOOSTER_FASTDDS_LOCATOR_KIND_TCPv4;
            }
            else if (str_kind == "TCPv6")
            {
                kind = BOOSTER_FASTDDS_LOCATOR_KIND_TCPv6;
            }
            ...
            {
                kind = BOOSTER_FASTDDS_LOCATOR_KIND_UDPv6;
            }
            else
            {
                kind = BOOSTER_FASTDDS_LOCATOR_KIND_INVALID;
            }
            ...
            if ((kind == BOOSTER_FASTDDS_LOCATOR_KIND_UDPv4 || kind == BOOSTER_FASTDDS_LOCATOR_KIND_TCPv4) &&
                    !IPLocator::isIPv4(address))
            {
                auto addresses = IPLocator::resolveNameDNS(address);
                if (addresses.first.empty())
                {
                    loc.kind = BOOSTER_FASTDDS_LOCATOR_KIND_INVALID;
                    BOOSTER_EPROSIMA_LOG_WARNING(LOCATOR, "Error deserializing Locator");
                    return input;
                }
                address = *addresses.first.begin();
            }
            if ((kind == BOOSTER_FASTDDS_LOCATOR_KIND_UDPv6 || kind == BOOSTER_FASTDDS_LOCATOR_KIND_TCPv6) &&
...
using Locator = booster_eprosima::fastrtps::rtps::Locator_t;

} // namespace rtps
} // namespace fastdds
} // namespace booster_eprosima

#include <booster_fastdds/fastdds/rtps/common/LocatorsIterator.hpp>
...
using LocatorsIterator = booster_eprosima::fastdds::rtps::LocatorsIterator;
using Locators = booster_eprosima::fastdds::rtps::Locators;
using LocatorList_t = booster_eprosima::fastdds::rtps::LocatorList;

} // namespace rtps
} // namespace fastrtps
} // namespace booster_eprosima

#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_ELEM_LOCATOR_H_ */
