...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_MATCHINGINFO_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_MATCHINGINFO_H_
 ...
 */
#if defined(_WIN32)
    enum BOOSTER_RTPS_DllAPI MatchingStatus{
#else
        enum MatchingStatus{
#endif
 ...
 * @ingroup COMMON_MODULE
 */
class BOOSTER_RTPS_DllAPI MatchingInfo
{
public:
    //!Default constructor
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_MATCHINGINFO_H_ */
