...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RPTS_ELEM_SEQNUM_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RPTS_ELEM_SEQNUM_H_
...
#include <booster_fastdds/fastrtps/utils/fixed_size_bitmap.hpp>
...
struct BOOSTER_RTPS_DllAPI SequenceNumber_t
{
    //!
    int32_t high = 0;
    //!
...
#endif /* _BOOSTER_FASTDDS_RTPS_ELEM_SEQNUM_H_ */
