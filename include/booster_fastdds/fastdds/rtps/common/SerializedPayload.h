...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_SERIALIZEDPAYLOAD_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_SERIALIZEDPAYLOAD_H_
...
#define BOOSTER_FASTDDS_CDR_BE 0x0000
#define BOOSTER_FASTDDS_CDR_LE 0x0001
#define BOOSTER_FASTDDS_PL_CDR_BE 0x0002
#define BOOSTER_FASTDDS_PL_CDR_LE 0x0003

#if BOOSTER_FASTDDS_IS_BIG_ENDIAN_TARGET
#define BOOSTER_FASTDDS_DEFAULT_ENCAPSULATION BOOSTER_FASTDDS_CDR_BE
#define BOOSTER_FASTDDS_PL_DEFAULT_ENCAPSULATION BOOSTER_FASTDDS_PL_CDR_BE
#else
#define BOOSTER_FASTDDS_DEFAULT_ENCAPSULATION BOOSTER_FASTDDS_CDR_LE
#define BOOSTER_FASTDDS_PL_DEFAULT_ENCAPSULATION BOOSTER_FASTDDS_PL_CDR_LE
#endif  // BOOSTER_FASTDDS_IS_BIG_ENDIAN_TARGET

//!@brief Structure SerializedPayload_t.
//!@ingroup COMMON_MODULE
struct BOOSTER_RTPS_DllAPI SerializedPayload_t
{
    ...
    //!Default constructor
    SerializedPayload_t()
        : encapsulation(BOOSTER_FASTDDS_CDR_BE)
        , length(0)
        , data(nullptr)
        , max_size(0)
        , pos(0)
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_SERIALIZEDPAYLOAD_H_ */
