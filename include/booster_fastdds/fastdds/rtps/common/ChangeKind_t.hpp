...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_COMMON_CHANGEKINDT_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_COMMON_CHANGEKINDT_HPP_
 ...
 */
enum BOOSTER_RTPS_DllAPI ChangeKind_t
{
    ALIVE,                            //!< ALIVE
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_COMMON_CHANGEKINDT_HPP_ */
