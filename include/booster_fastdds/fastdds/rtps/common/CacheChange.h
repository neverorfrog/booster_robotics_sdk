...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_CACHECHANGE_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_CACHECHANGE_H_

#include <cassert>
#include <atomic>

#include <booster_fastdds/fastdds/rtps/common/ChangeKind_t.hpp>
 ...
 */
struct BOOSTER_RTPS_DllAPI CacheChange_t
{
    ...
    CacheChange_t()
        : writer_info()
    {
        inline_qos.encapsulation = DEFAULT_ENDIAN == LITTLEEND ? BOOSTER_FASTDDS_PL_CDR_LE : BOOSTER_FASTDDS_PL_CDR_BE;
    }
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_CACHECHANGE_H_ */
