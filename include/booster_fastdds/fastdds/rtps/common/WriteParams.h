 ...
 * @file WriteParams.h
 */
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_COMMON_WRITEPARAMS_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_COMMON_WRITEPARAMS_H_
 ...
 */
class BOOSTER_RTPS_DllAPI WriteParams
{
public:
...
private:
    ...
    Time_t source_timestamp_{ -1, BOOSTER_FASTDDS_TIME_T_INFINITE_NANOSECONDS };
};
...
#endif //BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_COMMON_WRITEPARAMS_H_
