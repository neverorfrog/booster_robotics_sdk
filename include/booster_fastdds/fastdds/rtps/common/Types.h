...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_COMMON_TYPES_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_COMMON_TYPES_H_
...
#include <booster_fastdds/fastdds/rtps/common/VendorId_t.hpp>
...
struct BOOSTER_RTPS_DllAPI ProtocolVersion_t
{
    octet m_major;
    octet m_minor;
    ProtocolVersion_t():
...
using VendorId_t = booster_eprosima::fastdds::rtps::VendorId_t;
using booster_eprosima::fastdds::rtps::c_VendorId_Unknown;
using booster_eprosima::fastdds::rtps::c_VendorId_eProsima;

} // namespace rtps
} // namespace fastrtps
} // namespace booster_eprosima

#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_COMMON_TYPES_H_ */
