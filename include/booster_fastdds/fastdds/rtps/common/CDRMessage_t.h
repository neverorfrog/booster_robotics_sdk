...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_CDRMESSAGE_T_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_CDRMESSAGE_T_H_
 ...
 */
struct BOOSTER_RTPS_DllAPI CDRMessage_t final
{
        ...
        : wraps(true)
    {
        ...
        if (payload.encapsulation == BOOSTER_FASTDDS_PL_CDR_BE || payload.encapsulation == BOOSTER_FASTDDS_CDR_BE)
        {
            msg_endian = BIGEND;
        }
        pos = payload.pos;
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_CDRMESSAGE_T_H_ */
