...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_COMMON_ENTITYID_T_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_COMMON_ENTITYID_T_HPP_
...
struct BOOSTER_RTPS_DllAPI EntityId_t
{
            ...
            uint32_t id)
    {
        ...
        reverse();
#endif // if !BOOSTER_FASTDDS_IS_BIG_ENDIAN_TARGET
    }
...
#endif // if BOOSTER_FASTDDS_STATISTICS
...
namespace std {
template <>
struct hash<booster_eprosima::fastrtps::rtps::EntityId_t>
{
    std::size_t operator ()(
            const booster_eprosima::fastrtps::rtps::EntityId_t& k) const
    {
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_COMMON_ENTITYID_T_HPP_ */
