...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_PORT_PARAMETERS_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_PORT_PARAMETERS_H_
...
public:
            ...
            uint32_t domainId) const
    {
        ...
        if (port > 65535)
        {
            BOOSTER_EPROSIMA_LOG_ERROR(RTPS, "Calculated port number is too high. Probably the domainId is over 232 "
            ...
            uint32_t RTPSParticipantID) const
    {
        ...
        if (port > 65535)
        {
            BOOSTER_EPROSIMA_LOG_ERROR(RTPS, "Calculated port number is too high. Probably the domainId is over 232, there are "
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_PORT_PARAMETERS_H_ */
