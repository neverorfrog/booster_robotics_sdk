...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_COMMON_REMOTELOCATORS_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_COMMON_REMOTELOCATORS_HPP_
        ...
        RemoteLocatorList& locList)
{
    ...
    if (s)
    {
        ...
        catch (std::ios_base::failure& )
        {
            ...
            BOOSTER_EPROSIMA_LOG_WARNING(REMOTE_LOCATOR_LIST, "Error deserializing RemoteLocatorList");
        }
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_COMMON_REMOTELOCATORS_HPP_ */
