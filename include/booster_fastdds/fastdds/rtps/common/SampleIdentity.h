...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_COMMON_SAMPLEIDENTITY_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_COMMON_SAMPLEIDENTITY_H_
 ...
 */
class BOOSTER_RTPS_DllAPI SampleIdentity
{
public:
...
#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_COMMON_SAMPLEIDENTITY_H_
