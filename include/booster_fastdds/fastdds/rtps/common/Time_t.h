...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_TIME_T_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_TIME_T_H_
 ...
 */
struct BOOSTER_RTPS_DllAPI Time_t
{
 ...
 * @ingroup COMMON_MODULE
 */
class BOOSTER_RTPS_DllAPI Time_t
{
public:
     ...
     */
    Time_t(
            const booster_eprosima::fastrtps::Time_t& time);
...
#define BOOSTER_FASTDDS_TIME_T_INFINITE_SECONDS (booster_eprosima::fastrtps::Time_t::INFINITE_SECONDS)
#define BOOSTER_FASTDDS_TIME_T_INFINITE_NANOSECONDS (booster_eprosima::fastrtps::Time_t::INFINITE_NANOSECONDS)

#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_TIME_T_H_ */
