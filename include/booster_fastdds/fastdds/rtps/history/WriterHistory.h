...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_WRITERHISTORY_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_WRITERHISTORY_H_
...
public:
     ...
     */
    BOOSTER_RTPS_DllAPI WriterHistory(
            const HistoryAttributes&  att);
    BOOSTER_RTPS_DllAPI virtual ~WriterHistory() override;
    ...
    BOOSTER_RTPS_DllAPI virtual bool remove_change_g(
            CacheChange_t* a_change);
    ...
    BOOSTER_RTPS_DllAPI CacheChange_t* remove_change_and_reuse(
            const SequenceNumber_t& sequence_number);
     ...
     */
    BOOSTER_RTPS_DllAPI bool remove_min_change();
    ...
    BOOSTER_RTPS_DllAPI SequenceNumber_t next_sequence_number() const
    {
...
protected:
            ...
            std::chrono::time_point<std::chrono::steady_clock> max_blocking_time)
    {
        ...
        {
            BOOSTER_EPROSIMA_LOG_ERROR(RTPS_WRITER_HISTORY,
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_WRITERHISTORY_H_ */
