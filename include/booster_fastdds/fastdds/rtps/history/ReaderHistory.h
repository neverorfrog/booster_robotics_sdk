...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_READERHISTORY_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_READERHISTORY_H_

#include <booster_fastdds/fastdds/rtps/history/History.h>
...
public:
     ...
     */
    BOOSTER_RTPS_DllAPI ReaderHistory(
            const HistoryAttributes& att);
    BOOSTER_RTPS_DllAPI ~ReaderHistory() override;
     ...
     */
    BOOSTER_RTPS_DllAPI virtual bool can_change_be_added_nts(
     ...
     */
    BOOSTER_RTPS_DllAPI virtual bool received_change(
     ...
     * @return
     */
    BOOSTER_RTPS_DllAPI bool virtual completed_change(
     ...
     * @return
     */
    BOOSTER_RTPS_DllAPI virtual bool completed_change(
            CacheChange_t* change,
            size_t unknown_missing_changes_up_to,
            fastdds::dds::SampleRejectedStatusKind& rejection_reason)
    {
     ...
     * @return True if added.
     */
    BOOSTER_RTPS_DllAPI bool add_change(
     ...
     */
    BOOSTER_RTPS_DllAPI iterator remove_change_nts(
     ...
     */
    BOOSTER_RTPS_DllAPI bool matches_change(
     ...
     * */
    BOOSTER_RTPS_DllAPI bool remove_changes_with_guid(
            const GUID_t& a_guid);
    ...
    BOOSTER_RTPS_DllAPI bool get_min_change_from(
     ...
     */
    BOOSTER_RTPS_DllAPI virtual void writer_unmatched(
            const GUID_t& writer_guid,
     ...
     */
    BOOSTER_RTPS_DllAPI virtual void writer_update_its_ownership_strength_nts(
            const GUID_t& writer_guid,
...
protected:
    ...
    BOOSTER_RTPS_DllAPI bool do_reserve_cache(
            CacheChange_t** change,
            uint32_t size) override;

    BOOSTER_RTPS_DllAPI void do_release_cache(
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_READERHISTORY_H_ */
