...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_THROUGHPUT_CONTROLLER_DESCRIPTOR_H
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_THROUGHPUT_CONTROLLER_DESCRIPTOR_H
...
struct ThroughputControllerDescriptor
{
    ...
    BOOSTER_RTPS_DllAPI ThroughputControllerDescriptor();
    BOOSTER_RTPS_DllAPI ThroughputControllerDescriptor(
            uint32_t size,
            uint32_t time);
