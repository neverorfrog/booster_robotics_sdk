...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_RESOURCES_RESOURCEEVENT_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_RESOURCES_RESOURCEEVENT_H_
...
private:
    ...
    //! Execution thread.
    std::unique_ptr<booster_eprosima::thread> thread_;
...
#endif //BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_RESOURCES_RESOURCEEVENT_H_
