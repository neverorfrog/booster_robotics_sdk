...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_DOMAIN_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_DOMAIN_H_
...
public:
     ...
     */
    BOOSTER_RTPS_DllAPI static void set_filewatch_thread_config(
     ...
     */
    BOOSTER_RTPS_DllAPI static RTPSParticipant* createParticipant(
            uint32_t domain_id,
     ...
     *          so its use may result in undefined behaviour.
     */
    BOOSTER_RTPS_DllAPI static RTPSWriter* createRTPSWriter(
            RTPSParticipant* p,
     ...
     */
    BOOSTER_RTPS_DllAPI static bool removeRTPSWriter(
            RTPSWriter* writer);
     ...
     *          so its use may result in undefined behaviour.
     */
    BOOSTER_RTPS_DllAPI static RTPSReader* createRTPSReader(
            RTPSParticipant* p,
     ...
     * @return  True if correctly removed.
     */
    BOOSTER_RTPS_DllAPI static bool removeRTPSReader(
            RTPSReader* reader);
     ...
     */
    BOOSTER_RTPS_DllAPI static bool removeRTPSParticipant(
            RTPSParticipant* p);
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_DOMAIN_H_*/
