...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_READERLISTENER_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_READERLISTENER_H_
...
#include <booster_fastdds/fastdds/rtps/common/MatchingInfo.h>
 ...
 */
class BOOSTER_RTPS_DllAPI ReaderListener
{
public:
    ...
    virtual void on_liveliness_changed(
            RTPSReader* reader,
            const booster_eprosima::fastdds::dds::LivelinessChangedStatus& status)
    {
        static_cast<void>(reader);
    ...
    virtual void on_requested_incompatible_qos(
            RTPSReader* reader,
            booster_eprosima::fastdds::dds::PolicyMask qos)
    {
        static_cast<void>(reader);
    ...
    virtual void on_sample_rejected(
            RTPSReader* reader,
            booster_eprosima::fastdds::dds::SampleRejectedStatusKind reason,
            const CacheChange_t* const change)
    {
        static_cast<void>(reader);
        static_cast<void>(reason);
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_READERLISTENER_H_ */
