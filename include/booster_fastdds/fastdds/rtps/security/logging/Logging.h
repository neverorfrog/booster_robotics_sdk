 ...
 * @file Logging.h
 */
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_SECURITY_LOGGING_LOGGING_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_SECURITY_LOGGING_LOGGING_H_

#include <limits>
#include <iomanip>

#include <booster_fastdds/fastdds/dds/log/Log.hpp>
#include <booster_fastdds/fastdds/rtps/security/logging/LogOptions.h>
#include <booster_fastdds/fastdds/rtps/security/logging/BuiltinLoggingType.h>
#include <booster_fastdds/fastdds/rtps/security/exceptions/SecurityException.h>
...
#define __BOOSTER_FASTRTPS_EXPAND(x) x

#define __BOOSTER_FASTRTPS_SECURITY_LOGGING(LEVEL, CLASS, MESSAGE, EXCEPTION) \
    do {                                                              \
        ...
        if (logger){                                                  \
            ...
            switch (LEVEL){                                           \
                ...
                case LoggingLevel::ERROR_LEVEL:                       \
                    BOOSTER_EPROSIMA_LOG_ERROR(SECURITY, MESSAGE);                      \
                    break;                                            \
                case LoggingLevel::WARNING_LEVEL:                     \
                    BOOSTER_EPROSIMA_LOG_WARNING(SECURITY, MESSAGE);                    \
                    break;                                            \
                case LoggingLevel::NOTICE_LEVEL:                      \
                case LoggingLevel::INFORMATIONAL_LEVEL:               \
                case LoggingLevel::DEBUG_LEVEL:                       \
                    BOOSTER_EPROSIMA_LOG_INFO(SECURITY, MESSAGE);                       \
                    break;                                            \
            }                                                         \
        }                                                             \
    } while (0);

#define __BOOSTER_FASTRTPS_SECURITY_LOGGING_EX(LEVEL, CLASS, MESSAGE)             \
    do {                                                                  \
        booster_eprosima::fastrtps::rtps::security::SecurityException lexception; \
        __BOOSTER_FASTRTPS_SECURITY_LOGGING(LEVEL, CLASS, MESSAGE, lexception);   \
    } while (0);

#define __BOOSTER_FASTRTPS_MACRO_SELECTOR(_1, _2, _3, _4, NAME, ...) NAME

#define SECURITY_LOGGING(...)                   \
    __BOOSTER_FASTRTPS_EXPAND(                          \
        __BOOSTER_FASTRTPS_MACRO_SELECTOR(__VA_ARGS__,  \
        __BOOSTER_FASTRTPS_SECURITY_LOGGING,            \
        __BOOSTER_FASTRTPS_SECURITY_LOGGING_EX,         \
        _UNUSED)(__VA_ARGS__))
...
#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_SECURITY_LOGGING_LOGGING_H_
