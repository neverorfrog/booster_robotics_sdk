 ...
 * @file Handle.h
 */
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_SECURITY_COMMON_HANDLE_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_SECURITY_COMMON_HANDLE_H_
...
#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_SECURITY_COMMON_HANDLE_H_
