...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_BUILTIN_DATA_PARTICIPANTPROXYDATA_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_BUILTIN_DATA_PARTICIPANTPROXYDATA_H_
...
#include <booster_fastdds/fastdds/rtps/builtin/data/BuiltinEndpoints.hpp>
...
public:
    ...
    BOOSTER_RTPS_DllAPI ParticipantProxyData(
            const RTPSParticipantAllocationAttributes& allocation);

    BOOSTER_RTPS_DllAPI ParticipantProxyData(
            const ParticipantProxyData& pdata);

    BOOSTER_RTPS_DllAPI virtual ~ParticipantProxyData();
     ...
     */
    BOOSTER_RTPS_DllAPI bool updateData(
     ...
     */
    BOOSTER_RTPS_DllAPI uint32_t get_serialized_size(
     ...
     * @return True on success
     */
    BOOSTER_RTPS_DllAPI bool writeToCDRMessage(
            CDRMessage_t* msg,
     ...
     * @return True on success
     */
    BOOSTER_RTPS_DllAPI bool readFromCDRMessage(
            CDRMessage_t* msg,
     ...
     */
    BOOSTER_RTPS_DllAPI void set_persistence_guid(
            const GUID_t& guid);
     ...
     */
    BOOSTER_RTPS_DllAPI GUID_t get_persistence_guid() const;

    /**
     * Set participant client server sample identity
     * @param sid valid SampleIdentity
     */
    BOOSTER_RTPS_DllAPI void set_sample_identity(
     ...
     */
    BOOSTER_RTPS_DllAPI SampleIdentity get_sample_identity() const;

    /**
     * Identifies the participant as client of the given server
     * @param guid valid backup server GUID
     */
    BOOSTER_RTPS_DllAPI void set_backup_stamp(
            const GUID_t& guid);
     ...
     * @return GUID
     */
    BOOSTER_RTPS_DllAPI GUID_t get_backup_stamp() const;

    BOOSTER_RTPS_DllAPI void assert_liveliness();

    BOOSTER_RTPS_DllAPI const std::chrono::steady_clock::time_point& last_received_message_tm() const
    {
        return last_received_message_tm_;
    }

    BOOSTER_RTPS_DllAPI const std::chrono::microseconds& lease_duration() const
    {
...
#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_BUILTIN_DATA_PARTICIPANTPROXYDATA_H_
