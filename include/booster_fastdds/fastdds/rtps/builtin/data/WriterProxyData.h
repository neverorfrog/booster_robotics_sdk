...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_BUILTIN_DATA_WRITERPROXYDATA_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_BUILTIN_DATA_WRITERPROXYDATA_H_
#ifndef DOXYGEN_SHOULD_SKIP_THIS_PUBLIC

#include <booster_fastdds/fastrtps/qos/WriterQos.h>
...
public:
    ...
    BOOSTER_RTPS_DllAPI WriterProxyData(
    ...
    virtual BOOSTER_RTPS_DllAPI ~WriterProxyData();

    BOOSTER_RTPS_DllAPI WriterProxyData(
            const WriterProxyData& writerInfo);

    BOOSTER_RTPS_DllAPI WriterProxyData& operator =(
            const WriterProxyData& writerInfo);
    ...
    BOOSTER_RTPS_DllAPI void persistence_guid(
            const GUID_t& guid)
    {
    ...
    BOOSTER_RTPS_DllAPI GUID_t persistence_guid() const
    {
        return persistence_guid_;
    }

    BOOSTER_RTPS_DllAPI GUID_t& persistence_guid()
    {
        return persistence_guid_;
    }

    BOOSTER_RTPS_DllAPI void set_persistence_entity_id(
    ...
    BOOSTER_RTPS_DllAPI void typeMaxSerialized(
            uint32_t typeMaxSerialized)
    {
        m_typeMaxSerialized = typeMaxSerialized;
    }

    BOOSTER_RTPS_DllAPI uint32_t typeMaxSerialized() const
    {
        return m_typeMaxSerialized;
    }

    BOOSTER_RTPS_DllAPI uint32_t& typeMaxSerialized()
    {
        return m_typeMaxSerialized;
    }
...
#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_BUILTIN_DATA_WRITERPROXYDATA_H_
