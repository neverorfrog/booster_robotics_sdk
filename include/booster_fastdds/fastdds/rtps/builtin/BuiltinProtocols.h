...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_BUILTINPROTOCOLS_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_BUILTINPROTOCOLS_H_
...
private:
     ...
     */
    mutable booster_eprosima::shared_mutex discovery_mutex_;
...
public:
    ...
    std::list<booster_eprosima::fastdds::rtps::RemoteServerAttributes> m_DiscoveryServers;
     ...
     */
    inline booster_eprosima::shared_mutex& getDiscoveryMutex() const
    {
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_BUILTINPROTOCOLS_H_ */
