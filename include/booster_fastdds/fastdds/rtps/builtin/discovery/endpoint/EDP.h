...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_EDP_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_EDP_H_
...
private:
    ...
    booster_foonathan::memory::map<GUID_t, fastdds::dds::SubscriptionMatchedStatus, pool_allocator_t> reader_status_;
    booster_foonathan::memory::map<GUID_t, fastdds::dds::PublicationMatchedStatus, pool_allocator_t> writer_status_;
};
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_EDP_H_ */
