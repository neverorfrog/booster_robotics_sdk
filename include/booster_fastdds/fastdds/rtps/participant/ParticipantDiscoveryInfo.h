...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_PARTICIPANT_PARTICIPANTDISCOVERYINFO_H__
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_PARTICIPANT_PARTICIPANTDISCOVERYINFO_H__

#include <booster_fastdds/fastrtps/fastrtps_dll.h>
#include <booster_fastdds/fastdds/rtps/builtin/data/ParticipantProxyData.h>
...
struct ParticipantDiscoveryInfo
{
    ...
    //!@ingroup RTPS_MODULE
#if defined(_WIN32)
    enum BOOSTER_RTPS_DllAPI DISCOVERY_STATUS
#else
...
{
    enum BOOSTER_RTPS_DllAPI AUTHENTICATION_STATUS
    {
...
#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_PARTICIPANT_PARTICIPANTDISCOVERYINFO_H__
