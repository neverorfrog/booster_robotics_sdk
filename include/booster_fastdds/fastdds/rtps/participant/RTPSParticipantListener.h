...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_PARTICIPANT_RTPSPARTICIPANTLISTENER_H__
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_PARTICIPANT_RTPSPARTICIPANTLISTENER_H__
 ...
 * @ingroup RTPS_MODULE
 */
class BOOSTER_RTPS_DllAPI RTPSParticipantListener
{
public:
...
#endif //BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_PARTICIPANT_RTPSPARTICIPANTLISTENER_H__
