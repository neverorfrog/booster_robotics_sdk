 ...
 */
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_WRITERLISTENER_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_WRITERLISTENER_H_
 ...
 */
class BOOSTER_RTPS_DllAPI WriterListener
{
public:
    ...
    virtual void onWriterMatched(
            RTPSWriter* writer,
            const booster_eprosima::fastdds::dds::PublicationMatchedStatus& info)
    {
        static_cast<void>(writer);
        static_cast<void>(info);
    }
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_WRITERLISTENER_H_ */
