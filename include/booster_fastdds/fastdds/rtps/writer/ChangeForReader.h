...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_CHANGEFORREADER_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_CHANGEFORREADER_H_
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_RTPS_CHANGEFORREADER_H_ */
