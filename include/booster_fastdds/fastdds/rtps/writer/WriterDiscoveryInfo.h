 ...
 */
#ifndef BOOSTER_FASTDDS__RTPS_WRITER_WRITERDISCOVERYINFO_H_
#define BOOSTER_FASTDDS__RTPS_WRITER_WRITERDISCOVERYINFO_H_
...
#endif // BOOSTER_FASTDDS__RTPS_WRITER_WRITERDISCOVERYINFO_H_
