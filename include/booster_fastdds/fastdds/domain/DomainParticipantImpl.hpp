...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_PARTICIPANTIMPL_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_PARTICIPANTIMPL_HPP_
...
#include <booster_fastdds/fastdds/rtps/reader/StatefulReader.h>
...
#include "booster_fastdds/fastdds/topic/DDSSQLFilter/DDSFilterFactory.hpp"
#include <booster_fastdds/fastdds/topic/TopicProxyFactory.hpp>
...
public:
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t get_qos(
            ...
            const std::chrono::seconds timeout = std::chrono::seconds::max())
    {
        ...
        {
            return ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_ERROR;
        }

        rtps_listener_.callback_counter_ = (listener == nullptr) ? -1 : 0;
        listener_ = listener;
        return ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_OK;
    }
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t delete_publisher(
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t delete_subscriber(
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t delete_topic(
            const Topic* topic);
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t delete_contentfilteredtopic(
            const ContentFilteredTopic* topic);

    ::booster_eprosima::fastrtps::types::ReturnCode_t register_content_filter_factory(
            const char* filter_class_name,
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t unregister_content_filter_factory(
            const char* filter_class_name);
     ...
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t register_type(
            TypeSupport type,
            const std::string& type_name);
     ...
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t unregister_type(
     ...
     *
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t ignore_participant(
    ...
    virtual ::booster_eprosima::fastrtps::types::ReturnCode_t delete_contained_entities();

    ::booster_eprosima::fastrtps::types::ReturnCode_t assert_liveliness();

    ::booster_eprosima::fastrtps::types::ReturnCode_t set_default_publisher_qos(
            const PublisherQos& qos);
    ...
    const ::booster_eprosima::fastrtps::types::ReturnCode_t get_publisher_qos_from_profile(
            const std::string& profile_name,
            PublisherQos& qos) const;

    ::booster_eprosima::fastrtps::types::ReturnCode_t set_default_subscriber_qos(
            const SubscriberQos& qos);
    ...
    const ::booster_eprosima::fastrtps::types::ReturnCode_t get_subscriber_qos_from_profile(
            const std::string& profile_name,
            SubscriberQos& qos) const;

    ::booster_eprosima::fastrtps::types::ReturnCode_t set_default_topic_qos(
            const TopicQos& qos);
    ...
    const ::booster_eprosima::fastrtps::types::ReturnCode_t get_topic_qos_from_profile(
            const std::string& profile_name,
            TopicQos& qos) const;
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t get_current_time(
     ...
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t register_remote_type(
...
protected:
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t register_dynamic_type(
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_PARTICIPANTIMPL_HPP_ */
