...
#ifndef BOOSTER_FASTDDS_BOOSTER_FASTDDS_CORE_PLICY__QOSPOLICIESSERIALIZER_HPP_
#define BOOSTER_FASTDDS_BOOSTER_FASTDDS_CORE_PLICY__QOSPOLICIESSERIALIZER_HPP_
...
inline bool QosPoliciesSerializer<DurabilityQosPolicy>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_KIND_LENGTH)
    {
        return false;
    }
...
inline bool QosPoliciesSerializer<DeadlineQosPolicy>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_TIME_LENGTH)
    {
        return false;
    }
    qos_policy.length = parameter_length;
...
inline bool QosPoliciesSerializer<LivelinessQosPolicy>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_KIND_LENGTH + BOOSTER_FASTDDS_PARAMETER_TIME_LENGTH)
    {
        return false;
    }
    qos_policy.length = parameter_length;
...
inline bool QosPoliciesSerializer<PresentationQosPolicy>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_PRESENTATION_LENGTH)
    {
        return false;
    }
    qos_policy.length = parameter_length;
...
inline bool QosPoliciesSerializer<HistoryQosPolicy>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_KIND_LENGTH + 4)
    {
        return false;
    }
    qos_policy.length = parameter_length;
...
inline bool QosPoliciesSerializer<DurabilityServiceQosPolicy>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_TIME_LENGTH + BOOSTER_FASTDDS_PARAMETER_KIND_LENGTH + 16)
    {
        return false;
    }
    qos_policy.length = parameter_length;
...
inline bool QosPoliciesSerializer<DisablePositiveACKsQosPolicy>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_BOOL_LENGTH)
    {
        return false;
    }
    qos_policy.length = parameter_length;
...
{
    booster_eprosima::fastcdr::CdrSizeCalculator calculator(booster_eprosima::fastcdr::CdrVersion::XCDRv1);
        ...
        fastrtps::rtps::CDRMessage_t* cdr_message)
{
    ...
    size_t size = calculator.calculate_serialized_size(qos_policy.m_type_identifier, current_alignment)
            + booster_eprosima::fastrtps::rtps::SerializedPayload_t::representation_header_size;
    fastrtps::rtps::SerializedPayload_t payload(static_cast<uint32_t>(size));
    booster_eprosima::fastcdr::FastBuffer fastbuffer((char*) payload.data, payload.max_size);

    booster_eprosima::fastcdr::Cdr ser(fastbuffer, booster_eprosima::fastcdr::Cdr::DEFAULT_ENDIAN,
            booster_eprosima::fastcdr::CdrVersion::XCDRv1); // Object that serializes the data.
    payload.encapsulation = ser.endianness() == booster_eprosima::fastcdr::Cdr::BIG_ENDIANNESS ? BOOSTER_FASTDDS_CDR_BE : BOOSTER_FASTDDS_CDR_LE;
        ...
        const uint16_t parameter_length)
{
    ...
    booster_eprosima::fastcdr::FastBuffer fastbuffer((char*)payload.data, parameter_length);

    fastrtps::rtps::CDRMessage::readData(cdr_message, payload.data, parameter_length); // Object that manages the raw buffer.

    booster_eprosima::fastcdr::Cdr deser(fastbuffer, booster_eprosima::fastcdr::Cdr::DEFAULT_ENDIAN
#if BOOSTER_FASTCDR_VERSION_MAJOR == 1
            , booster_eprosima::fastcdr::Cdr::CdrType::DDS_CDR
#endif // BOOSTER_FASTCDR_VERSION_MAJOR == 1
            );
    ...
    try
    {
        ...
        payload.encapsulation = deser.endianness() == booster_eprosima::fastcdr::Cdr::BIG_ENDIANNESS ? BOOSTER_FASTDDS_CDR_BE : BOOSTER_FASTDDS_CDR_LE;

        deser >> qos_policy.m_type_identifier;
    }
    catch (booster_eprosima::fastcdr::exception::Exception& /*exception*/)
    {
        qos_policy.clear();
    }
        ...
        fastrtps::rtps::CDRMessage_t* cdr_message)
{
    ...
    size_t size =
            calculator.calculate_serialized_size(qos_policy.type_information,
                    current_alignment) + booster_eprosima::fastrtps::rtps::SerializedPayload_t::representation_header_size;
    fastrtps::rtps::SerializedPayload_t payload(static_cast<uint32_t>(size));
    booster_eprosima::fastcdr::FastBuffer fastbuffer((char*) payload.data, payload.max_size);
...
#endif // BOOSTER_FASTDDS_BOOSTER_FASTDDS_CORE_PLICY__QOSPOLICIESSERIALIZER_HPP_
