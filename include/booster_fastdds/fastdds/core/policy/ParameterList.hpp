...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_QOS_PARAMETERLIST_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_QOS_PARAMETERLIST_HPP_
#ifndef DOXYGEN_SHOULD_SKIP_THIS_PUBLIC

#include <booster_fastdds/fastdds/dds/core/policy/ParameterTypes.hpp>
#include <booster_fastdds/fastdds/rtps/messages/RTPS_messages.h>
...
public:
            ...
            uint32_t& qos_size)
    {
        ...
        if (use_encapsulation)
        {
            ...
            if (encapsulation == BOOSTER_FASTDDS_PL_CDR_BE)
            {
                msg.msg_endian = fastrtps::rtps::Endianness_t::BIGEND;
            }
            else if (encapsulation == BOOSTER_FASTDDS_PL_CDR_LE)
            {
...
#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_QOS_PARAMETERLIST_HPP_
