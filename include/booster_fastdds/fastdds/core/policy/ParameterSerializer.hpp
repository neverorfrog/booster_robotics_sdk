...
#ifndef BOOSTER_FASTDDS_BOOSTER_FASTDDS_CORE_POLICY__PARAMETERSERIALIZER_HPP_
#define BOOSTER_FASTDDS_BOOSTER_FASTDDS_CORE_POLICY__PARAMETERSERIALIZER_HPP_

#include "ParameterList.hpp"

#include <booster_fastdds/fastdds/rtps/builtin/data/ContentFilterProperty.hpp>
#include <booster_fastdds/fastdds/rtps/common/CDRMessage_t.h>
...
inline bool ParameterSerializer<ParameterLocator_t>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_LOCATOR_LENGTH)
    {
        return false;
    }
...
inline bool ParameterSerializer<ParameterKey_t>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_KEY_HASH_LENGTH)
    {
        return false;
    }
    parameter.length = parameter_length;
    return fastrtps::rtps::CDRMessage::readData(cdr_message, parameter.key.value, BOOSTER_FASTDDS_PARAMETER_KEY_HASH_LENGTH);
}
...
inline bool ParameterSerializer<ParameterPort_t>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_PORT_LENGTH)
    {
        return false;
    }
    parameter.length = parameter_length;
...
inline bool ParameterSerializer<ParameterGuid_t>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_GUID_LENGTH)
    {
        return false;
    }
    parameter.length = parameter_length;
...
inline bool ParameterSerializer<ParameterProtocolVersion_t>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_PROTOCOL_LENGTH)
    {
        return false;
    }
    parameter.length = parameter_length;
...
inline bool ParameterSerializer<ParameterVendorId_t>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_VENDOR_LENGTH)
    {
        return false;
    }
    parameter.length = parameter_length;
...
inline bool ParameterSerializer<ParameterIP4Address_t>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_IP4_LENGTH)
    {
        return false;
    }
    parameter.length = parameter_length;
...
inline bool ParameterSerializer<ParameterStatusInfo_t>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_STATUS_INFO_LENGTH)
    {
        return false;
    }
    parameter.length = parameter_length;
...
inline bool ParameterSerializer<ParameterCount_t>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_COUNT_LENGTH)
    {
        return false;
    }
    parameter.length = parameter_length;
...
inline bool ParameterSerializer<ParameterEntityId_t>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_ENTITYID_LENGTH)
    {
        return false;
    }
    parameter.length = parameter_length;
...
inline bool ParameterSerializer<ParameterBuiltinEndpointSet_t>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_BUILTINENDPOINTSET_LENGTH)
    {
        return false;
    }
    parameter.length = parameter_length;
...
inline bool ParameterSerializer<ParameterNetworkConfigSet_t>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_NETWORKCONFIGSET_LENGTH)
    {
        return false;
    }
    parameter.length = parameter_length;
...
inline bool ParameterSerializer<ParameterSampleIdentity_t>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_SAMPLEIDENTITY_LENGTH)
    {
        return false;
    }
    parameter.length = parameter_length;
...
inline bool ParameterSerializer<ParameterParticipantSecurityInfo_t>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_PARTICIPANT_SECURITY_INFO_LENGTH)
    {
        return false;
    }
    parameter.length = parameter_length;
...
inline bool ParameterSerializer<ParameterEndpointSecurityInfo_t>::read_content_from_cdr_message(
        ...
        const uint16_t parameter_length)
{
    if (parameter_length != BOOSTER_FASTDDS_PARAMETER_ENDPOINT_SECURITY_INFO_LENGTH)
    {
        return false;
    }
    parameter.length = parameter_length;
...
#endif // BOOSTER_FASTDDS_BOOSTER_FASTDDS_CORE_POLICY__PARAMETERSERIALIZER_HPP_
