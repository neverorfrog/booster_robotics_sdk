...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_PUBLISHER_DATAWRITERHISTORY_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_PUBLISHER_DATAWRITERHISTORY_HPP_
...
#include <booster_fastdds/fastdds/publisher/history/DataWriterInstance.hpp>
...
public:
            ...
            const std::chrono::time_point<std::chrono::steady_clock>& max_blocking_time)
    {
        ...
        if (add)
        {
    #if BOOSTER_FASTDDS_HAVE_STRICT_REALTIME
    ...
    #endif // if BOOSTER_FASTDDS_HAVE_STRICT_REALTIME
            {
                BOOSTER_EPROSIMA_LOG_INFO(RTPS_HISTORY,
...
#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_PUBLISHER_DATAWRITERHISTORY_HPP_
