...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_PUBLISHERIMPL_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_PUBLISHERIMPL_HPP_
...
#include <booster_fastdds/fastrtps/qos/IncompatibleQosStatus.hpp>

#include <mutex>
#include <map>

#ifdef BOOSTER_FASTDDS_STATISTICS
#include <booster_fastdds/fastdds/statistics/rtps/monitor_service/interfaces/IStatusQueryable.hpp>
...
public:
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t enable();
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t delete_datawriter(
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t set_default_datawriter_qos(
            const DataWriterQos& qos);
    ...
    const ::booster_eprosima::fastrtps::types::ReturnCode_t get_datawriter_qos_from_profile(
            const std::string& profile_name,
...
#endif /* _BOOSTER_FASTDDS_PUBLISHER_HPP_ */
