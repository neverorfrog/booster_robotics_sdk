...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_PUBLISHER_FILTERING_READERFILTERCOLLECTION_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_PUBLISHER_FILTERING_READERFILTERCOLLECTION_HPP_
...
#include <booster_fastdds/foonathan/memory/container.hpp>
#include <booster_fastdds/foonathan/memory/memory_pool.hpp>

#include <booster_fastdds/fastdds/domain/DomainParticipantImpl.hpp>
#include <booster_fastdds/fastdds/publisher/filtering/DataWriterFilteredChange.hpp>
#include <booster_fastdds/fastdds/publisher/filtering/ReaderFilterInformation.hpp>
#include <booster_fastdds/fastdds/topic/TopicProxy.hpp>
#include <booster_fastdds/fastdds/topic/ContentFilterInfo.hpp>
#include <booster_fastdds/fastdds/topic/ContentFilterUtils.hpp>
...
private:
            ...
            const TypeSupport& type)
    {
        ...
        ::booster_eprosima::fastrtps::types::ReturnCode_t ret = new_factory->create_content_filter(
            class_name,
        ...
        if (::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_OK != ret)
        {
            return false;
        }
    ...
    using pool_allocator_t =
            booster_foonathan::memory::memory_pool<booster_foonathan::memory::node_pool, booster_foonathan::memory::heap_allocator>;

    pool_allocator_t reader_filter_allocator_;

    booster_foonathan::memory::map<fastrtps::rtps::GUID_t, ReaderFilterInformation, pool_allocator_t> reader_filters_;
...
#endif  //BOOSTER_FASTDDS__BOOSTER_FASTDDS_PUBLISHER_FILTERING_READERFILTERCOLLECTION_HPP_
