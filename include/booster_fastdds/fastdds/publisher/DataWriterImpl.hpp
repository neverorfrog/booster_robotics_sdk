...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTRTPS_DATAWRITERIMPL_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTRTPS_DATAWRITERIMPL_HPP_
...
#include <booster_fastdds/fastdds/dds/publisher/DataWriterListener.hpp>
...
#include <booster_fastdds/fastdds/rtps/common/WriteParams.h>
#include <booster_fastdds/fastdds/rtps/history/IChangePool.h>
#include <booster_fastdds/fastdds/rtps/history/IPayloadPool.h>
#include <booster_fastdds/fastdds/rtps/interfaces/IReaderDataFilter.hpp>
...
#include <booster_fastdds/fastdds/publisher/DataWriterHistory.hpp>
#include <booster_fastdds/fastdds/publisher/filtering/ReaderFilterCollection.hpp>
...
#ifdef BOOSTER_FASTDDS_STATISTICS
namespace statistics {
namespace dds {
class DomainParticipantImpl;
} // namespace dds
} // namespace statistics
#endif // BOOSTER_FASTDDS_STATISTICS
...
class DataWriterImpl : protected rtps::IReaderDataFilter
{
    ...
    using PayloadInfo_t = booster_eprosima::fastrtps::rtps::detail::PayloadInfo_t;
    using CacheChange_t = booster_eprosima::fastrtps::rtps::CacheChange_t;
...
#ifdef BOOSTER_FASTDDS_STATISTICS
    friend class booster_eprosima::fastdds::statistics::dds::DomainParticipantImpl;
#endif // BOOSTER_FASTDDS_STATISTICS
...
public:
     ...
     *
     * @pre This method has not previously returned ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_OK
     *
     * @return ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_OK if all the lower layer entities have been correctly created.
     * @return Other standard return codes on error.
     */
    virtual ::booster_eprosima::fastrtps::types::ReturnCode_t enable();

    /**
     * Check if the preconditions to delete this object are met.
     *
     * @return ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_PRECONDITION_NOT_MET if the preconditions to delete this object are not met.
     * @return ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_OK if it is safe to delete this object.
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t check_delete_preconditions();
     ...
     *
     * @return ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_ILLEGAL_OPERATION when the type does not support loans.
     ...
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t loan_sample(
            void*& sample,
     ...
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t discard_loan(
            void*& sample);
     ...
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t write(
            void* data,
     ...
     * @return any of the standard return codes.
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t write_w_timestamp(
            void* data,
            const InstanceHandle_t& handle,
     ...
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t unregister_instance(
            void* instance,
            const InstanceHandle_t& handle,
            bool dispose = false);
     ...
     * If the operation finishes successfully, ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_OK is returned.
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t unregister_instance_w_timestamp(
            void* instance,
            const InstanceHandle_t& handle,
            const fastrtps::Time_t& timestamp,
            bool dispose = false);
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t wait_for_acknowledgments(
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t get_publication_matched_status(
            PublicationMatchedStatus& status);

    ::booster_eprosima::fastrtps::types::ReturnCode_t get_offered_deadline_missed_status(
            fastrtps::OfferedDeadlineMissedStatus& status);

    ::booster_eprosima::fastrtps::types::ReturnCode_t get_offered_incompatible_qos_status(
            OfferedIncompatibleQosStatus& status);

    ::booster_eprosima::fastrtps::types::ReturnCode_t set_qos(
            const DataWriterQos& qos);
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t set_listener(
     ...
     * @return Any of the standard return codes.
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t get_key_value(
            void* key_holder,
            const InstanceHandle_t& handle);

    ::booster_eprosima::fastrtps::types::ReturnCode_t get_liveliness_lost_status(
            LivelinessLostStatus& status);

    const Publisher* get_publisher() const;

    ::booster_eprosima::fastrtps::types::ReturnCode_t assert_liveliness();
     ...
     * @return ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_OK if correct, ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_ERROR if not.
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t clear_history(
            size_t* removed);
     ...
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t get_sending_locators(
...
protected:
    ...
    using IChangePool = booster_eprosima::fastrtps::rtps::IChangePool;
    using IPayloadPool = booster_eprosima::fastrtps::rtps::IPayloadPool;
    using ITopicPayloadPool = booster_eprosima::fastrtps::rtps::ITopicPayloadPool;
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t check_write_preconditions(
            void* data,
            const InstanceHandle_t& handle,
            InstanceHandle_t& instance_handle);

    ::booster_eprosima::fastrtps::types::ReturnCode_t check_instance_preconditions(
            void* data,
            const InstanceHandle_t& handle,
            InstanceHandle_t& instance_handle);
     ...
     * @return
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t create_new_change(
     ...
     * @return
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t create_new_change_with_params(
            fastrtps::rtps::ChangeKind_t kind,
            void* data,
            fastrtps::rtps::WriteParams& wparams);
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t check_new_change_preconditions(
            fastrtps::rtps::ChangeKind_t change_kind,
            void* data);

    ::booster_eprosima::fastrtps::types::ReturnCode_t perform_create_new_change(
            fastrtps::rtps::ChangeKind_t change_kind,
            void* data,
            fastrtps::rtps::WriteParams& wparams,
            const InstanceHandle_t& handle);
     ...
     * @return True if correct.
     */
    static ::booster_eprosima::fastrtps::types::ReturnCode_t check_qos_including_resource_limits(
            const DataWriterQos& qos,
            const TypeSupport& type);
     ...
     * @return True if correct.
     */
    static ::booster_eprosima::fastrtps::types::ReturnCode_t check_qos(
            const DataWriterQos& qos);
     ...
     * @return True if correct.
     */
    static ::booster_eprosima::fastrtps::types::ReturnCode_t check_allocation_consistency(
            const DataWriterQos& qos);
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t check_datasharing_compatible(
...
#endif //BOOSTER_FASTDDS__BOOSTER_FASTRTPS_DATAWRITERIMPL_HPP_
