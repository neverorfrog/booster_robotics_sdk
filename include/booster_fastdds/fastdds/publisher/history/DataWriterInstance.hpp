...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_PUBLISHER_HISTORY_DATAWRITERINSTANCE_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_PUBLISHER_HISTORY_DATAWRITERINSTANCE_HPP_
...
struct DataWriterInstance
{
    ...
    BOOSTER_FASTDDS_DELETED_COPY(DataWriterInstance);
    BOOSTER_FASTDDS_DEFAULT_MOVE(DataWriterInstance);
...
#endif  // BOOSTER_FASTDDS__BOOSTER_FASTDDS_PUBLISHER_HISTORY_DATAWRITERINSTANCE_HPP_
