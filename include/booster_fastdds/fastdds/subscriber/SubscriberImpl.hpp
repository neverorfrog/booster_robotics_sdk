...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_SUBSCRIBERIMPL_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_SUBSCRIBERIMPL_HPP_
...
public:
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t delete_datareader(
     ...
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t get_datareaders(
            std::vector<DataReader*>& readers) const;

    bool has_datareaders() const;

    ::booster_eprosima::fastrtps::types::ReturnCode_t notify_datareaders() const;

    ::booster_eprosima::fastrtps::types::ReturnCode_t set_default_datareader_qos(
    ...
    const ::booster_eprosima::fastrtps::types::ReturnCode_t get_datareader_qos_from_profile(
            const std::string& profile_name,
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_SUBSCRIBERIMPL_HPP_ */
