...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTRTPS_DATAREADERIMPL_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTRTPS_DATAREADERIMPL_HPP_
...
#include <booster_fastdds/fastrtps/qos/LivelinessChangedStatus.h>
#include <booster_fastdds/fastrtps/types/TypesBase.h>

#include <booster_fastdds/fastdds/subscriber/DataReaderImpl/DataReaderLoanManager.hpp>
#include <booster_fastdds/fastdds/subscriber/DataReaderImpl/SampleInfoPool.hpp>
#include <booster_fastdds/fastdds/subscriber/DataReaderImpl/SampleLoanManager.hpp>
#include <booster_fastdds/fastdds/subscriber/DataReaderImpl/StateFilter.hpp>
#include <booster_fastdds/fastdds/subscriber/SubscriberImpl.hpp>
#include <rtps/history/ITopicPayloadPool.h>

#include <booster_fastdds/fastdds/subscriber/history/DataReaderHistory.hpp>
...
public:
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t read(
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t read_instance(
            LoanableCollection& data_values,
            SampleInfoSeq& sample_infos,
            int32_t max_samples = LENGTH_UNLIMITED,
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t read_next_instance(
            LoanableCollection& data_values,
            SampleInfoSeq& sample_infos,
            int32_t max_samples = LENGTH_UNLIMITED,
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t read_next_sample(
            void* data,
            SampleInfo* info);

    ::booster_eprosima::fastrtps::types::ReturnCode_t take(
            LoanableCollection& data_values,
            SampleInfoSeq& sample_infos,
            int32_t max_samples = LENGTH_UNLIMITED,
            SampleStateMask sample_states = ANY_SAMPLE_STATE,
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t take_instance(
            LoanableCollection& data_values,
            SampleInfoSeq& sample_infos,
            int32_t max_samples = LENGTH_UNLIMITED,
            const InstanceHandle_t& a_handle = HANDLE_NIL,
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t take_next_instance(
            LoanableCollection& data_values,
            SampleInfoSeq& sample_infos,
            int32_t max_samples = LENGTH_UNLIMITED,
            const InstanceHandle_t& previous_handle = HANDLE_NIL,
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t take_next_sample(
            void* data,
            SampleInfo* info);

    ///@}

    ::booster_eprosima::fastrtps::types::ReturnCode_t return_loan(
            LoanableCollection& data_values,
            SampleInfoSeq& sample_infos);
     ...
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t get_first_untaken_info(
            SampleInfo* info);
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t get_subscription_matched_status(
            SubscriptionMatchedStatus& status);

    ::booster_eprosima::fastrtps::types::ReturnCode_t get_requested_deadline_missed_status(
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t get_liveliness_changed_status(
            fastrtps::LivelinessChangedStatus& status);

    ::booster_eprosima::fastrtps::types::ReturnCode_t get_requested_incompatible_qos_status(
     ...
     * @return RETCODE_OK
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t get_sample_lost_status(
     ...
     * @return RETCODE_OK
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t get_sample_rejected_status(
     ...
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t get_listening_locators(
            rtps::LocatorList& locators) const;

    ::booster_eprosima::fastrtps::types::ReturnCode_t delete_contained_entities();
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t delete_readcondition(
...
protected:
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t check_collection_preconditions_and_calc_max_samples(
            LoanableCollection& data_values,
            SampleInfoSeq& sample_infos,
            int32_t& max_samples);

    ::booster_eprosima::fastrtps::types::ReturnCode_t prepare_loan(
            LoanableCollection& data_values,
            SampleInfoSeq& sample_infos,
            int32_t& max_samples);

    ::booster_eprosima::fastrtps::types::ReturnCode_t read_or_take(
            LoanableCollection& data_values,
            SampleInfoSeq& sample_infos,
            int32_t max_samples,
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t read_or_take_next_sample(
            void* data,
            SampleInfo* info,
            bool should_take);
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTRTPS_DATAREADERIMPL_HPP_*/
