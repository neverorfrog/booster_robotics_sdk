...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_SUBSCRIBER_HISTORY_DATAREADERHISTORY_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_SUBSCRIBER_HISTORY_DATAREADERHISTORY_HPP_
...
#include <booster_fastdds/fastdds/dds/topic/TopicDescription.hpp>
 ...
 */
class DataReaderHistory : public booster_eprosima::fastrtps::rtps::ReaderHistory
{
public:

    using MemoryManagementPolicy_t = booster_eprosima::fastrtps::rtps::MemoryManagementPolicy_t;
    ...
    using GUID_t = booster_eprosima::fastrtps::rtps::GUID_t;
    using SequenceNumber_t = booster_eprosima::fastrtps::rtps::SequenceNumber_t;
...
private:
    ...
    booster_eprosima::fastrtps::ResourceLimitedContainerConfig key_changes_allocation_;
    //!Resource limits for allocating the array of alive writers per instance
    booster_eprosima::fastrtps::ResourceLimitedContainerConfig key_writers_allocation_;
...
#endif  // BOOSTER_FASTDDS__BOOSTER_FASTDDS_SUBSCRIBER_HISTORY_DATAREADERHISTORY_HPP_
