...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_SUBSCRIBER_DATAREADERIMPL_READTAKECOMMAND_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_SUBSCRIBER_DATAREADERIMPL_READTAKECOMMAND_HPP_
...
#include <booster_fastdds/fastdds/subscriber/DataReaderImpl.hpp>
...
#include <booster_fastdds/fastdds/rtps/common/CacheChange.h>
...
struct ReadTakeCommand
{
    ...
    using history_type = booster_eprosima::fastdds::dds::detail::DataReaderHistory;
    using CacheChange_t = booster_eprosima::fastrtps::rtps::CacheChange_t;
    using RTPSReader = booster_eprosima::fastrtps::rtps::RTPSReader;
    using WriterProxy = booster_eprosima::fastrtps::rtps::WriterProxy;
    using SampleInfoSeq = LoanableTypedCollection<SampleInfo>;
    using DataSharingPayloadPool = booster_eprosima::fastrtps::rtps::DataSharingPayloadPool;
    ...
    ~ReadTakeCommand()
    {
        if (!data_values_.has_ownership() && ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_NO_DATA == return_value_)
        {
        ...
        while (!finished_ && it != instance_->second->cache_changes.end())
        {
            ...
            if ((check & states_.sample_states) != 0)
            {
                ...
                if (!is_future_change)
                {
                    ...
                    ::booster_eprosima::fastrtps::types::ReturnCode_t previous_return_value = return_value_;
    ...
    inline ::booster_eprosima::fastrtps::types::ReturnCode_t return_value() const
    {
            ...
            const DataReaderCacheChange& item)
    {
        ...
        switch (item->kind)
        {
            case booster_eprosima::fastrtps::rtps::NOT_ALIVE_DISPOSED:
            case booster_eprosima::fastrtps::rtps::NOT_ALIVE_DISPOSED_UNREGISTERED:
            case booster_eprosima::fastrtps::rtps::NOT_ALIVE_UNREGISTERED:
                info.valid_data = false;
                break;
            case booster_eprosima::fastrtps::rtps::ALIVE:
            default:
                break;
        }
    }
...
private:
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t return_value_ = ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_NO_DATA;
            ...
            bool& deserialization_error)
    {
        ...
        if (remaining_samples_ > 0)
        {
            ...
            return_value_ = ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_OK;
            ++current_slot_;
            --remaining_samples_;
            ret_val = true;
        }
            ...
            bool has_ownership)
    {
        ...
        if (!is_valid)
        {
            BOOSTER_EPROSIMA_LOG_WARNING(RTPS_READER,
...
#endif  // BOOSTER_FASTDDS__BOOSTER_FASTDDS_SUBSCRIBER_DATAREADERIMPL_READTAKECOMMAND_HPP_
