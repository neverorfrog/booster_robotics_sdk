...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_SUBSCRIBER_DATAREADERIMPL_DATAREADERLOANMANAGER_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_SUBSCRIBER_DATAREADERIMPL_DATAREADERLOANMANAGER_HPP_
...
struct DataReaderLoanManager
{
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t get_loan(
            ...
            SampleInfoSeq& sample_infos)
    {
        ...
        if (free_loans_.empty())
        {
            ...
            if (nullptr == result)
            {
                return ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_OUT_OF_RESOURCES;
            }
            ...
            SampleInfoSeq& sample_infos)
    {
        ...
        {
            return ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_PRECONDITION_NOT_MET;
        }
...
private:
    ...
    using collection_type = booster_eprosima::fastrtps::ResourceLimitedVector<OutstandingLoanItem>;
...
#endif  // BOOSTER_FASTDDS__BOOSTER_FASTDDS_SUBSCRIBER_DATAREADERIMPL_DATAREADERLOANMANAGER_HPP_
