...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_TOPIC_DDSSQLFILTER_DDSFILTERFACTORY_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_TOPIC_DDSSQLFILTER_DDSFILTERFACTORY_HPP_
...
public:
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t create_content_filter(
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t delete_content_filter(
            const char* filter_class_name,
            IContentFilter* filter_instance) override;
...
private:
    ...
    ::booster_eprosima::fastrtps::types::ReturnCode_t convert_tree(
            _State& state,
...
#endif  // BOOSTER_FASTDDS__BOOSTER_FASTDDS_TOPIC_DDSSQLFILTER_DDSFILTERFACTORY_HPP_
