...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_TOPIC_DDSSQLFILTER_DDSFILTEREXPRESSIONPARSER_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_TOPIC_DDSSQLFILTER_DDSFILTEREXPRESSIONPARSER_HPP_
...
std::unique_ptr<ParseNode> parse_filter_expression(
        ...
        const booster_eprosima::fastrtps::types::TypeObject* type_object);
...
#endif  // BOOSTER_FASTDDS__BOOSTER_FASTDDS_TOPIC_DDSSQLFILTER_DDSFILTEREXPRESSIONPARSER_HPP_
