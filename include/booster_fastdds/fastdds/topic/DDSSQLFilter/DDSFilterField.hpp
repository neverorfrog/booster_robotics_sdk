...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_TOPIC_DDSSQLFILTER_DDSFILTERFIELD_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_TOPIC_DDSSQLFILTER_DDSFILTERFIELD_HPP_
...
public:
     ...
     */
    DDSFilterField(
            const booster_eprosima::fastrtps::types::TypeIdentifier* type_id,
    ...
    inline bool set_value(
            booster_eprosima::fastrtps::types::DynamicData& data_value)
    {
     ...
     */
    bool set_value(
            booster_eprosima::fastrtps::types::DynamicData& data,
            size_t n);
...
private:
    ...
    bool set_value(
            const booster_eprosima::fastrtps::types::DynamicData* data,
            booster_eprosima::fastrtps::types::MemberId member_id);

    bool has_value_ = false;
    std::vector<FieldAccessor> access_path_;
    const booster_eprosima::fastrtps::types::TypeIdentifier* type_id_ = nullptr;
...
#endif  // BOOSTER_FASTDDS__BOOSTER_FASTDDS_TOPIC_DDSSQLFILTER_DDSFILTERFIELD_HPP_
