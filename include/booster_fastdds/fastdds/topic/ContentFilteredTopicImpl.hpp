...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_TOPIC_CONTENTFILTEREDTOPICIMPL_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_TOPIC_CONTENTFILTEREDTOPICIMPL_HPP_
...
#include <booster_fastdds/fastdds/topic/TopicDescriptionImpl.hpp>

namespace booster_eprosima {
namespace fastdds {
namespace dds {

class ContentFilteredTopicImpl final : public TopicDescriptionImpl, public booster_eprosima::fastdds::rtps::IReaderDataFilter
{
public:
     ...
     */
    ::booster_eprosima::fastrtps::types::ReturnCode_t set_expression_parameters(
    ...
    booster_eprosima::fastdds::rtps::ContentFilterProperty filter_property{{}};
...
#endif  // BOOSTER_FASTDDS__BOOSTER_FASTDDS_TOPIC_CONTENTFILTEREDTOPICIMPL_HPP_
