...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_STATISTICS_DDS_DOMAIN_DOMAINPARTICIPANT_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_STATISTICS_DDS_DOMAIN_DOMAINPARTICIPANT_HPP_
 ...
 */
class DomainParticipant : public booster_eprosima::fastdds::dds::DomainParticipant
{
...
public:
     ...
     * @return RETCODE_UNSUPPORTED if the BOOSTER_FASTDDS_STATISTICS CMake option has not been set,
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t enable_statistics_datawriter(
            const std::string& topic_name,
            const booster_eprosima::fastdds::dds::DataWriterQos& dwqos);
     ...
     * and RETCODE_ERROR otherwise
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t enable_statistics_datawriter_with_profile(
     ...
     * and RETCODE_ERROR otherwise
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t disable_statistics_datawriter(
            const std::string& topic_name);
     ...
     * nullptr otherwise.
     */
    BOOSTER_RTPS_DllAPI static DomainParticipant* narrow(
            booster_eprosima::fastdds::dds::DomainParticipant* domain_participant);
     ...
     * nullptr otherwise.
     */
    BOOSTER_RTPS_DllAPI static const DomainParticipant* narrow(
            const booster_eprosima::fastdds::dds::DomainParticipant* domain_participant);
     ...
     * @return RETCODE_UNSUPPORTED if BOOSTER_FASTDDS_STATISTICS is not enabled.
     *
     * @note Not supported yet. Currently returns RETCODE_UNSUPPORTED
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t enable_monitor_service();
     ...
     * @note Not supported yet. Currently returns RETCODE_UNSUPPORTED
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t disable_monitor_service();
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t fill_discovery_data_from_cdr_message(
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_STATISTICS_DDS_DOMAIN_DOMAINPARTICIPANT_HPP_ */
