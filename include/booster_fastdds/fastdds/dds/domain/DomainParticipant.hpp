...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_DOMAIN_PARTICIPANT_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_DOMAIN_PARTICIPANT_HPP_
...
#include <booster_fastdds/fastdds/dds/builtin/topic/ParticipantBuiltinTopicData.hpp>
#include <booster_fastdds/fastdds/dds/builtin/topic/TopicBuiltinTopicData.hpp>
#include <booster_fastdds/fastdds/dds/core/status/StatusMask.hpp>
#include <booster_fastdds/fastdds/dds/core/Entity.hpp>
#include <booster_fastdds/fastdds/dds/domain/qos/DomainParticipantQos.hpp>
#include <booster_fastdds/fastdds/dds/topic/ContentFilteredTopic.hpp>
...
#include <booster_fastdds/fastdds/dds/topic/TopicListener.hpp>
 ...
 *
 * @ingroup BOOSTER_FASTDDS_MODULE
 */
...
public:
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_qos(
     ...
     */
    BOOSTER_RTPS_DllAPI const DomainParticipantQos& get_qos() const;
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t set_qos(
     ...
     */
    BOOSTER_RTPS_DllAPI const DomainParticipantListener* get_listener() const;
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t set_listener(
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t enable() override;
     ...
     */
    BOOSTER_RTPS_DllAPI Publisher* create_publisher(
     ...
     * @return Pointer to the created Publisher.
     */
    BOOSTER_RTPS_DllAPI Publisher* create_publisher_with_profile(
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t delete_publisher(
     ...
     */
    BOOSTER_RTPS_DllAPI Subscriber* create_subscriber(
     ...
     * @return Pointer to the created Subscriber.
     */
    BOOSTER_RTPS_DllAPI Subscriber* create_subscriber_with_profile(
            const std::string& profile_name,
            SubscriberListener* listener = nullptr,
            const StatusMask& mask = StatusMask::all());
     ...
     * RETCODE_OK if it is correctly deleted and RETCODE_ERROR otherwise.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t delete_subscriber(
     ...
     */
    BOOSTER_RTPS_DllAPI Topic* create_topic(
     ...
     * @return Pointer to the created Topic.
     */
    BOOSTER_RTPS_DllAPI Topic* create_topic_with_profile(
            const std::string& topic_name,
            const std::string& type_name,
            const std::string& profile_name,
            TopicListener* listener = nullptr,
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t delete_topic(
            const Topic* topic);
     ...
     */
    BOOSTER_RTPS_DllAPI ContentFilteredTopic* create_contentfilteredtopic(
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t delete_contentfilteredtopic(
     ...
     */
    BOOSTER_RTPS_DllAPI MultiTopic* create_multitopic(
            const std::string& name,
            const std::string& type_name,
     ...
     *
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t delete_multitopic(
     ...
     */
    BOOSTER_RTPS_DllAPI Topic* find_topic(
            const std::string& topic_name,
     ...
     */
    BOOSTER_RTPS_DllAPI TopicDescription* lookup_topicdescription(
     ...
     */
    BOOSTER_RTPS_DllAPI const Subscriber* get_builtin_subscriber() const;
     ...
     *
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t ignore_participant(
     ...
     *
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t ignore_topic(
            const InstanceHandle_t& handle);
     ...
     *
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t ignore_publication(
            const InstanceHandle_t& handle);
     ...
     *
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t ignore_subscription(
            const InstanceHandle_t& handle);
     ...
     */
    BOOSTER_RTPS_DllAPI DomainId_t get_domain_id() const;
     ...
     * @return RETURN_OK code if everything correct, error code otherwise
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t delete_contained_entities();
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t assert_liveliness();
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t set_default_publisher_qos(
            const PublisherQos& qos);
     ...
     */
    BOOSTER_RTPS_DllAPI const PublisherQos& get_default_publisher_qos() const;
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_default_publisher_qos(
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_publisher_qos_from_profile(
            const std::string& profile_name,
            PublisherQos& qos) const;
     ...
     * @return RETCODE_INCONSISTENT_POLICY if the Qos is not self consistent and RETCODE_OK if the qos is changed correctly.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t set_default_subscriber_qos(
            const SubscriberQos& qos);
     ...
     */
    BOOSTER_RTPS_DllAPI const SubscriberQos& get_default_subscriber_qos() const;
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_default_subscriber_qos(
     ...
     * @return RETCODE_OK if the profile exists. RETCODE_BAD_PARAMETER otherwise.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_subscriber_qos_from_profile(
            const std::string& profile_name,
            SubscriberQos& qos) const;
     ...
     * @return RETCODE_INCONSISTENT_POLICY if the Qos is not self consistent and RETCODE_OK if the qos is changed correctly.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t set_default_topic_qos(
            const TopicQos& qos);
     ...
     */
    BOOSTER_RTPS_DllAPI const TopicQos& get_default_topic_qos() const;
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_default_topic_qos(
            TopicQos& qos) const;
     ...
     * @return RETCODE_OK if the profile exists. RETCODE_BAD_PARAMETER otherwise.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_topic_qos_from_profile(
            const std::string& profile_name,
            TopicQos& qos) const;
     ...
     * @warning Not supported yet. Currently returns RETCODE_UNSUPPORTED
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_discovered_participants(
     ...
     * @warning Not supported yet. Currently returns RETCODE_UNSUPPORTED
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_discovered_participant_data(
     ...
     * @warning Not supported yet. Currently returns RETCODE_UNSUPPORTED
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_discovered_topics(
     ...
     * @warning Not supported yet. Currently returns RETCODE_UNSUPPORTED
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_discovered_topic_data(
     ...
     */
    BOOSTER_RTPS_DllAPI bool contains_entity(
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_current_time(
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t register_type(
            TypeSupport type,
            const std::string& type_name);
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t unregister_type(
     ...
     */
    BOOSTER_RTPS_DllAPI TypeSupport find_type(
     ...
     */
    BOOSTER_RTPS_DllAPI const InstanceHandle_t& get_instance_handle() const;
     ...
     */
    BOOSTER_RTPS_DllAPI const fastrtps::rtps::GUID_t& guid() const;
     ...
     */
    BOOSTER_RTPS_DllAPI std::vector<std::string> get_participant_names() const;
     ...
     */
    BOOSTER_RTPS_DllAPI bool new_remote_endpoint_discovered(
     ...
     */
    BOOSTER_RTPS_DllAPI fastrtps::rtps::ResourceEvent& get_resource_event() const;
     ...
     */
    BOOSTER_RTPS_DllAPI fastrtps::rtps::SampleIdentity get_type_dependencies(
     ...
     * @return SampleIdentity
     */
    BOOSTER_RTPS_DllAPI fastrtps::rtps::SampleIdentity get_types(
            const fastrtps::types::TypeIdentifierSeq& in) const;
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t register_remote_type(
     ...
     * @return RETCODE_PRECONDITION_NOT_MET if filter_class_name is BOOSTER_FASTDDS_SQLFILTER_NAME.
     * @return RETCODE_OK if the filter is correctly registered.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t register_content_filter_factory(
            const char* filter_class_name,
     ...
     */
    BOOSTER_RTPS_DllAPI IContentFilterFactory* lookup_content_filter_factory(
            const char* filter_class_name);
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t unregister_content_filter_factory(
            const char* filter_class_name);
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_DOMAIN_PARTICIPANT_HPP_ */
