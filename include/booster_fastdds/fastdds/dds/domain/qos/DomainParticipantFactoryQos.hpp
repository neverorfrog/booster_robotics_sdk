...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_PARTICIPANTFACTORYQOS_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_PARTICIPANTFACTORYQOS_HPP_
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI DomainParticipantFactoryQos()
    {
    }
     ...
     * @brief Destructor
     */
    BOOSTER_RTPS_DllAPI virtual ~DomainParticipantFactoryQos()
    {
    }
...
BOOSTER_RTPS_DllAPI extern const DomainParticipantFactoryQos PARTICIPANT_FACTORY_QOS_DEFAULT;

} /* namespace dds */
} /* namespace fastdds */
} /* namespace booster_eprosima */

#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_PARTICIPANTFACTORYQOS_HPP_ */
