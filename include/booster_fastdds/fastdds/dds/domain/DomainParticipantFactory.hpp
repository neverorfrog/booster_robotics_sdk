...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_DOMAINPARTICIPANT_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_DOMAINPARTICIPANT_HPP_
...
public:
     ...
     */
    BOOSTER_RTPS_DllAPI static DomainParticipantFactory* get_instance();
     ...
     */
    BOOSTER_RTPS_DllAPI static std::shared_ptr<DomainParticipantFactory> get_shared_instance();
     ...
     */
    BOOSTER_RTPS_DllAPI DomainParticipant* create_participant(
     ...
     * @return DomainParticipant pointer. (nullptr if not created.)
     */
    BOOSTER_RTPS_DllAPI DomainParticipant* create_participant_with_profile(
            DomainId_t domain_id,
     ...
     */
    BOOSTER_RTPS_DllAPI DomainParticipant* lookup_participant(
     ...
     */
    BOOSTER_RTPS_DllAPI std::vector<DomainParticipant*> lookup_participants(
            DomainId_t domain_id) const;
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_default_participant_qos(
     ...
     */
    BOOSTER_RTPS_DllAPI const DomainParticipantQos& get_default_participant_qos() const;
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t set_default_participant_qos(
            const DomainParticipantQos& qos);
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_participant_qos_from_profile(
            const std::string& profile_name,
            DomainParticipantQos& qos) const;
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t delete_participant(
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t load_profiles();
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t load_XML_profiles_file(
     ...
     * @return RETCODE_OK if it is correctly loaded, RETCODE_ERROR otherwise.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t load_XML_profiles_string(
            const char* data,
            size_t length);
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t check_xml_static_discovery(
            std::string& xml_file);
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_DOMAINPARTICIPANT_HPP_*/
