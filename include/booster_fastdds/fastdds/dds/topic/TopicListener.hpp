...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_TOPICLISTENER_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_TOPICLISTENER_HPP_
 ...
 */
class BOOSTER_RTPS_DllAPI TopicListener
{
public:
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_TOPICLISTENER_HPP_ */
