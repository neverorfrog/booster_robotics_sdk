...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_TYPE_SUPPORT_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_TYPE_SUPPORT_HPP_
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI TypeSupport() noexcept = default;
     ...
     */
    BOOSTER_RTPS_DllAPI TypeSupport(
     ...
     * @param type Another instance of TypeSupport
     */
    BOOSTER_RTPS_DllAPI TypeSupport& operator = (
            const TypeSupport& type) noexcept = default;
     ...
     * @param ptr
     */
    BOOSTER_RTPS_DllAPI explicit TypeSupport(
     ...
     */
    BOOSTER_RTPS_DllAPI virtual ::booster_eprosima::fastrtps::types::ReturnCode_t register_type(
     ...
     */
    BOOSTER_RTPS_DllAPI virtual const std::string& get_type_name() const
    {
     ...
     */
    BOOSTER_RTPS_DllAPI virtual std::function<uint32_t()> get_serialized_size_provider(
            void* data)
    {
     ...
     */
    BOOSTER_RTPS_DllAPI virtual void* create_data()
    {
     ...
     */
    BOOSTER_RTPS_DllAPI virtual void delete_data(
            void* data)
    {
     ...
     * @param force_md5 boolean to force booster_fastdds_md5 (default: false)
     * @return true if the key is returned, false if not
     */
    BOOSTER_RTPS_DllAPI virtual bool get_key(
            void* data,
    ...
    BOOSTER_RTPS_DllAPI virtual bool operator ==(
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_TYPE_SUPPORT_HPP_ */
