...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_TOPIC_ICONTENTFILTERFACTORY_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_TOPIC_ICONTENTFILTERFACTORY_HPP_
...
struct IContentFilterFactory
{
    ...
    using TypeDescriptor = booster_eprosima::fastrtps::types::TypeDescriptor;
     ...
     */
    virtual ::booster_eprosima::fastrtps::types::ReturnCode_t create_content_filter(
     ...
     * @return A return code indicating the result of the operation.
     */
    virtual ::booster_eprosima::fastrtps::types::ReturnCode_t delete_content_filter(
            const char* filter_class_name,
            IContentFilter* filter_instance) = 0;
};
...
#endif  // BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_TOPIC_ICONTENTFILTERFACTORY_HPP_
