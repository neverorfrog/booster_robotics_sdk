...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_TOPIC_CONTENTFILTEREDTOPIC_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_TOPIC_CONTENTFILTEREDTOPIC_HPP_
...
#define BOOSTER_FASTDDS_SQLFILTER_NAME booster_eprosima::fastdds::dds::sqlfilter_name
...
public:
     ...
     */
    BOOSTER_RTPS_DllAPI Topic* get_related_topic() const;
     ...
     */
    BOOSTER_RTPS_DllAPI const std::string& get_filter_expression() const;
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_expression_parameters(
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t set_expression_parameters(
            const std::vector<std::string>& expression_parameters);
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t set_filter_expression(
            const std::string& filter_expression,
            const std::vector<std::string>& expression_parameters);
     ...
     */
    BOOSTER_RTPS_DllAPI DomainParticipant* get_participant() const override;
...
#endif  // BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_TOPIC_CONTENTFILTEREDTOPIC_HPP_
