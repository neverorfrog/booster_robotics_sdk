...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_TOPIC_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_TOPIC_HPP_
...
public:
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_inconsistent_topic_status(
     ...
     */
    BOOSTER_RTPS_DllAPI const TopicQos& get_qos() const;
     ...
     */
    BOOSTER_RTPS_DllAPI const TopicListener* get_listener() const;
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_TOPIC_HPP_ */
