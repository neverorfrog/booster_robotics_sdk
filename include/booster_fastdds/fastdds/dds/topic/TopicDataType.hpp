...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_TOPICDATATYPE_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_TOPICDATATYPE_HPP_
...
#define BOOSTER_FASTDDS_TOPIC_DATA_TYPE_API_HAS_IS_BOUNDED

// This version of TypeSupport has `is_plain()`
#define BOOSTER_FASTDDS_TOPIC_DATA_TYPE_API_HAS_IS_PLAIN

// This version of TypeSupport has `construct_sample()`
#define BOOSTER_FASTDDS_TOPIC_DATA_TYPE_API_HAS_CONSTRUCT_SAMPLE
 ...
 * @ingroup BOOSTER_FASTRTPS_MODULE, BOOSTER_FASTDDS_MODULE
 */
class TopicDataType
{
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI TopicDataType();

    /**
     * @brief Destructor
     */
    BOOSTER_RTPS_DllAPI virtual ~TopicDataType();
     ...
     */
    // BOOSTER_FASTDDS_TODO_BEFORE(3, 0, "Remove this overload")
    BOOSTER_RTPS_DllAPI virtual bool serialize(
            void* data,
     ...
     * @return True if correct.
     */
    BOOSTER_RTPS_DllAPI virtual bool deserialize(
            fastrtps::rtps::SerializedPayload_t* payload,
            void* data) = 0;
     ...
     */
    BOOSTER_RTPS_DllAPI virtual std::function<uint32_t()> getSerializedSizeProvider(
            void* data) = 0;
     ...
     */
    BOOSTER_RTPS_DllAPI virtual void* createData() = 0;
    /**
     * Remove a previously created object.
     *
     * @param data Pointer to the created Data.
     */
    BOOSTER_RTPS_DllAPI virtual void deleteData(
            void* data) = 0;
     ...
     * @param[in] force_md5 Force BoosterFastddsMD5 checking.
     * @return True if correct.
     */
    BOOSTER_RTPS_DllAPI virtual bool getKey(
            void* data,
     ...
     */
    BOOSTER_RTPS_DllAPI inline void setName(
            const char* nam)
    {
     ...
     */
    BOOSTER_RTPS_DllAPI inline const char* getName() const
    {
     ...
     */
    BOOSTER_RTPS_DllAPI inline bool auto_fill_type_object() const
    {
     ...
     */
    BOOSTER_RTPS_DllAPI inline void auto_fill_type_object(
     ...
     */
    BOOSTER_RTPS_DllAPI inline bool auto_fill_type_information() const
    {
     ...
     */
    BOOSTER_RTPS_DllAPI inline void auto_fill_type_information(
     ...
     * @return TypeIdV1
     */
    BOOSTER_RTPS_DllAPI inline const std::shared_ptr<TypeIdV1> type_identifier() const
    {
     ...
     * @return TypeObjectV1
     */
    BOOSTER_RTPS_DllAPI inline const std::shared_ptr<TypeObjectV1> type_object() const
    {
        return type_object_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI inline const std::shared_ptr<xtypes::TypeInformation> type_information() const
    {
     ...
     */
    BOOSTER_RTPS_DllAPI inline void type_information(
     ...
     */
    BOOSTER_RTPS_DllAPI virtual inline bool is_bounded() const
    {
        return false;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI virtual inline bool is_plain() const
    {
        return false;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI virtual inline bool is_plain(
     ...
     */
    BOOSTER_RTPS_DllAPI virtual inline bool construct_sample(
            void* memory) const
    {
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_TOPICDATATYPE_HPP_ */
