...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_SUBSCRIBER_SAMPLEINFO_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_SUBSCRIBER_SAMPLEINFO_HPP_
...
#include <booster_fastdds/fastdds/dds/common/InstanceHandle.hpp>

namespace booster_eprosima {
namespace fastdds {
namespace dds {

BOOSTER_FASTDDS_DEPRECATED_UNTIL(3, "booster_eprosima::fastdds::dds::READ",
        "Use booster_eprosima::fastdds::dds::READ_SAMPLE_STATE instead.")
constexpr SampleStateKind READ = READ_SAMPLE_STATE;

BOOSTER_FASTDDS_DEPRECATED_UNTIL(3, "booster_eprosima::fastdds::dds::NOT_READ",
        "Use booster_eprosima::fastdds::dds::NOT_READ_SAMPLE_STATE instead.")
constexpr SampleStateKind NOT_READ = NOT_READ_SAMPLE_STATE;

BOOSTER_FASTDDS_DEPRECATED_UNTIL(3, "booster_eprosima::fastdds::dds::NEW",
        "Use booster_eprosima::fastdds::dds::NEW_VIEW_STATE instead.")
constexpr ViewStateKind NEW = NEW_VIEW_STATE;

BOOSTER_FASTDDS_DEPRECATED_UNTIL(3, "booster_eprosima::fastdds::dds::NOT_NEW",
        "Use booster_eprosima::fastdds::dds::NOT_NEW_VIEW_STATE instead.")
constexpr ViewStateKind NOT_NEW = NOT_NEW_VIEW_STATE;

BOOSTER_FASTDDS_DEPRECATED_UNTIL(3, "booster_eprosima::fastdds::dds::ALIVE",
        "Use booster_eprosima::fastdds::dds::ALIVE_INSTANCE_STATE instead.")
constexpr InstanceStateKind ALIVE = ALIVE_INSTANCE_STATE;

BOOSTER_FASTDDS_DEPRECATED_UNTIL(3, "booster_eprosima::fastdds::dds::NOT_ALIVE_DISPOSED",
        "Use booster_eprosima::fastdds::dds::NOT_ALIVE_DISPOSED_INSTANCE_STATE instead.")
constexpr InstanceStateKind NOT_ALIVE_DISPOSED = NOT_ALIVE_DISPOSED_INSTANCE_STATE;

BOOSTER_FASTDDS_DEPRECATED_UNTIL(3, "booster_eprosima::fastdds::dds::NOT_ALIVE_NO_WRITERS",
        "Use booster_eprosima::fastdds::dds::NOT_ALIVE_NO_WRITERS_INSTANCE_STATE instead.")
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_SUBSCRIBER_SAMPLEINFO_HPP_*/
