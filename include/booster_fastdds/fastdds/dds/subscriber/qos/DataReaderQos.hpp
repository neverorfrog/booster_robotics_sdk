...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_DATAREADERQOS_HPP
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_DATAREADERQOS_HPP

#include <booster_fastdds/fastdds/dds/core/policy/QosPolicies.hpp>
#include <booster_fastdds/fastdds/dds/core/policy/ReaderDataLifecycleQosPolicy.hpp>
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI RTPSReliableReaderQos()
    {
    }
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~RTPSReliableReaderQos() = default;
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI ReaderResourceLimitsQos() = default;

    /**
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~ReaderResourceLimitsQos() = default;
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI TypeConsistencyQos()
        : QosPolicy(false)
    {
    }
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~TypeConsistencyQos() = default;
...
public:
    ...
    BOOSTER_RTPS_DllAPI ReaderQos get_readerqos(
     ...
     */
    BOOSTER_RTPS_DllAPI TimeBasedFilterQosPolicy& time_based_filter()
    {
     ...
     */
    BOOSTER_RTPS_DllAPI const TimeBasedFilterQosPolicy& time_based_filter() const
    {
        return time_based_filter_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void time_based_filter(
     ...
     */
    BOOSTER_RTPS_DllAPI ReaderDataLifecycleQosPolicy& reader_data_lifecycle()
    {
     ...
     */
    BOOSTER_RTPS_DllAPI const ReaderDataLifecycleQosPolicy& reader_data_lifecycle() const
    {
        return reader_data_lifecycle_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void reader_data_lifecycle(
     ...
     */
    BOOSTER_RTPS_DllAPI RTPSReliableReaderQos& reliable_reader_qos()
    {
     ...
     */
    BOOSTER_RTPS_DllAPI const RTPSReliableReaderQos& reliable_reader_qos() const
    {
        return reliable_reader_qos_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void reliable_reader_qos(
     ...
     */
    BOOSTER_RTPS_DllAPI TypeConsistencyQos& type_consistency()
    {
     ...
     */
    BOOSTER_RTPS_DllAPI const TypeConsistencyQos& type_consistency() const
    {
        return type_consistency_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void type_consistency(
     ...
     */
    BOOSTER_RTPS_DllAPI bool expects_inline_qos() const
    {
     ...
     */
    BOOSTER_RTPS_DllAPI void expects_inline_qos(
            bool new_value)
    {
     ...
     */
    BOOSTER_RTPS_DllAPI ReaderResourceLimitsQos& reader_resource_limits()
    {
     ...
     */
    BOOSTER_RTPS_DllAPI const ReaderResourceLimitsQos& reader_resource_limits() const
    {
        return reader_resource_limits_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void reader_resource_limits(
...
BOOSTER_RTPS_DllAPI extern const DataReaderQos DATAREADER_QOS_DEFAULT;

} // namespace dds
} // namespace fastdds
} // namespace booster_eprosima

#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_DATAREADERQOS_HPP
