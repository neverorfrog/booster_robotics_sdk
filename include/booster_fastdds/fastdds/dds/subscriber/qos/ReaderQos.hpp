...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_QOS_READERQOS_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_QOS_READERQOS_HPP_
...
public:
    ...
    BOOSTER_RTPS_DllAPI ReaderQos()
    {
    }

    BOOSTER_RTPS_DllAPI virtual ~ReaderQos()
    {
    }
...
#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_QOS_READERQOS_HPP_
