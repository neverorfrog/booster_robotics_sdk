...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTRTPS_DATAREADERLISTENER_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTRTPS_DATAREADERLISTENER_HPP_
...
#include <booster_fastdds/fastrtps/qos/SampleRejectedStatus.hpp>
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI DataReaderListener()
    {
    }
     ...
     * @brief Destructor
     */
    BOOSTER_RTPS_DllAPI virtual ~DataReaderListener()
    {
    }
     ...
     */
    BOOSTER_RTPS_DllAPI virtual void on_data_available(
            DataReader* reader)
    {
        (void)reader;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI virtual void on_subscription_matched(
            DataReader* reader,
     ...
     */
    BOOSTER_RTPS_DllAPI virtual void on_requested_deadline_missed(
            DataReader* reader,
     ...
     */
    BOOSTER_RTPS_DllAPI virtual void on_liveliness_changed(
            DataReader* reader,
     ...
     */
    BOOSTER_RTPS_DllAPI virtual void on_sample_rejected(
            DataReader* reader,
     ...
     */
    BOOSTER_RTPS_DllAPI virtual void on_requested_incompatible_qos(
            DataReader* reader,
     ...
     */
    BOOSTER_RTPS_DllAPI virtual void on_sample_lost(
            DataReader* reader,
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTRTPS_DATAREADERLISTENER_HPP_ */
