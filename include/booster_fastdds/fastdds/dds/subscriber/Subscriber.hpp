...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_SUBSCRIBER_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_SUBSCRIBER_HPP_
...
public:
     ...
     */
    BOOSTER_RTPS_DllAPI const SubscriberQos& get_qos() const;
     ...
     */
    BOOSTER_RTPS_DllAPI const SubscriberListener* get_listener() const;
     ...
     */
    BOOSTER_RTPS_DllAPI DataReader* create_datareader(
     ...
     * @return Pointer to the created DataReader. nullptr if failed.
     */
    BOOSTER_RTPS_DllAPI DataReader* create_datareader_with_profile(
            TopicDescription* topic,
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t delete_datareader(
     ...
     */
    BOOSTER_RTPS_DllAPI DataReader* lookup_datareader(
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_datareaders(
     ...
     */
    BOOSTER_RTPS_DllAPI bool has_datareaders() const;
     ...
     * @warning Not supported yet. Currently returns RETCODE_UNSUPPORTED
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t begin_access();
     ...
     * @warning Not supported yet. Currently returns RETCODE_UNSUPPORTED
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t end_access();
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t notify_datareaders() const;
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t set_default_datareader_qos(
     ...
     */
    BOOSTER_RTPS_DllAPI const DataReaderQos& get_default_datareader_qos() const;
     ...
     * @return Current default DataReaderQos.
     */
    BOOSTER_RTPS_DllAPI DataReaderQos& get_default_datareader_qos();
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_default_datareader_qos(
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_datareader_qos_from_profile(
            const std::string& profile_name,
            DataReaderQos& qos) const;
     ...
     * @warning Not supported yet. Currently returns RETCODE_UNSUPPORTED
     */
    BOOSTER_RTPS_DllAPI static ::booster_eprosima::fastrtps::types::ReturnCode_t copy_from_topic_qos(
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_SUBSCRIBER_HPP_ */
