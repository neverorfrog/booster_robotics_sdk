...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_SUBSCRIBER_DATAREADER_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_SUBSCRIBER_DATAREADER_HPP_

#include <cstdint>
#include <vector>

#include <booster_fastdds/fastdds/dds/builtin/topic/PublicationBuiltinTopicData.hpp>
#include <booster_fastdds/fastdds/dds/core/Entity.hpp>
#include <booster_fastdds/fastdds/dds/core/LoanableCollection.hpp>
#include <booster_fastdds/fastdds/dds/core/LoanableSequence.hpp>
...
#include <booster_fastdds/fastdds/dds/core/status/SampleRejectedStatus.hpp>
...
#include <booster_fastdds/fastdds/dds/subscriber/ReadCondition.hpp>
...
public:
     ...
     */
    BOOSTER_RTPS_DllAPI bool wait_for_unread_message(
     ...
     * @return RETCODE_OK if there is new unread message, ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_TIMEOUT if timeout
     * @warning Not supported yet. Currently returns RETCODE_UNSUPPORTED
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t wait_for_historical_data(
     ...
     * @ref booster_eprosima::fastdds::dds::DestinationOrderQosPolicy "DestinationOrderQosPolicy":
     *
     ...
     * @ref booster_eprosima::fastdds::dds::ReaderResourceLimitsQos "ReaderResourceLimitsQos":
     *
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t read(
     ...
     * @return Any of the standard return codes.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t read_w_condition(
            LoanableCollection& data_values,
            SampleInfoSeq& sample_infos,
            int32_t max_samples,
     ...
     * @return Any of the standard return codes.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t read_instance(
            LoanableCollection& data_values,
            SampleInfoSeq& sample_infos,
            int32_t max_samples = LENGTH_UNLIMITED,
     ...
     * @return Any of the standard return codes.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t read_next_instance(
            LoanableCollection& data_values,
            SampleInfoSeq& sample_infos,
            int32_t max_samples = LENGTH_UNLIMITED,
     ...
     * @return Any of the standard return codes.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t read_next_instance_w_condition(
            LoanableCollection& data_values,
            SampleInfoSeq& sample_infos,
            int32_t max_samples,
     ...
     * @return Any of the standard return codes.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t read_next_sample(
            void* data,
            SampleInfo* info);
     ...
     * @return Any of the standard return codes.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t take(
            LoanableCollection& data_values,
            SampleInfoSeq& sample_infos,
            int32_t max_samples = LENGTH_UNLIMITED,
            SampleStateMask sample_states = ANY_SAMPLE_STATE,
     ...
     * @return Any of the standard return codes.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t take_w_condition(
            LoanableCollection& data_values,
            SampleInfoSeq& sample_infos,
            int32_t max_samples,
            ReadCondition* a_condition);
     ...
     * @return Any of the standard return codes.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t take_instance(
            LoanableCollection& data_values,
            SampleInfoSeq& sample_infos,
            int32_t max_samples = LENGTH_UNLIMITED,
            const InstanceHandle_t& a_handle = HANDLE_NIL,
     ...
     * @return Any of the standard return codes.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t take_next_instance(
            LoanableCollection& data_values,
            SampleInfoSeq& sample_infos,
            int32_t max_samples = LENGTH_UNLIMITED,
            const InstanceHandle_t& previous_handle = HANDLE_NIL,
     ...
     * @return Any of the standard return codes.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t take_next_instance_w_condition(
            LoanableCollection& data_values,
            SampleInfoSeq& sample_infos,
            int32_t max_samples,
            const InstanceHandle_t& previous_handle,
     ...
     * @return Any of the standard return codes.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t take_next_sample(
            void* data,
            SampleInfo* info);
     ...
     * @return Any of the standard return codes.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t return_loan(
            LoanableCollection& data_values,
            SampleInfoSeq& sample_infos);
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_first_untaken_info(
            SampleInfo* info);
     ...
     */
    BOOSTER_RTPS_DllAPI uint64_t get_unread_count() const;
     ...
     * @return the number of samples on the reader history that have never been read.
     */
    BOOSTER_RTPS_DllAPI uint64_t get_unread_count(
     ...
     */
    BOOSTER_RTPS_DllAPI const fastrtps::rtps::GUID_t& guid();
     ...
     */
    BOOSTER_RTPS_DllAPI TypeSupport type();
     ...
     */
    BOOSTER_RTPS_DllAPI const TopicDescription* get_topicdescription() const;
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_requested_deadline_missed_status(
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_requested_incompatible_qos_status(
     ...
     */
    BOOSTER_RTPS_DllAPI const DataReaderQos& get_qos() const;
     ...
     */
    BOOSTER_RTPS_DllAPI const DataReaderListener* get_listener() const;

    /* TODO
       BOOSTER_RTPS_DllAPI bool get_key_value(
            void* data,
            const InstanceHandle_t& handle);
     */
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_liveliness_changed_status(
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_sample_lost_status(
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_sample_rejected_status(
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_subscription_matched_status(
     ...
     * @warning Not supported yet. Currently returns RETCODE_UNSUPPORTED
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_matched_publication_data(
     ...
     * @warning Not supported yet. Currently returns RETCODE_UNSUPPORTED
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_matched_publications(
     ...
     */
    BOOSTER_RTPS_DllAPI ReadCondition* create_readcondition(
     ...
     */
    BOOSTER_RTPS_DllAPI QueryCondition* create_querycondition(
            SampleStateMask sample_states,
            ViewStateMask view_states,
            InstanceStateMask instance_states,
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t delete_readcondition(
            ReadCondition* a_condition);
     ...
     */
    BOOSTER_RTPS_DllAPI const Subscriber* get_subscriber() const;
     ...
     */
    BOOSTER_RTPS_DllAPI bool is_sample_valid(
            const void* data,
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_listening_locators(
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_SUBSCRIBER_DATAREADER_HPP_*/
