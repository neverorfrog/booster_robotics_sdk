...
//
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_LOG_LOG_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_LOG_LOG_HPP_
...
// BOOSTER_EPROSIMA LOG MACROS
//! Logs an info message. Disable it through Log::SetVerbosity, define LOG_NO_INFO, or being in a release branch
#define BOOSTER_EPROSIMA_LOG_INFO(cat, msg) BOOSTER_EPROSIMA_LOG_INFO_IMPL_(cat, msg)
//! Logs a warning. Disable reporting through Log::SetVerbosity or define LOG_NO_WARNING
#define BOOSTER_EPROSIMA_LOG_WARNING(cat, msg) BOOSTER_EPROSIMA_LOG_WARNING_IMPL_(cat, msg)
//! Logs an error. Disable reporting through define LOG_NO_ERROR
#define BOOSTER_EPROSIMA_LOG_ERROR(cat, msg) BOOSTER_EPROSIMA_LOG_ERROR_IMPL_(cat, msg)

#if BOOSTER_FASTDDS_ENABLE_OLD_LOG_MACROS_
...
//! Logs an info message. Disable it through Log::SetVerbosity, define LOG_NO_INFO, or being in a release branch
#define BOOSTER_FASTDDS_logInfo(cat, msg) BOOSTER_FASTDDS_logInfo_(cat, msg)
//! Logs a warning. Disable reporting through Log::SetVerbosity or define LOG_NO_WARNING
#define BOOSTER_FASTDDS_logWarning(cat, msg) BOOSTER_FASTDDS_logWarning_(cat, msg)
//! Logs an error. Disable reporting through define LOG_NO_ERROR
#define BOOSTER_FASTDDS_logError(cat, msg) BOOSTER_FASTDDS_logError_(cat, msg)

//! Old internal macros. Just kept them in case some crazy bastard thoughtlessly used them
#define BOOSTER_FASTDDS_logInfo_(cat, msg) BOOSTER_EPROSIMA_LOG_INFO_IMPL_(cat, msg);
#define BOOSTER_FASTDDS_logWarning_(cat, msg) BOOSTER_EPROSIMA_LOG_WARNING_IMPL_(cat, msg);
#define BOOSTER_FASTDDS_logError_(cat, msg) BOOSTER_EPROSIMA_LOG_ERROR_IMPL_(cat, msg);

#endif  // BOOSTER_FASTDDS_ENABLE_OLD_LOG_MACROS_
...
public:
     ...
     *  * BOOSTER_EPROSIMA_LOG_INFO(cat, msg);
     *  * BOOSTER_EPROSIMA_LOG_WARNING(cat, msg);
     *  * BOOSTER_EPROSIMA_LOG_ERROR(cat, msg);
     *
     ...
     */
    BOOSTER_RTPS_DllAPI static void QueueLog(
...
protected:
    ...
    BOOSTER_RTPS_DllAPI void print_timestamp(
            std::ostream& stream,
            const Log::Entry&,
            bool color) const;

    BOOSTER_RTPS_DllAPI void print_header(
            std::ostream& stream,
            const Log::Entry&,
            bool color) const;

    BOOSTER_RTPS_DllAPI void print_context(
            std::ostream& stream,
            const Log::Entry&,
            bool color) const;

    BOOSTER_RTPS_DllAPI void print_message(
            std::ostream& stream,
            const Log::Entry&,
            bool color) const;

    BOOSTER_RTPS_DllAPI void print_new_line(
            std::ostream& stream,
            bool color) const;
};
...
* BOOSTER_EPROSIMA_LOG_INFO_IMPL_ would only be compiled if BOOSTER_FASTDDS_HAVE_LOG_NO_INFO is OFF and
* - BOOSTER_FASTDDS_ENFORCE_LOG_INFO or (DEBUG and INTERNALDEBUG) are defined
*
...
#if !BOOSTER_FASTDDS_HAVE_LOG_NO_ERROR

#define BOOSTER_EPROSIMA_LOG_ERROR_IMPL_(cat, msg)                                                                                 \
    do {                                                                                                               \
        using namespace booster_eprosima::fastdds::dds;                                                                        \
...
* WARNING *
***********/
#if !BOOSTER_FASTDDS_HAVE_LOG_NO_WARNING

#define BOOSTER_EPROSIMA_LOG_WARNING_IMPL_(cat, msg)                                                                            \
    do {                                                                                                            \
        using namespace booster_eprosima::fastdds::dds;                                                                     \
...
#if !BOOSTER_FASTDDS_HAVE_LOG_NO_INFO &&  \
    (defined(BOOSTER_FASTDDS_ENFORCE_LOG_INFO) || \
    ((defined(__INTERNALDEBUG) || defined(_INTERNALDEBUG)) && (defined(_DEBUG) || defined(__DEBUG) || \
    !defined(NDEBUG))))

#define BOOSTER_EPROSIMA_LOG_INFO_IMPL_(cat, msg)                                                                   \
    do {                                                                                                \
        using namespace booster_eprosima::fastdds::dds;                                                         \
...
#endif // ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_LOG_LOG_HPP_
