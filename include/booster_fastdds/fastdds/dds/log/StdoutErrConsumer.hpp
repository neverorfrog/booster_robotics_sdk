...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_LOG_STDOUTERRCONSUMER_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_LOG_STDOUTERRCONSUMER_HPP_
...
public:
     ...
     */
    BOOSTER_RTPS_DllAPI virtual void stderr_threshold(
            const Log::Kind& kind);
     ...
     */
    BOOSTER_RTPS_DllAPI virtual Log::Kind stderr_threshold() const;
...
#endif // ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_LOG_STDOUTERRCONSUMER_HPP_
