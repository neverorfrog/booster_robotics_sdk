...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_PUBLISHERLISTENER_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_PUBLISHERLISTENER_HPP_
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI PublisherListener()
    {
    }
     ...
     * @brief Destructor
     */
    BOOSTER_RTPS_DllAPI virtual ~PublisherListener()
    {
    }
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_PUBLISHERLISTENER_HPP_ */
