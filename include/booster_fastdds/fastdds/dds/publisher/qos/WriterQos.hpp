...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_QOS_WRITERQOS_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_QOS_WRITERQOS_HPP_
 ...
 * @ingroup BOOSTER_FASTRTPS_ATTRIBUTES_MODULE
 */
class WriterQos
{
public:

    BOOSTER_RTPS_DllAPI WriterQos();
    BOOSTER_RTPS_DllAPI virtual ~WriterQos();
     ...
     */
    BOOSTER_RTPS_DllAPI void setQos(
            const WriterQos& qos,
            bool first_time);
     ...
     */
    BOOSTER_RTPS_DllAPI bool checkQos() const;

    BOOSTER_RTPS_DllAPI bool canQosBeUpdated(
            const WriterQos& qos) const;

    void clear();
};

//BOOSTER_RTPS_DllAPI extern const WriterQos DATAWRITER_QOS_DEFAULT;

} //namespace dds
} //namespace fastdds
} //namespace booster_eprosima

#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_QOS_WRITERQOS_HPP_
