...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_DATAWRITERQOS_HPP
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_DATAWRITERQOS_HPP

#include <booster_fastdds/fastdds/dds/core/policy/QosPolicies.hpp>
#include <booster_fastdds/fastdds/dds/publisher/qos/WriterQos.hpp>
#include <booster_fastdds/fastdds/dds/publisher/qos/PublisherQos.hpp>
#include <booster_fastdds/fastdds/dds/core/policy/WriterDataLifecycleQosPolicy.hpp>
#include <booster_fastdds/fastdds/dds/publisher/qos/PublisherQos.hpp>
#include <booster_fastdds/fastdds/dds/publisher/qos/WriterQos.hpp>
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI RTPSReliableWriterQos()
    {
    }
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~RTPSReliableWriterQos() = default;
 ...
 *
 * @ingroup BOOSTER_FASTDDS_QOS_MODULE
 */
class DataWriterQos
{
public:
     ...
     * @brief Destructor
     */
    BOOSTER_RTPS_DllAPI ~DataWriterQos() = default;
    ...
    BOOSTER_RTPS_DllAPI WriterQos get_writerqos(
     ...
     */
    BOOSTER_RTPS_DllAPI DurabilityQosPolicy& durability()
    {
        return durability_;
    }
     ...
     * @return DurabilityQosPolicy reference
     */
    BOOSTER_RTPS_DllAPI const DurabilityQosPolicy& durability() const
    {
        return durability_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void durability(
     ...
     */
    BOOSTER_RTPS_DllAPI DurabilityServiceQosPolicy& durability_service()
    {
     ...
     * @return DurabilityServiceQosPolicy reference
     */
    BOOSTER_RTPS_DllAPI const DurabilityServiceQosPolicy& durability_service() const
    {
        return durability_service_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void durability_service(
     ...
     */
    BOOSTER_RTPS_DllAPI DeadlineQosPolicy& deadline()
    {
        return deadline_;
    }
     ...
     * @return DeadlineQosPolicy reference
     */
    BOOSTER_RTPS_DllAPI const DeadlineQosPolicy& deadline() const
    {
        return deadline_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void deadline(
     ...
     */
    BOOSTER_RTPS_DllAPI LatencyBudgetQosPolicy& latency_budget()
    {
     ...
     * @return LatencyBudgetQosPolicy reference
     */
    BOOSTER_RTPS_DllAPI const LatencyBudgetQosPolicy& latency_budget() const
    {
        return latency_budget_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void latency_budget(
     ...
     */
    BOOSTER_RTPS_DllAPI LivelinessQosPolicy& liveliness()
    {
        return liveliness_;
    }
     ...
     * @return LivelinessQosPolicy reference
     */
    BOOSTER_RTPS_DllAPI const LivelinessQosPolicy& liveliness() const
    {
        return liveliness_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void liveliness(
     ...
     */
    BOOSTER_RTPS_DllAPI ReliabilityQosPolicy& reliability()
    {
        return reliability_;
    }
     ...
     * @return ReliabilityQosPolicy reference
     */
    BOOSTER_RTPS_DllAPI const ReliabilityQosPolicy& reliability() const
    {
        return reliability_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void reliability(
     ...
     */
    BOOSTER_RTPS_DllAPI DestinationOrderQosPolicy& destination_order()
    {
     ...
     * @return DestinationOrderQosPolicy reference
     */
    BOOSTER_RTPS_DllAPI const DestinationOrderQosPolicy& destination_order() const
    {
        return destination_order_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void destination_order(
     ...
     */
    BOOSTER_RTPS_DllAPI HistoryQosPolicy& history()
    {
        return history_;
    }
     ...
     * @return HistoryQosPolicy reference
     */
    BOOSTER_RTPS_DllAPI const HistoryQosPolicy& history() const
    {
        return history_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void history(
     ...
     */
    BOOSTER_RTPS_DllAPI ResourceLimitsQosPolicy& resource_limits()
    {
     ...
     * @return ResourceLimitsQosPolicy reference
     */
    BOOSTER_RTPS_DllAPI const ResourceLimitsQosPolicy& resource_limits() const
    {
        return resource_limits_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void resource_limits(
     ...
     */
    BOOSTER_RTPS_DllAPI TransportPriorityQosPolicy& transport_priority()
    {
     ...
     * @return TransportPriorityQosPolicy reference
     */
    BOOSTER_RTPS_DllAPI const TransportPriorityQosPolicy& transport_priority() const
    {
        return transport_priority_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void transport_priority(
     ...
     */
    BOOSTER_RTPS_DllAPI LifespanQosPolicy& lifespan()
    {
        return lifespan_;
    }
     ...
     * @return LifespanQosPolicy reference
     */
    BOOSTER_RTPS_DllAPI const LifespanQosPolicy& lifespan() const
    {
        return lifespan_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void lifespan(
     ...
     */
    BOOSTER_RTPS_DllAPI UserDataQosPolicy& user_data()
    {
        return user_data_;
    }
     ...
     * @return UserDataQosPolicy reference
     */
    BOOSTER_RTPS_DllAPI const UserDataQosPolicy& user_data() const
    {
        return user_data_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void user_data(
     ...
     */
    BOOSTER_RTPS_DllAPI OwnershipQosPolicy& ownership()
    {
        return ownership_;
    }
     ...
     * @return OwnershipQosPolicy reference
     */
    BOOSTER_RTPS_DllAPI const OwnershipQosPolicy& ownership() const
    {
        return ownership_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void ownership(
     ...
     */
    BOOSTER_RTPS_DllAPI OwnershipStrengthQosPolicy& ownership_strength()
    {
     ...
     * @return OwnershipStrengthQosPolicy reference
     */
    BOOSTER_RTPS_DllAPI const OwnershipStrengthQosPolicy& ownership_strength() const
    {
        return ownership_strength_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void ownership_strength(
     ...
     */
    BOOSTER_RTPS_DllAPI WriterDataLifecycleQosPolicy& writer_data_lifecycle()
    {
     ...
     * @return WriterDataLifecycleQosPolicy reference
     */
    BOOSTER_RTPS_DllAPI const WriterDataLifecycleQosPolicy& writer_data_lifecycle() const
    {
        return writer_data_lifecycle_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void writer_data_lifecycle(
     ...
     */
    BOOSTER_RTPS_DllAPI PublishModeQosPolicy& publish_mode()
    {
     ...
     * @return PublishModeQosPolicy reference
     */
    BOOSTER_RTPS_DllAPI const PublishModeQosPolicy& publish_mode() const
    {
        return publish_mode_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void publish_mode(
     ...
     */
    BOOSTER_RTPS_DllAPI DataRepresentationQosPolicy& representation()
    {
     ...
     * @return DataRepresentationQosPolicy reference
     */
    BOOSTER_RTPS_DllAPI const DataRepresentationQosPolicy& representation() const
    {
        return representation_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void representation(
     ...
     */
    BOOSTER_RTPS_DllAPI PropertyPolicyQos& properties()
    {
        return properties_;
    }
     ...
     * @return PropertyPolicyQos reference
     */
    BOOSTER_RTPS_DllAPI const PropertyPolicyQos& properties() const
    {
        return properties_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void properties(
     ...
     */
    BOOSTER_RTPS_DllAPI RTPSReliableWriterQos& reliable_writer_qos()
    {
     ...
     * @return RTPSReliableWriterQos reference
     */
    BOOSTER_RTPS_DllAPI const RTPSReliableWriterQos& reliable_writer_qos() const
    {
        return reliable_writer_qos_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void reliable_writer_qos(
     ...
     */
    BOOSTER_RTPS_DllAPI RTPSEndpointQos& endpoint()
    {
        return endpoint_;
    }
     ...
     * @return RTPSEndpointQos reference
     */
    BOOSTER_RTPS_DllAPI const RTPSEndpointQos& endpoint() const
    {
        return endpoint_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void endpoint(
     ...
     */
    BOOSTER_RTPS_DllAPI WriterResourceLimitsQos& writer_resource_limits()
    {
     ...
     * @return WriterResourceLimitsQos reference
     */
    BOOSTER_RTPS_DllAPI const WriterResourceLimitsQos& writer_resource_limits() const
    {
        return writer_resource_limits_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void writer_resource_limits(
     ...
     */
    BOOSTER_RTPS_DllAPI fastrtps::rtps::ThroughputControllerDescriptor& throughput_controller()
    {
     ...
     * @deprecated Use flow_controllers() on DomainParticipantQoS
     */
    BOOSTER_RTPS_DllAPI const fastrtps::rtps::ThroughputControllerDescriptor& throughput_controller() const
    {
        return throughput_controller_;
    }
     ...
     * @deprecated Use flow_controllers() on DomainParticipantQoS
     */
    BOOSTER_RTPS_DllAPI void throughput_controller(
     ...
     */
    BOOSTER_RTPS_DllAPI DataSharingQosPolicy& data_sharing()
    {
     ...
     * @return DataSharingQosPolicy reference
     */
    BOOSTER_RTPS_DllAPI const DataSharingQosPolicy& data_sharing() const
    {
        return data_sharing_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void data_sharing(
...
BOOSTER_RTPS_DllAPI extern const DataWriterQos DATAWRITER_QOS_DEFAULT;

} // namespace dds
} // namespace fastdds
} // namespace booster_eprosima

#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_DATAWRITERQOS_HPP
