...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_PUBLISHERQOS_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_PUBLISHERQOS_HPP_
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI PublisherQos()
    {
    }
     ...
     * @brief Destructor
     */
    BOOSTER_RTPS_DllAPI virtual ~PublisherQos() = default;
...
BOOSTER_RTPS_DllAPI extern const PublisherQos PUBLISHER_QOS_DEFAULT;

} // namespace dds
} // namespace fastdds
} // namespace booster_eprosima

#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_PUBLISHERQOS_HPP_
