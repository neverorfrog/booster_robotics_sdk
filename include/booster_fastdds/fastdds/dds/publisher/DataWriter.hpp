...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_PUBLISHER_DATAWRITER_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_PUBLISHER_DATAWRITER_HPP_

#include <booster_fastdds/fastdds/dds/builtin/topic/SubscriptionBuiltinTopicData.hpp>
...
public:
     ...
     */
    BOOSTER_RTPS_DllAPI bool write(
            void* data);
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t write(
            void* data,
            const InstanceHandle_t& handle);

    /**
     * @brief This operation performs the same function as write except that it also provides the value for the
     * @ref booster_eprosima::fastdds::dds::SampleInfo::source_timestamp "source_timestamp" that is made available to DataReader
     * objects by means of the @ref booster_eprosima::fastdds::dds::SampleInfo::source_timestamp attribute "source_timestamp"
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t write_w_timestamp(
            void* data,
            const InstanceHandle_t& handle,
            const fastrtps::Time_t& timestamp);

#ifndef DOXYGEN_SHOULD_SKIP_THIS
    BOOSTER_FASTDDS_DEPRECATED_UNTIL(3, "booster_eprosima::fastdds::dds:DataWriter::write_w_timestamp()",
            "In favor of version using booster_eprosima::fastrtps::Time_t.")
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t write_w_timestamp(
            void* data,
            const InstanceHandle_t& handle,
     ...
     */
    BOOSTER_RTPS_DllAPI InstanceHandle_t register_instance(
            void* instance);
     ...
     * @ref booster_eprosima::fastdds::dds::SampleInfo::source_timestamp "source_timestamp".
     * The @ref booster_eprosima::fastdds::dds::SampleInfo::source_timestamp "source_timestamp" potentially affects the relative
     * order in which readers observe events from multiple writers. See the QoS policy
     * @ref booster_eprosima::fastdds::dds::DataWriterQos::destination_order "DESTINATION_ORDER".
     *
     ...
     * @return Handle containing the instance's key.
     */
    BOOSTER_RTPS_DllAPI InstanceHandle_t register_instance_w_timestamp(
            void* instance,
            const fastrtps::Time_t& timestamp);

#ifndef DOXYGEN_SHOULD_SKIP_THIS
    BOOSTER_FASTDDS_DEPRECATED_UNTIL(3, "booster_eprosima::fastdds::dds:DataWriter::register_instance_w_timestamp()",
            "In favor of version using booster_eprosima::fastrtps::Time_t.")
    BOOSTER_RTPS_DllAPI InstanceHandle_t register_instance_w_timestamp(
            void* instance,
            const fastrtps::rtps::Time_t& timestamp);
     ...
     * If the operation finishes successfully, ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_OK is returned.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t unregister_instance(
            void* instance,
            const InstanceHandle_t& handle);
     ...
     * @return Handle containing the instance's key.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t unregister_instance_w_timestamp(
            void* instance,
            const InstanceHandle_t& handle,
            const fastrtps::Time_t& timestamp);

#ifndef DOXYGEN_SHOULD_SKIP_THIS
    BOOSTER_FASTDDS_DEPRECATED_UNTIL(3, "booster_eprosima::fastdds::dds:DataWriter::unregister_instance_w_timestamp()",
            "In favor of version using booster_eprosima::fastrtps::Time_t.")
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t unregister_instance_w_timestamp(
            void* instance,
            const InstanceHandle_t& handle,
     ...
     * @ref booster_eprosima::fastdds::dds::Entity::instance_handle_ "instance_handle".
     ...
     * @return Any of the standard return codes.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_key_value(
            void* key_holder,
            const InstanceHandle_t& handle);
     ...
     */
    BOOSTER_RTPS_DllAPI InstanceHandle_t lookup_instance(
     ...
     */
    BOOSTER_RTPS_DllAPI InstanceHandle_t get_instance_handle() const;
     ...
     */
    BOOSTER_RTPS_DllAPI TypeSupport get_type() const;
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t wait_for_acknowledgments(
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_offered_deadline_missed_status(
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_offered_incompatible_qos_status(
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_publication_matched_status(
     ...
     */
    BOOSTER_RTPS_DllAPI const DataWriterQos& get_qos() const;
     ...
     */
    BOOSTER_RTPS_DllAPI Topic* get_topic() const;
     ...
     */
    BOOSTER_RTPS_DllAPI const DataWriterListener* get_listener() const;
     ...
     * RETCODE_OK if the data is correctly sent and RETCODE_ERROR otherwise.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t dispose(
            void* data,
            const InstanceHandle_t& handle);

    /**
     * @brief This operation performs the same functions as @ref dispose except that the application provides the value
     * for the @ref booster_eprosima::fastdds::dds::SampleInfo::source_timestamp "source_timestamp" that is made available to
     * DataReader objects by means of the @ref booster_eprosima::fastdds::dds::SampleInfo::source_timestamp "source_timestamp"
     ...
     * @param timestamp Time_t used to set the source_timestamp.
     * @return BOOSTER_RTPS_DllAPI
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t dispose_w_timestamp(
            void* instance,
            const InstanceHandle_t& handle,
            const fastrtps::Time_t& timestamp);
    /**
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_liveliness_lost_status(
     ...
     */
    BOOSTER_RTPS_DllAPI const Publisher* get_publisher() const;
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_matched_subscription_data(
     ...
     * @warning Not supported yet. Currently returns RETCODE_UNSUPPORTED
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_matched_subscriptions(
            std::vector<InstanceHandle_t>& subscription_handles) const;

#ifndef DOXYGEN_SHOULD_SKIP_THIS
    BOOSTER_FASTDDS_DEPRECATED_UNTIL(3, "booster_eprosima::fastdds::dds:DataWriter::get_matched_subscriptions()",
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t clear_history(
            size_t* removed);
     ...
     *
     * @return ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_ILLEGAL_OPERATION when the data type does not support loans.
     * @return ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_NOT_ENABLED if the writer has not been enabled.
     * @return ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_OUT_OF_RESOURCES if the pool has been exhausted.
     * @return ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_OK if a pointer to a sample is successfully obtained.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t loan_sample(
            void*& sample,
     ...
     * @return ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_ILLEGAL_OPERATION when the data type does not support loans.
     * @return ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_NOT_ENABLED if the writer has not been enabled.
     * @return ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_BAD_PARAMETER if the pointer does not correspond to a loaned sample.
     * @return ::booster_eprosima::fastrtps::types::ReturnCode_t::RETCODE_OK if the loan is successfully discarded.
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t discard_loan(
            void*& sample);
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_sending_locators(
...
#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_PUBLISHER_DATAWRITER_HPP_
