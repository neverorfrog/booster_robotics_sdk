...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_PUBLISHER_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_PUBLISHER_HPP_
...
public:
     ...
     */
    BOOSTER_RTPS_DllAPI const PublisherQos& get_qos() const;
     ...
     */
    BOOSTER_RTPS_DllAPI const PublisherListener* get_listener() const;
     ...
     */
    BOOSTER_RTPS_DllAPI DataWriter* create_datawriter(
            Topic* topic,
     ...
     * @return Pointer to the created DataWriter. nullptr if failed.
     */
    BOOSTER_RTPS_DllAPI DataWriter* create_datawriter_with_profile(
            Topic* topic,
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t delete_datawriter(
     ...
     */
    BOOSTER_RTPS_DllAPI DataWriter* lookup_datawriter(
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t suspend_publications();
     ...
     * @warning Not supported yet. Currently returns RETCODE_UNSUPPORTED
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t resume_publications();
     ...
     * @warning Not supported yet. Currently returns RETCODE_UNSUPPORTED
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t begin_coherent_changes();
     ...
     * @warning Not supported yet. Currently returns RETCODE_UNSUPPORTED
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t end_coherent_changes();
     ...
     */
    BOOSTER_RTPS_DllAPI const DomainParticipant* get_participant() const;
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t set_default_datawriter_qos(
            const DataWriterQos& qos);
     ...
     */
    BOOSTER_RTPS_DllAPI const DataWriterQos& get_default_datawriter_qos() const;
     ...
     * @return RETCODE_OK
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_default_datawriter_qos(
     ...
     * @warning Not supported yet. Currently returns RETCODE_UNSUPPORTED
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t copy_from_topic_qos(
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t get_datawriter_qos_from_profile(
            const std::string& profile_name,
            DataWriterQos& qos) const;
     ...
     * @return true
     */
    BOOSTER_RTPS_DllAPI bool get_datawriters(
     ...
     */
    BOOSTER_RTPS_DllAPI bool has_datawriters() const;
...
#endif /* BOOSTER_FASTDDS__BOOSTER_FASTDDS_PUBLISHER_HPP_ */
