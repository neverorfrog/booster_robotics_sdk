...
#ifndef BOOSTER_FASTDDS_REPLYHEADER_HPP
#define BOOSTER_FASTDDS_REPLYHEADER_HPP
...
struct ReplyHeader
{
    ...
    BOOSTER_FASTDDS_SER_METHOD_DEPRECATED(3, "booster_eprosima::fastdds::dds::rpc::ReplyHeader::getCdrSerializedSize()",
    ...
    BOOSTER_FASTDDS_SER_METHOD_DEPRECATED(3, "booster_eprosima::fastdds::dds::rpc::ReplyHeader::serialize()",
    ...
    BOOSTER_FASTDDS_SER_METHOD_DEPRECATED(3, "booster_eprosima::fastdds::dds::rpc::ReplyHeader::deserialize()",
...
#endif // BOOSTER_FASTDDS_REPLYHEADER_HPP
