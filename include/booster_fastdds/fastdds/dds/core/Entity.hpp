...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_ENTITY_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_ENTITY_HPP_

#include <booster_fastdds/fastdds/dds/common/InstanceHandle.hpp>
#include <booster_fastdds/fastdds/dds/core/condition/StatusCondition.hpp>
...
public:
     ...
     */
    BOOSTER_RTPS_DllAPI const StatusMask& get_status_mask() const
    {
        return status_mask_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI const StatusMask& get_status_changes() const;
     ...
     */
    BOOSTER_RTPS_DllAPI bool is_enabled() const
    {
        return enable_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI StatusCondition& get_statuscondition()
    {
...
protected:
     ...
     */
    BOOSTER_RTPS_DllAPI void set_instance_handle(
...
#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_ENTITY_HPP_
