...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_STATUS_CONDITION_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_STATUS_CONDITION_HPP_
...
public:
     ...
     */
    BOOSTER_RTPS_DllAPI bool get_trigger_value() const override;
     ...
     */
    BOOSTER_RTPS_DllAPI ::booster_eprosima::fastrtps::types::ReturnCode_t set_enabled_statuses(
     ...
     */
    BOOSTER_RTPS_DllAPI const StatusMask& get_enabled_statuses() const;

    /**
     * @brief Returns the Entity associated
     * @return Entity
     */
    BOOSTER_RTPS_DllAPI Entity* get_entity() const;
...
#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_STATUS_CONDITION_HPP_
