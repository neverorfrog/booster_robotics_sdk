...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_QOS_QOSPOLICIES_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_QOS_QOSPOLICIES_HPP_

#include <vector>

#include <booster_fastdds/fastdds/dds/core/policy/ParameterTypes.hpp>
...
#include <booster_fastdds/fastdds/rtps/common/LocatorList.hpp>
#include <booster_fastdds/fastdds/rtps/common/Time_t.h>
#include <booster_fastdds/fastdds/rtps/common/Types.h>
#include <booster_fastdds/fastdds/rtps/flowcontrol/FlowControllerConsts.hpp>
#include <booster_fastdds/fastdds/rtps/resources/ResourceManagement.h>
#include <booster_fastdds/fastrtps/types/TypeObject.h>
#include <booster_fastdds/fastrtps/utils/collections/ResourceLimitedVector.hpp>
...
public:
     ...
     * @brief Constructor without parameters
     */
    BOOSTER_RTPS_DllAPI EntityFactoryQosPolicy()
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~EntityFactoryQosPolicy()
    {
    }
...
#define BOOSTER_FASTDDS_PARAMETER_KIND_LENGTH 4
#define BOOSTER_FASTDDS_PARAMETER_BOOL_LENGTH 4
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI DurabilityQosPolicy()
        : Parameter_t(PID_DURABILITY, BOOSTER_FASTDDS_PARAMETER_KIND_LENGTH)
        , QosPolicy(true)
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~DurabilityQosPolicy() = default;
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI DeadlineQosPolicy()
        : Parameter_t(PID_DEADLINE, BOOSTER_FASTDDS_PARAMETER_TIME_LENGTH)
        , QosPolicy(true)
        , period(BOOSTER_FASTDDS_TIME_T_INFINITE_SECONDS, BOOSTER_FASTDDS_TIME_T_INFINITE_NANOSECONDS)
    {
    }
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~DeadlineQosPolicy() = default;
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI LatencyBudgetQosPolicy()
        : Parameter_t(PID_LATENCY_BUDGET, BOOSTER_FASTDDS_PARAMETER_TIME_LENGTH)
        , QosPolicy(true)
        , duration(0, 0)
    {
    }
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~LatencyBudgetQosPolicy() = default;
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI LivelinessQosPolicy()
        : Parameter_t(PID_LIVELINESS, BOOSTER_FASTDDS_PARAMETER_KIND_LENGTH + BOOSTER_FASTDDS_PARAMETER_TIME_LENGTH)
        , QosPolicy(true)
        , kind(AUTOMATIC_LIVELINESS_QOS)
        , lease_duration(BOOSTER_FASTDDS_TIME_T_INFINITE_SECONDS, BOOSTER_FASTDDS_TIME_T_INFINITE_NANOSECONDS)
        , announcement_period(BOOSTER_FASTDDS_TIME_T_INFINITE_SECONDS, BOOSTER_FASTDDS_TIME_T_INFINITE_NANOSECONDS)
    {
    }
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~LivelinessQosPolicy() = default;
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI ReliabilityQosPolicy()
        : Parameter_t(PID_RELIABILITY, BOOSTER_FASTDDS_PARAMETER_KIND_LENGTH + BOOSTER_FASTDDS_PARAMETER_TIME_LENGTH)
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~ReliabilityQosPolicy() = default;
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI OwnershipQosPolicy()
        : Parameter_t(PID_OWNERSHIP, BOOSTER_FASTDDS_PARAMETER_KIND_LENGTH)
        , QosPolicy(true)
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~OwnershipQosPolicy() = default;
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI DestinationOrderQosPolicy()
        : Parameter_t(PID_DESTINATION_ORDER, BOOSTER_FASTDDS_PARAMETER_KIND_LENGTH)
        , QosPolicy(true)
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~DestinationOrderQosPolicy() = default;
...
public:
    ...
    BOOSTER_RTPS_DllAPI GenericDataQosPolicy(
            ParameterId_t pid)
        : Parameter_t(pid, 0)
        , QosPolicy(false)
    ...
    virtual BOOSTER_RTPS_DllAPI ~GenericDataQosPolicy() = default;
     ...
     * */
    BOOSTER_RTPS_DllAPI inline const collection_type& data_vec() const
    {
        return collection_;
    }
     ...
     * @return raw data as vector of octets.
     * */
    BOOSTER_RTPS_DllAPI inline collection_type& data_vec()
    {
        return collection_;
    }
     ...
     * */
    BOOSTER_RTPS_DllAPI inline void data_vec(
     ...
     * @return raw data as vector of octets.
     * */
    BOOSTER_RTPS_DllAPI inline const collection_type& getValue() const
    {
        return collection_;
    }
     ...
     * @param vec raw data to set.
     * */
    BOOSTER_RTPS_DllAPI inline void setValue(
            const collection_type& vec)
    {
        data_vec(vec);
    }
...
#define BOOSTER_FASTDDS_TEMPLATE_DATA_QOS_POLICY(TClassName, TPid)                                         \
    class TClassName : public GenericDataQosPolicy                                         \
    {                                                                                      \
    public:                                                                                \
                                                                                           \
        BOOSTER_RTPS_DllAPI TClassName()                                                           \
        ...
        {                                                                                  \
                                                                                           ...
                                                                                           \
        virtual BOOSTER_RTPS_DllAPI ~TClassName() = default;                                       \
                                                                                           \
        /**                                                                                \
...
BOOSTER_FASTDDS_TEMPLATE_DATA_QOS_POLICY(UserDataQosPolicy, PID_USER_DATA)
BOOSTER_FASTDDS_TEMPLATE_DATA_QOS_POLICY(TopicDataQosPolicy, PID_TOPIC_DATA)
BOOSTER_FASTDDS_TEMPLATE_DATA_QOS_POLICY(GroupDataQosPolicy, PID_GROUP_DATA)
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI TimeBasedFilterQosPolicy()
        : Parameter_t(PID_TIME_BASED_FILTER, BOOSTER_FASTDDS_PARAMETER_TIME_LENGTH)
        , QosPolicy(false)
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~TimeBasedFilterQosPolicy() = default;
...
#define BOOSTER_FASTDDS_PARAMETER_PRESENTATION_LENGTH 8
...
public:
     ...
     * @brief Constructor without parameters
     */
    BOOSTER_RTPS_DllAPI PresentationQosPolicy()
        : Parameter_t(PID_PRESENTATION, BOOSTER_FASTDDS_PARAMETER_PRESENTATION_LENGTH)
        , QosPolicy(false)
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~PresentationQosPolicy() = default;
...
public:
     ...
     * @brief Constructor without parameters
     */
    BOOSTER_RTPS_DllAPI PartitionQosPolicy()
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~PartitionQosPolicy() = default;
     ...
     */
    BOOSTER_RTPS_DllAPI inline void push_back(
            const char* name)
    {
        //Realloc if needed;
     ...
     */
    BOOSTER_RTPS_DllAPI inline void clear() override
    {
     ...
     */
    BOOSTER_RTPS_DllAPI inline const std::vector<std::string> getNames() const
    {
        return names();
    }
     ...
     */
    BOOSTER_RTPS_DllAPI inline void setNames(
     ...
     * @return Vector of partition name strings.
     */
    BOOSTER_RTPS_DllAPI inline const std::vector<std::string> names() const
    {
     ...
     * @param nam Vector of partition name strings.
     */
    BOOSTER_RTPS_DllAPI inline void names(
            std::vector<std::string>& nam)
    {
        clear();
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI HistoryQosPolicy()
        : Parameter_t(PID_HISTORY, BOOSTER_FASTDDS_PARAMETER_KIND_LENGTH + 4)
        , QosPolicy(true)
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~HistoryQosPolicy() = default;
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI ResourceLimitsQosPolicy()
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~ResourceLimitsQosPolicy() = default;
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI DurabilityServiceQosPolicy()
        : Parameter_t(PID_DURABILITY_SERVICE, BOOSTER_FASTDDS_PARAMETER_TIME_LENGTH + BOOSTER_FASTDDS_PARAMETER_KIND_LENGTH + 4 + 4 + 4 + 4)
        , QosPolicy(false)
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~DurabilityServiceQosPolicy() = default;
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI LifespanQosPolicy()
        : Parameter_t(PID_LIFESPAN, BOOSTER_FASTDDS_PARAMETER_TIME_LENGTH)
        , QosPolicy(true)
        , duration(BOOSTER_FASTDDS_TIME_T_INFINITE_SECONDS, BOOSTER_FASTDDS_TIME_T_INFINITE_NANOSECONDS)
    {
    }
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~LifespanQosPolicy() = default;
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI OwnershipStrengthQosPolicy()
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~OwnershipStrengthQosPolicy() = default;
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI TransportPriorityQosPolicy()
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~TransportPriorityQosPolicy() = default;
...
public:
     ...
     * @since 2.4.0
     */
    const char* flow_controller_name = fastdds::rtps::BOOSTER_FASTDDS_FLOW_CONTROLLER_DEFAULT;
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI DataRepresentationQosPolicy()
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~DataRepresentationQosPolicy() override = default;
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI TypeConsistencyEnforcementQosPolicy()
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~TypeConsistencyEnforcementQosPolicy() override = default;
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI DisablePositiveACKsQosPolicy()
        : Parameter_t(PID_DISABLE_POSITIVE_ACKS, BOOSTER_FASTDDS_PARAMETER_BOOL_LENGTH)
        , QosPolicy(true)
        , enabled(false)
        , duration(BOOSTER_FASTDDS_TIME_T_INFINITE_SECONDS, BOOSTER_FASTDDS_TIME_T_INFINITE_NANOSECONDS)
    {
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~DisablePositiveACKsQosPolicy() = default;
...
public:
    ...
    BOOSTER_RTPS_DllAPI TypeIdV1& operator =(
            const TypeIdV1& type)
    {
        Pid = type.Pid;
        length = type.length;
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~TypeIdV1() override = default;
     ...
     */
    BOOSTER_RTPS_DllAPI const fastrtps::types::TypeIdentifier& get() const
    {
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI TypeObjectV1()
    ...
    BOOSTER_RTPS_DllAPI TypeObjectV1& operator =(
            const TypeObjectV1& type)
    {
        Pid = type.Pid;
        length = type.length;
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~TypeObjectV1() override = default;
     ...
     */
    BOOSTER_RTPS_DllAPI const fastrtps::types::TypeObject& get() const
    {
...
public:
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~TypeInformation() override = default;
     ...
     */
    BOOSTER_RTPS_DllAPI bool assigned() const
    {
        return assigned_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void assigned(
            bool value)
    {
        assigned_ = value;
    }
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI WireProtocolConfigQos()
        : QosPolicy(false)
        , participant_id(-1)
    {
    }
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~WireProtocolConfigQos() = default;
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI TransportConfigQos()
        : QosPolicy(false)
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~TransportConfigQos() = default;
...
public:
    ...
    BOOSTER_RTPS_DllAPI RTPSEndpointQos() = default;

    virtual BOOSTER_RTPS_DllAPI ~RTPSEndpointQos() = default;
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI WriterResourceLimitsQos()
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~WriterResourceLimitsQos() = default;
...
public:
     ...
     * @brief Constructor
     */
    BOOSTER_RTPS_DllAPI DataSharingQosPolicy()
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~DataSharingQosPolicy() = default;
    ...
    BOOSTER_RTPS_DllAPI DataSharingQosPolicy& operator =(
            const DataSharingQosPolicy& b)
    {
        QosPolicy::operator =(b);
        Parameter_t::operator =(b);
     ...
     */
    BOOSTER_RTPS_DllAPI const DataSharingKind& kind() const
    {
        return kind_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI const std::string& shm_directory() const
    {
     ...
     */
    BOOSTER_RTPS_DllAPI const std::vector<uint64_t>& domain_ids() const
    {
        return domain_ids_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void set_max_domains(
            uint32_t size)
    {
     ...
     */
    BOOSTER_RTPS_DllAPI const uint32_t& max_domains() const
    {
        return max_domains_;
    }
     ...
     */
    BOOSTER_RTPS_DllAPI void automatic()
    {
     ...
     */
    BOOSTER_RTPS_DllAPI void add_domain_id(
            uint16_t id)
    {
...
#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_QOS_QOSPOLICIES_HPP_
