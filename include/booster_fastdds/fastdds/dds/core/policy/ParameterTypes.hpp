...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_QOS_PARAMETERTYPES_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_QOS_PARAMETERTYPES_HPP_

#ifndef DOXYGEN_SHOULD_SKIP_THIS_PUBLIC

#include <booster_fastdds/fastdds/rtps/common/all_common.h>
#include <booster_fastdds/fastdds/rtps/common/Token.h>
#include <booster_fastdds/fastdds/rtps/messages/CDRMessage.h>

#include <booster_fastdds/fastrtps/utils/fixed_size_string.hpp>

#if BOOSTER_FASTDDS_HAVE_SECURITY
#include <booster_fastdds/fastdds/rtps/security/accesscontrol/ParticipantSecurityAttributes.h>
...
public:
     ...
     */
    BOOSTER_RTPS_DllAPI Parameter_t()
        : Pid(PID_PAD)
        , length(0)
    {
    }
     ...
     * @brief Destructor
     */
    virtual BOOSTER_RTPS_DllAPI ~Parameter_t()
    {
    }
...
#define BOOSTER_FASTDDS_PARAMETER_KEY_HASH_LENGTH 16
...
#define BOOSTER_FASTDDS_PARAMETER_LOCATOR_LENGTH 24
...
#define BOOSTER_FASTDDS_PARAMETER_PORT_LENGTH 4
...
#define BOOSTER_FASTDDS_PARAMETER_GUID_LENGTH 16
...
#define BOOSTER_FASTDDS_PARAMETER_PROTOCOL_LENGTH 4
...
#define BOOSTER_FASTDDS_PARAMETER_VENDOR_LENGTH 4
...
#define BOOSTER_FASTDDS_PARAMETER_IP4_LENGTH 4
...
#define BOOSTER_FASTDDS_PARAMETER_STATUS_INFO_LENGTH 4
...
#define BOOSTER_FASTDDS_PARAMETER_COUNT_LENGTH 4
...
#define BOOSTER_FASTDDS_PARAMETER_ENTITYID_LENGTH 4
...
#define BOOSTER_FASTDDS_PARAMETER_TIME_LENGTH 8
...
#define BOOSTER_FASTDDS_PARAMETER_BUILTINENDPOINTSET_LENGTH 4
...
#define BOOSTER_FASTDDS_PARAMETER_NETWORKCONFIGSET_LENGTH 4
...
#define BOOSTER_FASTDDS_PARAMETER_SAMPLEIDENTITY_LENGTH 24
...
#define BOOSTER_FASTDDS_PARAMETER_PARTICIPANT_SECURITY_INFO_LENGTH 8
...
public:
     ...
     * Sets the value PID_PARTICIPANT_SECURITY_INFO for the parameter PID and BOOSTER_FASTDDS_PARAMETER_PARTICIPANT_SECURITY_INFO_LENGTH
     * for the length.
     */
    ParameterParticipantSecurityInfo_t()
        : Parameter_t(PID_PARTICIPANT_SECURITY_INFO, BOOSTER_FASTDDS_PARAMETER_PARTICIPANT_SECURITY_INFO_LENGTH)
    {
    }
...
#define BOOSTER_FASTDDS_PARAMETER_ENDPOINT_SECURITY_INFO_LENGTH 8
...
public:
    ...
    /**
     * @brief Constructor without parameters. <br>
     * Sets the value PID_ENDPOINT_SECURITY_INFO for the parameter PID and BOOSTER_FASTDDS_PARAMETER_ENDPOINT_SECURITY_INFO_LENGTH
     * for the length.
     */
    ParameterEndpointSecurityInfo_t()
        : Parameter_t(PID_ENDPOINT_SECURITY_INFO, BOOSTER_FASTDDS_PARAMETER_ENDPOINT_SECURITY_INFO_LENGTH)
    {
    }
...
#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_QOS_PARAMETERTYPES_HPP_
