...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_STATUSMASK_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_STATUSMASK_HPP_
...
//!Alias of size_t(16)
#define BOOSTER_FASTDDS_STATUS_COUNT size_t(16)
...
class BOOSTER_RTPS_DllAPI StatusMask : public std::bitset<BOOSTER_FASTDDS_STATUS_COUNT>
{
public:

    /**
     * Convenience typedef for std::bitset<BOOSTER_FASTDDS_STATUS_COUNT>.
     */
    typedef std::bitset<BOOSTER_FASTDDS_STATUS_COUNT> MaskType;

    /**
     * Construct an StatusMask with no flags set.
     */
    StatusMask()
        : std::bitset<BOOSTER_FASTDDS_STATUS_COUNT>()
    {
    }
    ...
    explicit StatusMask(
            uint32_t mask)
        : std::bitset<BOOSTER_FASTDDS_STATUS_COUNT>(mask)
    {
    }
...
#endif //BOOSTER_FASTDDS__BOOSTER_FASTDDS_STATUSMASK_HPP_
