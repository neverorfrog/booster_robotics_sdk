...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_CORE_LOANABLESEQUENCE_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_CORE_LOANABLESEQUENCE_HPP_
...
public:
    ...
    ~LoanableSequence()
    {
        ...
        {
            BOOSTER_EPROSIMA_LOG_WARNING(SUBSCRIBER, "Sequence destroyed with active loan");
            return;
        }
...
#define BOOSTER_FASTDDS_SEQUENCE(FooSeq, Foo) using FooSeq = booster_eprosima::fastdds::dds::LoanableSequence<Foo>
#define BOOSTER_FASTDDS_CONST_SEQUENCE(FooSeq, Foo) using FooSeq = booster_eprosima::fastdds::dds::LoanableSequence<Foo, \
                    std::false_type>

#endif // BOOSTER_FASTDDS__BOOSTER_FASTDDS_DDS_CORE_LOANABLESEQUENCE_HPP_
