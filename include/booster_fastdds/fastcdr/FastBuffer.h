...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTCDR_CDRBUFFER_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTCDR_CDRBUFFER_H_
...
inline uint32_t booster_fastcdr_size_to_uint32(
        size_t val)
{
  #if defined(_WIN32) || !defined(BOOSTER_FASTCDR_ARM32)
    ...
    return val;
  #endif // if defined(_WIN32) || !defined(BOOSTER_FASTCDR_ARM32)
}
 ...
 */
class BOOSTER_Cdr_DllAPI _FastBuffer_iterator
{
public:
 ...
 */
class BOOSTER_Cdr_DllAPI FastBuffer
{
public:
    ...
    /*!
     * @brief This constructor creates an internal stream and assigns it to the booster_eprosima::fastcdr::FastBuffers object.
     * The user can obtain this internal stream using the function booster_eprosima::fastcdr::FastBuffers::getBuffer(). Be careful because this internal stream
     * is deleted in the destruction of the booster_eprosima::fastcdr::FastBuffers object.
     */
    FastBuffer() = default;

    /*!
     * @brief This constructor assigns the user's stream of bytes to the booster_eprosima::fastcdr::FastBuffers object.
    ...
    /*!
     * @brief This function returns the stream that the booster_eprosima::fastcdr::FastBuffers uses to serialize data.
     * @return The stream used by booster_eprosima::fastcdr::FastBuffers to serialize data.
     */
    ...
    /*!
     * @brief This function returns the size of the allocated memory of the stream that the booster_eprosima::fastcdr::FastBuffers uses to serialize data.
     * @return The size of the allocated memory of the stream used by the booster_eprosima::fastcdr::FastBuffers to serialize data.
     */
...
#endif // _BOOSTER_FASTCDR_BOOSTER_FASTCDRBUFFER_H_
