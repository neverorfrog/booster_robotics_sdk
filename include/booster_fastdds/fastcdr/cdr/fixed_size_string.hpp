...
#ifndef BOOSTER_FASTDDS_BOOSTER_FASTCDR_UTILS_FIXED_SIZE_STRING_HPP_
#define BOOSTER_FASTDDS_BOOSTER_FASTCDR_UTILS_FIXED_SIZE_STRING_HPP_
...
#endif /* BOOSTER_FASTDDS_BOOSTER_FASTCDR_UTILS_FIXED_SIZE_STRING_HPP_ */
