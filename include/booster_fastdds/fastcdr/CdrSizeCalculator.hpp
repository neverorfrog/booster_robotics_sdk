...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTCDR_CDRSIZECALCULATOR_HPP_
#define BOOSTER_FASTDDS__BOOSTER_FASTCDR_CDRSIZECALCULATOR_HPP_
...
public:
     ...
     */
    BOOSTER_Cdr_DllAPI CdrSizeCalculator(
     ...
     */
    BOOSTER_Cdr_DllAPI EncodingAlgorithmFlag get_encoding() const;
     ...
     */
    BOOSTER_Cdr_DllAPI size_t begin_calculate_type_serialized_size(
     ...
     */
    BOOSTER_Cdr_DllAPI size_t end_calculate_type_serialized_size(
            EncodingAlgorithmFlag new_encoding,
            size_t& current_alignment);
...
#endif // BOOSTER_FASTDDS__BOOSTER_FASTCDR_CDRSIZECALCULATOR_HPP_
