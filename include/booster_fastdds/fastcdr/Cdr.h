...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTCDR_CDR_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTCDR_CDR_H_
...
/*!
 * @brief This class offers an interface to serialize/deserialize some basic types using CDR protocol inside an booster_eprosima::fastcdr::FastBuffer.
 * @ingroup BOOSTER_FASTCDRAPIREFERENCE
 */
class Cdr
{
public:
    ...
    BOOSTER_Cdr_DllAPI static const Endianness DEFAULT_ENDIAN;
    ...
    public:
        ...
        //! Compares two states.
        BOOSTER_Cdr_DllAPI bool operator ==(
    ...
    /*!
     * @brief This constructor creates an booster_eprosima::fastcdr::Cdr object that can serialize/deserialize
     * the assigned buffer.
     ...
     *        encapsulation.
     * @return Reference to the booster_eprosima::fastcdr::Cdr object.
     ...
     */
    BOOSTER_Cdr_DllAPI Cdr& read_encapsulation();
     ...
     */
    BOOSTER_Cdr_DllAPI Cdr& serialize_encapsulation();

    /*!
     * @brief Retrieves the CdrVersion used by the instance.
     * @return Configured CdrVersion.
     */
    BOOSTER_Cdr_DllAPI CdrVersion get_cdr_version() const;
     ...
     */
    BOOSTER_Cdr_DllAPI EncodingAlgorithmFlag get_encoding_flag() const;
     ...
     */
    BOOSTER_Cdr_DllAPI bool set_encoding_flag(
            EncodingAlgorithmFlag encoding_flag);

    /*!
     * @brief This function returns the option flags when the CDR type is booster_eprosima::fastcdr::DDS_CDR.
     * @return The option flags.
     */
    BOOSTER_Cdr_DllAPI std::array<uint8_t, 2> get_dds_cdr_options() const;

    /*!
     * @brief This function sets the option flags when the CDR type is booster_eprosima::fastcdr::DDS_CDR.
     * @param options New value for the option flags.
     */
    BOOSTER_Cdr_DllAPI void set_dds_cdr_options(
     ...
     */
    BOOSTER_Cdr_DllAPI void change_endianness(
     ...
     */
    BOOSTER_Cdr_DllAPI Endianness endianness() const;
     ...
     */
    BOOSTER_Cdr_DllAPI bool move_alignment_forward(
            size_t num_bytes);
    ...
    inline Cdr& operator <<(
            const _T& value)
    {
        if (BOOSTER_FASTDDS_MEMBER_ID_INVALID == next_member_id_)
        {
            serialize(value);
        }
        else
    ...
    Cdr& serialize(
            const _T& value)
    {
        booster_eprosima::fastcdr::serialize(*this, value);
        return *this;
    }
     ...
     * @exception exception::NotEnoughMemoryException This exception is thrown when trying to serialize a position that exceeds the internal memory size.
     */
    BOOSTER_Cdr_DllAPI Cdr& serialize(
    ...
    /*!
     * @brief Encodes a booster_eprosima::fastcdr::fixed_string in the buffer.
     ...
     * @exception exception::NotEnoughMemoryException This exception is thrown when trying to serialize a position that exceeds the internal memory size.
     */
    BOOSTER_Cdr_DllAPI Cdr& serialize_array(
            const char* char_t,
            size_t num_elements);
    ...
    Cdr& deserialize(
            _T& value)
    {
        booster_eprosima::fastcdr::deserialize(*this, value);
        return *this;
    }
     ...
     * @exception exception::NotEnoughMemoryException This exception is thrown when trying to deserialize a position that exceeds the internal memory size.
     */
    BOOSTER_Cdr_DllAPI Cdr& deserialize(
            char& char_t);
     ...
     * @exception exception::NotEnoughMemoryException This exception is thrown when trying to deserialize a position that exceeds the internal memory size.
     */
    BOOSTER_Cdr_DllAPI Cdr& deserialize_array(
            char* char_t,
            size_t num_elements);
     ...
     * position that exceeds the internal memory size.
     */
    BOOSTER_Cdr_DllAPI Cdr& begin_serialize_type(
     ...
     * position that exceeds the internal memory size.
     */
    BOOSTER_Cdr_DllAPI Cdr& end_serialize_type(
            Cdr::state& current_state)
    {
     ...
     * position that exceeds the internal memory size.
     */
    BOOSTER_Cdr_DllAPI Cdr& deserialize_type(
            EncodingAlgorithmFlag type_encoding,
     ...
     * encoded.
     */
    BOOSTER_Cdr_DllAPI Cdr& operator <<(
            const MemberId& member_id)
    {
        if (next_member_id_ != BOOSTER_FASTDDS_MEMBER_ID_INVALID)
        {
...
private:
    ...
    BOOSTER_Cdr_DllAPI Cdr& serialize_bool_sequence(
            const std::vector<bool>& vector_t);

    BOOSTER_Cdr_DllAPI Cdr& deserialize_bool_sequence(
            std::vector<bool>& vector_t);

    BOOSTER_Cdr_DllAPI Cdr& deserialize_string_sequence(
            std::string*& sequence_t,
            size_t& num_elements);

    BOOSTER_Cdr_DllAPI Cdr& deserialize_wstring_sequence(
            std::wstring*& sequence_t,
            size_t& num_elements);
    ...
    /*!
     * @brief This function jumps the number of bytes of the alignment. These bytes should be calculated with the function booster_eprosima::fastcdr::Cdr::alignment.
    ...
    BOOSTER_Cdr_DllAPI const char* read_string(
            uint32_t& length);
    BOOSTER_Cdr_DllAPI const std::wstring read_wstring(
            uint32_t& length);
     ...
     */
    BOOSTER_Cdr_DllAPI bool xcdr1_deserialize_member_header(
            MemberId& member_id,
            Cdr::state& current_state);
     ...
     * @param[in] member_id Member identifier.
     * @pre Member identifier cannot be BOOSTER_FASTDDS_MEMBER_ID_INVALID and next_member_id_ must be equal to the member identifier or
     * BOOSTER_FASTDDS_MEMBER_ID_INVALID.
     ...
     * @pre next_member_id_ cannot be BOOSTER_FASTDDS_MEMBER_ID_INVALID.
     * @return Reference to the booster_eprosima::fastcdr::Cdr object.
     * @exception exception::NotEnoughMemoryException This exception is thrown when trying to encode into a buffer
     * position that exceeds the internal memory size.
     * @exception exception::BadParamException This exception is thrown when trying to encode a long header when
