...
#ifndef BOOSTER_FASTDDS__BOOSTER_FASTCDR_BOOSTER_FASTCDR_H_
#define BOOSTER_FASTDDS__BOOSTER_FASTCDR_BOOSTER_FASTCDR_H_
...
namespace fastcdr {
/*!
 * @brief This class offers an interface to serialize/deserialize some basic types using a modified CDR protocol inside a booster_eprosima::FastBuffer.
 ...
 */
class BOOSTER_Cdr_DllAPI FastCdr
{
public:
     ...
     */
    class BOOSTER_Cdr_DllAPI state
    {
    ...
    /*!
     * @brief This constructor creates a booster_eprosima::fastcdr::FastCdr object that can serialize/deserialize
     * the assigned buffer.
     *
     ...
     * @return Reference to the booster_eprosima::fastcdr::FastCdr object.
            ...
            const std::vector<_T>& vector_t)
    {
        ...
        *this << static_cast<int32_t>(vector_t.size());
        ...
        catch (booster_eprosima::fastcdr::exception::Exception& ex)
        {
...
#endif //BOOSTER_FASTDDS__BOOSTER_FASTCDR_BOOSTER_FASTCDR_H_
