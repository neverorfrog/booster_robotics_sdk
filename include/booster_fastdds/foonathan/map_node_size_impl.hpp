...
#ifndef BOOSTER_FASTDDS_SRC_CPP_UTILS_COLLECTIONS_IMPL_BOOSTER_FOONATHAN_MAP_NODE_SIZE_IMPL_HPP_
#define BOOSTER_FASTDDS_SRC_CPP_UTILS_COLLECTIONS_IMPL_BOOSTER_FOONATHAN_MAP_NODE_SIZE_IMPL_HPP_
 ...
 *   booster_foonathan::memory::map_node_size<std::map<uint32_t, uint32_t>::value_type>
...
struct map_node_size : booster_foonathan::memory::map_node_size<std::pair<size_t, typename std::map<K, V>::value_type> >
{
};

#endif  /* BOOSTER_FASTDDS_SRC_CPP_UTILS_COLLECTIONS_IMPL_BOOSTER_FOONATHAN_MAP_NODE_SIZE_IMPL_HPP_ */