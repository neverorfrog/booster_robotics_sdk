...
#ifndef BOOSTER_FASTDDS_SRC_CPP_UTILS_COLLECTIONS_IMPL_BOOSTER_FOONATHAN_SET_NODE_SIZE_IMPL_HPP_
#define BOOSTER_FASTDDS_SRC_CPP_UTILS_COLLECTIONS_IMPL_BOOSTER_FOONATHAN_SET_NODE_SIZE_IMPL_HPP_
 ...
 *   booster_foonathan::memory::set_node_size<std::set<uint32_t[2]>::value_type>
...
template <typename K>
struct set_node_size : booster_foonathan::memory::set_node_size<std::pair<size_t, typename std::set<K>::value_type> >
{
};

#endif  /* BOOSTER_FASTDDS_SRC_CPP_UTILS_COLLECTIONS_IMPL_BOOSTER_FOONATHAN_SET_NODE_SIZE_IMPL_HPP_ */