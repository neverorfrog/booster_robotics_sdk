...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_SEGREGATOR_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_SEGREGATOR_HPP_INCLUDED

/// \file
/// Class template \ref booster_foonathan::memory::segregator and related classes.
...
namespace booster_foonathan
{
    namespace memory
    {
        ...
        class threshold_segregatable : BOOSTER_FOONATHAN_EBO(allocator_traits<RawAllocator>::allocator_type)
        {
        public:
        ...
        public:
            ...
            {
                BOOSTER_FOONATHAN_MEMORY_UNREACHABLE("cannot be called with proper values");
            }
        ...
        private:
            ...
            {
                return {BOOSTER_FOONATHAN_MEMORY_LOG_PREFIX "::null_allocator", this};
            }
        };
        ...
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(segregator,
...
#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_SEGREGATOR_HPP_INCLUDED
