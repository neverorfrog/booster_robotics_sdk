...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_FALLBACK_ALLOCATOR_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_FALLBACK_ALLOCATOR_HPP_INCLUDED

/// \file
//// Class template \ref booster_foonathan::memory::fallback_allocator.
...
namespace booster_foonathan
{
    namespace memory
    {
        ...
        : BOOSTER_FOONATHAN_EBO(detail::ebo_storage<0, typename allocator_traits<Default>::allocator_type>),
          BOOSTER_FOONATHAN_EBO(detail::ebo_storage<1, typename allocator_traits<Fallback>::allocator_type>)
        {
        ...
        public:
            ...
            BOOSTER_FOONATHAN_ENABLE_IF(!is_stateful::value)
            fallback_allocator()
            ...
            BOOSTER_FOONATHAN_ENABLE_IF(fallback_composable::value)
...
#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_FALLBACK_ALLOCATOR_HPP_INCLUDED
