...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_MEMORY_POOL_TYPE_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_MEMORY_POOL_TYPE_HPP_INCLUDED
...
namespace booster_foonathan
{
    namespace memory
    {
        ...
        /// \ingroup allocator
        struct node_pool : BOOSTER_FOONATHAN_EBO(std::true_type)
        {
        ...
        /// \ingroup allocator
        struct array_pool : BOOSTER_FOONATHAN_EBO(std::true_type)
        {
        ...
        /// \ingroup allocator
        struct small_node_pool : BOOSTER_FOONATHAN_EBO(std::false_type)
        {
...
#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_MEMORY_POOL_TYPE_HPP_INCLUDED
