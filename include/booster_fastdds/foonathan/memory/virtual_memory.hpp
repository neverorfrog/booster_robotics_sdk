...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_VIRTUAL_MEMORY_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_VIRTUAL_MEMORY_HPP_INCLUDED
...
namespace booster_foonathan
{
    namespace memory
    {
        namespace detail
        {
            ...
            BOOSTER_FOONATHAN_MEMORY_GLOBAL_LEAK_CHECKER(virtual_memory_allocator_leak_handler,
        ...
        : BOOSTER_FOONATHAN_EBO(detail::global_leak_checker<detail::virtual_memory_allocator_leak_handler>)
        {
        public:
...
#endif //BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_VIRTUAL_MEMORY_HPP_INCLUDED
