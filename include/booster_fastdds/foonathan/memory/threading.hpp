...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_THREADING_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_THREADING_HPP_INCLUDED
    ...
    namespace memory
    {
        ...
        namespace detail
        {
            ...
            public:
                ...
                {
                    BOOSTER_FOONATHAN_MEMORY_ASSERT(alloc_);
                    return *alloc_;
                }
...
#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_THREADING_HPP_INCLUDED
