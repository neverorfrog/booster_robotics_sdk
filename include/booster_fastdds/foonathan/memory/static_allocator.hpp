...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_STATIC_ALLOCATOR_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_STATIC_ALLOCATOR_HPP_INCLUDED
...
namespace booster_foonathan
{
    namespace memory
    {
        ...
        public:
            ...
            {
                BOOSTER_FOONATHAN_MEMORY_ASSERT(block_size <= Size);
                BOOSTER_FOONATHAN_MEMORY_ASSERT(Size % block_size == 0u);
            }
...
#endif //BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_STATIC_ALLOCATOR_HPP_INCLUDED
