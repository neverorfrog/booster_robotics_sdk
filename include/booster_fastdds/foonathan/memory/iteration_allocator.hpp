...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_ITERATION_ALLOCATOR_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_ITERATION_ALLOCATOR_HPP_INCLUDED

/// \file
/// Class template \ref booster_foonathan::memory::iteration_allocator.
...
namespace booster_foonathan
{
    namespace memory
    {
        ...
        : BOOSTER_FOONATHAN_EBO(detail::iteration_block_allocator<BlockOrRawAllocator>)
        {
        public:
            ...
            {
                BOOSTER_FOONATHAN_MEMORY_ASSERT_MSG(cur_ != N, "moved-from allocator");
                cur_ = (cur_ + 1) % N;
        ...
        private:
            ...
            {
                return {BOOSTER_FOONATHAN_MEMORY_LOG_PREFIX "::iteration_allocator", this};
            }

            char* block_start(std::size_t i) const noexcept
            {
                BOOSTER_FOONATHAN_MEMORY_ASSERT_MSG(i <= N, "moved from state");
        ...
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(double_frame_allocator,
...
#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_ITERATION_ALLOCATOR_HPP_INCLUDED
