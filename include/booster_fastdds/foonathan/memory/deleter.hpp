...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_DELETER_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_DELETER_HPP_INCLUDED
...
namespace booster_foonathan
{
    namespace memory
    {
        ...
        class allocator_deallocator : BOOSTER_FOONATHAN_EBO(allocator_reference<RawAllocator>)
        {
        ...
        : BOOSTER_FOONATHAN_EBO(allocator_reference<RawAllocator>)
        {
        ...
        class allocator_polymorphic_deallocator : BOOSTER_FOONATHAN_EBO(allocator_reference<RawAllocator>)
        {
        public:
            using allocator_type = typename allocator_reference<RawAllocator>::allocator_type;
            ...
            template <typename T, BOOSTER_FOONATHAN_REQUIRES((std::is_base_of<BaseType, T>::value))>
        ...
        /// \ingroup adapter
        template <typename Type, class RawAllocator>
        class allocator_deleter : BOOSTER_FOONATHAN_EBO(allocator_reference<RawAllocator>)
        {
            static_assert(!std::is_abstract<Type>::value,
        ...
        /// \ingroup adapter
        template <typename BaseType, class RawAllocator>
        class allocator_polymorphic_deleter : BOOSTER_FOONATHAN_EBO(allocator_reference<RawAllocator>)
        {
        public:
            using allocator_type = typename allocator_reference<RawAllocator>::allocator_type;
            using value_type     = BaseType;
            ...
            : allocator_reference<RawAllocator>(deleter.get_allocator()),
              ...
              derived_alignment_(alignof(T))
            {
                BOOSTER_FOONATHAN_MEMORY_ASSERT(std::size_t(derived_size_) == sizeof(T)
...
#endif //BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_DELETER_HPP_INCLUDED
