...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_ALLOCATOR_STORAGE_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_ALLOCATOR_STORAGE_HPP_INCLUDED

/// \file
/// Class template \ref booster_foonathan::memory::allocator_storage, some policies and resulting typedefs.
...
namespace booster_foonathan
{
    namespace memory
    {
        namespace detail
        {
            ...
            {
                BOOSTER_FOONATHAN_MEMORY_UNREACHABLE("Allocator is not compositioning");
                return nullptr;
            }
        ...
        : BOOSTER_FOONATHAN_EBO(StoragePolicy,
        ...
        public:
            ...
            allocator_storage(
                ...
                BOOSTER_FOONATHAN_SFINAE(new storage_policy(
            ...
            BOOSTER_FOONATHAN_ENABLE_IF(composable::value)
            void* try_allocate_node(std::size_t size, std::size_t alignment) noexcept
            {
                BOOSTER_FOONATHAN_MEMORY_ASSERT(is_composable());
                std::lock_guard<actual_mutex> lock(*this);
                auto&&                        alloc = get_allocator();
            ...
            auto lock() noexcept -> BOOSTER_FOONATHAN_IMPL_DEFINED(decltype(detail::lock_allocator(
            ...
            auto lock() const noexcept -> BOOSTER_FOONATHAN_IMPL_DEFINED(decltype(detail::lock_allocator(
        ...
        class direct_storage : BOOSTER_FOONATHAN_EBO(allocator_traits<RawAllocator>::allocator_type)
        {
        ...
        /// \ingroup storage
        template <class RawAllocator>
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(allocator_adapter,
...
/// \ingroup storage
        ...
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(thread_safe_allocator,
        ...
        namespace detail
        {
            ...
            protected:
                ...
                {
                    BOOSTER_FOONATHAN_MEMORY_ASSERT(alloc_ != nullptr);
                    return *alloc_;
                }
...
#ifndef DOXYGEN
        : BOOSTER_FOONATHAN_EBO(detail::reference_storage_impl<
        ...
        public:
            using allocator_type = BOOSTER_FOONATHAN_IMPL_DEFINED(base_allocator);
            ...
            reference_storage(
                ...
                BOOSTER_FOONATHAN_REQUIRES(!allocator_traits<RawAllocator>::is_stateful::value)) noexcept
            {
                static_assert(sizeof(basic_allocator<RawAllocator>)
                                  <= sizeof(basic_allocator<default_instantiation>),
                              "requires all instantiations to have certain maximum size");
            ...
            reference_storage(const BOOSTER_FOONATHAN_IMPL_DEFINED(base_allocator) & alloc) noexcept
            {
            ...
            /// Has the same effect as if the actual stored allocator were passed to the other constructor overloads.
            /// \note This constructor is used internally to avoid double-nesting.
            reference_storage(BOOSTER_FOONATHAN_IMPL_DEFINED(base_allocator) & alloc) noexcept
        ...
        /// \ingroup storage
        template <class RawAllocator>
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(allocator_reference,
...
#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_ALLOCATOR_STORAGE_HPP_INCLUDED
