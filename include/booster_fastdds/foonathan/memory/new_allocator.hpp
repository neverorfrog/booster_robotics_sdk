...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_NEW_ALLOCATOR_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_NEW_ALLOCATOR_HPP_INCLUDED

/// \file
/// Class \ref booster_foonathan::memory::new_allocator.
...
namespace booster_foonathan
{
    namespace memory
    {
        ...
        namespace detail
        {
            ...
            BOOSTER_FOONATHAN_MEMORY_LL_ALLOCATOR_LEAK_CHECKER(new_allocator_impl,
        ...
        /// \ingroup allocator
        using new_allocator =
            BOOSTER_FOONATHAN_IMPL_DEFINED(detail::lowlevel_allocator<detail::new_allocator_impl>);
...
#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_NEW_ALLOCATOR_HPP_INCLUDED
