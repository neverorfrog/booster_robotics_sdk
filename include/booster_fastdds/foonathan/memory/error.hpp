...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_ERROR_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_ERROR_HPP_INCLUDED
...
namespace booster_foonathan
{
    namespace memory
    {
        ...
        /// \note Most checks will only be done if \ref BOOSTER_FOONATHAN_MEMORY_CHECK_ALLOCATION_SIZE is \c true.
        /// \ingroup core
        ...
        namespace detail
        {
            ...
            {
#if BOOSTER_FOONATHAN_MEMORY_CHECK_ALLOCATION_SIZE
                auto supported = f();
                if (passed > supported)
                    BOOSTER_FOONATHAN_THROW(Ex(info, passed, supported));
#else
                (void)passed;
                (void)f;
                (void)info;
...
#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_ERROR_HPP_INCLUDED
