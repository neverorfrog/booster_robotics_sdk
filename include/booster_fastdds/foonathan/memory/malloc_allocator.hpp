...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_MALLOC_ALLOCATOR_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_MALLOC_ALLOCATOR_HPP_INCLUDED

/// \file
/// Class \ref booster_foonathan::memory::malloc_allocator.
...
namespace booster_foonathan
{
    namespace memory
    {
        ...
        namespace detail
        {
            ...
            BOOSTER_FOONATHAN_MEMORY_LL_ALLOCATOR_LEAK_CHECKER(malloc_allocator_impl,
        ...
        using malloc_allocator =
            BOOSTER_FOONATHAN_IMPL_DEFINED(detail::lowlevel_allocator<detail::malloc_allocator_impl>);
...
#endif //BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_MALLOC_ALLOCATOR_HPP_INCLUDED
