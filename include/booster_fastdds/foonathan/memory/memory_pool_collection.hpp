...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_MEMORY_POOL_COLLECTION_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_MEMORY_POOL_COLLECTION_HPP_INCLUDED

/// \file
/// Class \ref booster_foonathan::memory::memory_pool_collection and related classes.
...
namespace booster_foonathan
{
    namespace memory
    {
        ...
        : BOOSTER_FOONATHAN_EBO(detail::default_leak_checker<detail::memory_pool_collection_leak_handler>)
        {
        ...
        public:
            ...
            void* allocate_node(std::size_t node_size)
            {
                ...
                BOOSTER_FOONATHAN_MEMORY_ASSERT(mem);
                return mem;
            }
            ...
            {
                BOOSTER_FOONATHAN_MEMORY_ASSERT_MSG(node_size <= max_node_size(), "node_size too big");
                auto& pool = pools_.get(node_size);
        ...
        private:
            ...
            {
                return {BOOSTER_FOONATHAN_MEMORY_LOG_PREFIX "::memory_pool_collection", this};
            }
        ...
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(bucket_allocator,
...
#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_MEMORY_POOL_COLLECTION_HPP_INCLUDED
