...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_SMART_PTR_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_SMART_PTR_HPP_INCLUDED
...
namespace booster_foonathan
{
    namespace memory
    {
        ...
        /// \ingroup adapter
        template <typename T, class RawAllocator>
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(unique_ptr,
                                 std::unique_ptr<T, allocator_deleter<T, RawAllocator>>);
        ...
        /// \ingroup adapter
        template <typename T, class RawAllocator, typename... Args>
        auto allocate_unique(RawAllocator&& alloc, Args&&... args) -> BOOSTER_FOONATHAN_REQUIRES_RET(
        ...
        auto allocate_unique(any_allocator, RawAllocator&& alloc, Args&&... args)
            -> BOOSTER_FOONATHAN_REQUIRES_RET(!std::is_array<T>::value,
        ...
        /// \ingroup adapter
        template <typename T, class RawAllocator>
        auto allocate_unique(RawAllocator&& alloc, std::size_t size) -> BOOSTER_FOONATHAN_REQUIRES_RET(
            std::is_array<T>::value,
            std::unique_ptr<T, allocator_deleter<T, typename std::decay<RawAllocator>::type>>)
        {
...
#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_SMART_PTR_HPP_INCLUDED
