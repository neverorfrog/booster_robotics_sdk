...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_DETAIL_ALIGN_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_DETAIL_ALIGN_HPP_INCLUDED
...
namespace booster_foonathan
{
    namespace memory
    {
        namespace detail
        {
            ...
            {
                BOOSTER_FOONATHAN_MEMORY_ASSERT(is_valid_alignment(alignment));
...
#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_DETAIL_ALIGN_HPP_INCLUDED
