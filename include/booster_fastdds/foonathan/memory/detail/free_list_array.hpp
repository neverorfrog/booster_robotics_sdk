...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_DETAIL_FREE_LIST_ARRAY_HPP
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_DETAIL_FREE_LIST_ARRAY_HPP
        ...
        namespace detail
        {
            ...
            public:
                ...
                : no_elements_(AccessPolicy::index_from_size(max_node_size) - min_size_index + 1)
                {
                    ...
                    BOOSTER_FOONATHAN_MEMORY_ASSERT_MSG(array_, "insufficient memory for free lists");
...
#endif //BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_DETAIL_FREE_LIST_ARRAY_HPP
