...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_DETAIL_LOWLEVEL_ALLOCATOR_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_DETAIL_LOWLEVEL_ALLOCATOR_HPP_INCLUDED
        ...
        namespace detail
        {
            ...
            public:
                ...
                void* allocate_node(std::size_t size, std::size_t alignment)
                {
                    ...
                    if (!memory)
                        BOOSTER_FOONATHAN_THROW(out_of_memory(Functor::info(), actual_size));
...
#define BOOSTER_FOONATHAN_MEMORY_LL_ALLOCATOR_LEAK_CHECKER(functor, var_name)                              \
    BOOSTER_FOONATHAN_MEMORY_GLOBAL_LEAK_CHECKER(lowlevel_allocator_leak_handler<functor>, var_name)
        } // namespace detail
    }     // namespace memory
} // namespace booster_foonathan

#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_DETAIL_LOWLEVEL_ALLOCATOR_HPP_INCLUDED
