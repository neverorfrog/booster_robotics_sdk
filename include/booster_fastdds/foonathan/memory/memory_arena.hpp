...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_MEMORY_ARENA_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_MEMORY_ARENA_HPP_INCLUDED

/// \file
/// Class \ref booster_foonathan::memory::memory_arena and related functionality regarding \concept{concept_blockallocator,BlockAllocators}.
    ...
    namespace memory
    {
        ...
        namespace detail
        {
            ...
            std::true_type is_block_allocator_impl(
                int,
                BOOSTER_FOONATHAN_SFINAE(std::declval<memory_block&>() =
                                     std::declval<BlockAllocator&>().allocate_block()),
                BOOSTER_FOONATHAN_SFINAE(std::declval<std::size_t&>() =
                                     std::declval<BlockAllocator&>().next_block_size()),
                BOOSTER_FOONATHAN_SFINAE(std::declval<BlockAllocator>().deallocate_block(memory_block{})));
        ...
        namespace detail
        {
            ...
            public:
                ...
                {
                    BOOSTER_FOONATHAN_MEMORY_ASSERT(head_);
        ...
        /// \ingroup core
        template <class BlockAllocator, bool Cached /* = true */>
        class memory_arena : BOOSTER_FOONATHAN_EBO(BlockAllocator),
                             BOOSTER_FOONATHAN_EBO(detail::memory_arena_cache<Cached>)
        {
        ...
        public:
            ...
            {
                BOOSTER_FOONATHAN_MEMORY_ASSERT(block_size > min_block_size(0));
            }
...
#if BOOSTER_FOONATHAN_MEMORY_EXTERN_TEMPLATE
        ...
        : BOOSTER_FOONATHAN_EBO(allocator_traits<RawAllocator>::allocator_type)
        {
        ...
        class fixed_block_allocator : BOOSTER_FOONATHAN_EBO(allocator_traits<RawAllocator>::allocator_type)
        {
            using traits = allocator_traits<RawAllocator>;
        ...
        public:
            ...
            memory_block allocate_block()
            {
                ...
                BOOSTER_FOONATHAN_THROW(out_of_fixed_memory(info(), block_size_));
            }
        ...
        private:
            ...
            {
                return {BOOSTER_FOONATHAN_MEMORY_LOG_PREFIX "::fixed_block_allocator", this};
            }
        ...
        using make_block_allocator_t = BOOSTER_FOONATHAN_IMPL_DEFINED(
...
#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_MEMORY_ARENA_HPP_INCLUDED
