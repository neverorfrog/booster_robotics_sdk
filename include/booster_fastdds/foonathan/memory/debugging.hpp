...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_DEBUGGING_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_DEBUGGING_HPP_INCLUDED
...
namespace booster_foonathan
{
    namespace memory
    {
        ...
        /// If \ref BOOSTER_FOONATHAN_MEMORY_DEBUG_FILL is \c true, memory will be filled to help detect use-after-free or missing initialization errors.
        ...
        enum class debug_magic : unsigned char
        {
            ...
            /// The option \ref BOOSTER_FOONATHAN_MEMORY_DEBUG_FENCE controls the size of a memory fence that will be placed before or after a memory block.
            /// It helps catching buffer overflows.
            fence_memory = 0xFD
        };

        /// The type of the handler called when a memory leak is detected.
        /// Leak checking can be controlled via the option \ref BOOSTER_FOONATHAN_MEMORY_DEBUG_LEAK_CHECK
        ...
        /// Pointer checking can be controlled via the options \ref BOOSTER_FOONATHAN_MEMORY_DEBUG_POINTER_CHECK and \ref BOOSTER_FOONATHAN_MEMORY_DEBUG_DOUBLE_DEALLOC_CHECK.
        ...
        /// If \ref BOOSTER_FOONATHAN_MEMORY_DEBUG_FILL is \c true and \ref BOOSTER_FOONATHAN_MEMORY_DEBUG_FENCE has a non-zero value
...
#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_DEBUGGING_HPP_INCLUDED
