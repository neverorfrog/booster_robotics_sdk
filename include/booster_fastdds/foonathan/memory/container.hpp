...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_CONTAINER_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_CONTAINER_HPP_INCLUDED
...
namespace booster_foonathan
{
    namespace memory
    {
        ...
        /// RawAllocator wrapped in a \ref booster_foonathan::memory::std_allocator.
        template <typename T, class RawAllocator>
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(vector, std::vector<T, std_allocator<T, RawAllocator>>);

        /// Same as above but uses \c std::scoped_allocator_adaptor so the allocator is inherited by all
        /// nested containers.
        template <typename T, class RawAllocator>
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(
            vector_scoped_alloc,
            std::vector<T, std::scoped_allocator_adaptor<std_allocator<T, RawAllocator>>>);

        /// \copydoc vector
        template <typename T, class RawAllocator>
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(deque, std::deque<T, std_allocator<T, RawAllocator>>);
        ...
        /// \copydoc vector
        template <typename T, class RawAllocator>
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(list, std::list<T, std_allocator<T, RawAllocator>>);
        /// \copydoc vector_scoped_alloc
        template <typename T, class RawAllocator>
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(
            list_scoped_alloc,
        ...
        /// \copydoc vector
        template <typename T, class RawAllocator>
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(forward_list,
        ...
        /// \copydoc vector
        template <typename T, class RawAllocator>
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(set, std::set<T, std::less<T>, std_allocator<T, RawAllocator>>);
        /// \copydoc vector_scoped_alloc
        template <typename T, class RawAllocator>
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(
            set_scoped_alloc,
        ...
        /// \copydoc vector
        template <typename T, class RawAllocator>
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(multiset,
        ...
        /// \copydoc vector
        template <typename T, class RawAllocator>
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(unordered_multiset,
        ...
        /// \copydoc vector
        template <typename T, class RawAllocator>
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(stack, std::stack<T, deque<T, RawAllocator>>);
        /// \copydoc vector_scoped_alloc
        template <typename T, class RawAllocator>
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(stack_scoped_alloc,
                                 std::stack<T, deque_scoped_alloc<T, RawAllocator>>);

        /// \copydoc vector
        template <typename T, class RawAllocator>
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(queue, std::queue<T, deque<T, RawAllocator>>);
        /// \copydoc vector_scoped_alloc
        template <typename T, class RawAllocator>
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(queue_scoped_alloc,
                                 std::queue<T, deque_scoped_alloc<T, RawAllocator>>);

        /// \copydoc vector
        template <typename T, class RawAllocator>
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(priority_queue, std::priority_queue<T, deque<T, RawAllocator>>);
        /// \copydoc vector_scoped_alloc
        template <typename T, class RawAllocator>
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(priority_queue_scoped_alloc,
...
#if !defined(BOOSTER_FOONATHAN_MEMORY_NO_NODE_SIZE)
        /// \exclude
        namespace detail
        {
...
#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_CONTAINER_HPP_INCLUDED
