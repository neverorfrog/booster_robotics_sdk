...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_TEMPORARY_ALLOCATOR_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_TEMPORARY_ALLOCATOR_HPP_INCLUDED

/// \file
/// Class \ref booster_foonathan::memory::temporary_allocator and related functions.

#include "config.hpp"
#include "memory_stack.hpp"

#if BOOSTER_FOONATHAN_MEMORY_TEMPORARY_STACK_MODE >= 2
#include <atomic>
#endif
...
namespace booster_foonathan
{
    namespace memory
    {
        ...
        /// \ingroup allocator
        class temporary_stack : BOOSTER_FOONATHAN_EBO(detail::temporary_stack_list_node)
        {
        public:
        ...
        /// \note If `BOOSTER_FOONATHAN_MEMORY_TEMPORARY_STACK_MODE == 2`, it is not necessary to use this class,
        ...
        /// \note If `BOOSTER_FOONATHAN_MEMORY_TEMPORARY_STACK_MODE == 0`, the use of this class has no effect,
        ...
        public:
            ...
            /// \note If `BOOSTER_FOONATHAN_MEMORY_TEMPORARY_STACK_MODE == 0`, this function has no effect.
            ...
            /// \requires `initial_size` must not be `0` if `BOOSTER_FOONATHAN_MEMORY_TEMPORARY_STACK_MODE != 0`.
            /// \note If `BOOSTER_FOONATHAN_MEMORY_TEMPORARY_STACK_MODE == 0`, this function will issue a warning in debug mode.
        ...
        /// \requires There must be a per-thread temporary stack (\ref BOOSTER_FOONATHAN_MEMORY_TEMPORARY_STACK_MODE must not be equal to `0`).
        /// \note If \ref BOOSTER_FOONATHAN_MEMORY_TEMPORARY_STACK_MODE is equal to `1`,
        ...
        public:
                                       ...
                                       std::size_t alignment)
            {
                detail::check_allocation_size<bad_node_size>(size,
                                                             ...
                                                             {BOOSTER_FOONATHAN_MEMORY_LOG_PREFIX
                                                              "::temporary_allocator",
                                                              &state});
...
#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_TEMPORARY_ALLOCATOR_HPP_INCLUDED
