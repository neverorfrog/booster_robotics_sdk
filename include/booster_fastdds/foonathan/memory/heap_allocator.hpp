...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_HEAP_ALLOCATOR_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_HEAP_ALLOCATOR_HPP_INCLUDED

/// \file
/// Class \ref booster_foonathan::memory::heap_allocator and related functions.
...
namespace booster_foonathan
{
    namespace memory
    {
        ...
        namespace detail
        {
            ...
            BOOSTER_FOONATHAN_MEMORY_LL_ALLOCATOR_LEAK_CHECKER(heap_allocator_impl,
        ...
        using heap_allocator =
            BOOSTER_FOONATHAN_IMPL_DEFINED(detail::lowlevel_allocator<detail::heap_allocator_impl>);
...
#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_HEAP_ALLOCATOR_HPP_INCLUDED
