...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_STD_ALLOCATOR_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_STD_ALLOCATOR_HPP_INCLUDED

/// \file
/// Class \ref booster_foonathan::memory::std_allocator and related classes and functions.
...
namespace booster_foonathan
{
    namespace memory
    {
        ...
        class std_allocator :
            ...
            BOOSTER_FOONATHAN_EBO(protected allocator_reference<RawAllocator>)
#else
        ...
        public:
            ...
            template <
                ...
                BOOSTER_FOONATHAN_REQUIRES((!std::is_base_of<std_allocator, RawAlloc>::value))>
            std_allocator(RawAlloc& alloc,
                          BOOSTER_FOONATHAN_SFINAE(alloc_reference(std::declval<RawAlloc&>()))) noexcept
            ...
            template <
                ...
                // use this to prevent this constructor being chosen instead of move/copy for types inheriting from it
                BOOSTER_FOONATHAN_REQUIRES((!std::is_base_of<std_allocator, RawAlloc>::value))>
            std_allocator(const RawAlloc& alloc, BOOSTER_FOONATHAN_SFINAE(alloc_reference(
        ...
        /// \ingroup adapter
        template <typename T>
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(any_std_allocator, std_allocator<T, any_allocator>);
...
#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_STD_ALLOCATOR_HPP_INCLUDED
