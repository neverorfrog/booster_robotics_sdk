...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_MEMORY_RESOURCE_ADAPTER_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_MEMORY_RESOURCE_ADAPTER_HPP_INCLUDED

/// \file
/// Class \ref booster_foonathan::memory::memory_resource_adapter and \ref booster_foonathan::memory::memory_resource_allocator to allow usage of PMRs.
...
namespace booster_foonathan_memory_pmr = std::pmr;

#elif defined(__cpp_lib_experimental_memory_resources)

// We use std::experimental::pmr::memory_resource.
namespace booster_foonathan_memory_pmr = std::experimental::pmr;

#else

// We use our own implementation.
namespace booster_foonathan_memory_pmr
{
...
namespace booster_foonathan
{
    namespace memory
    {
        ...
        /// \ingroup adapter
        BOOSTER_FOONATHAN_ALIAS_TEMPLATE(memory_resource, foonathan_memory_pmr::memory_resource);
        ...
        public:
            ...
            {
                BOOSTER_FOONATHAN_MEMORY_ASSERT(ptr);
            }
...
#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_MEMORY_RESOURCE_ADAPTER_HPP_INCLUDED
