...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_ALIGNED_ALLOCATOR_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_ALIGNED_ALLOCATOR_HPP_INCLUDED

/// \file
/// Class \ref booster_foonathan::memory::aligned_allocator and related functions.
...
namespace booster_foonathan
{
    namespace memory
    {
        ...
        class aligned_allocator : BOOSTER_FOONATHAN_EBO(allocator_traits<RawAllocator>::allocator_type)
        {
        ...
        public:
            ...
            {
                BOOSTER_FOONATHAN_MEMORY_ASSERT(min_alignment_ <= max_alignment());
            }
            ...
            {
                BOOSTER_FOONATHAN_MEMORY_ASSERT(min_alignment <= max_alignment());
...
#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_ALIGNED_ALLOCATOR_HPP_INCLUDED
