...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_TRACKING_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_TRACKING_HPP_INCLUDED

/// \file
/// Class \ref booster_foonathan::memory::tracked_allocator and related classes and functions.
...
namespace booster_foonathan
{
    namespace memory
    {
        namespace detail
        {
            ...
            class deeply_tracked_block_allocator : BOOSTER_FOONATHAN_EBO(BlockAllocator)
            {
            public:
        ...
        : BOOSTER_FOONATHAN_EBO(Tracker, make_block_allocator_t<BlockOrRawAllocator>)
        {
        public:
        ...
        /// \ingroup adapter
        template <class Tracker, class BlockOrRawAllocator>
        using deeply_tracked_block_allocator = BOOSTER_FOONATHAN_IMPL_DEFINED(
        ...
        : BOOSTER_FOONATHAN_EBO(Tracker, allocator_traits<RawAllocator>::allocator_type)
        {
...
#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_TRACKING_HPP_INCLUDED
