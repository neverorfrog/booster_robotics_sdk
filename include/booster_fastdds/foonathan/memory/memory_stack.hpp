...
#ifndef BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_MEMORY_STACK_HPP_INCLUDED
#define BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_MEMORY_STACK_HPP_INCLUDED

/// \file
/// Class \ref booster_foonathan::memory::memory_stack and its \ref booster_foonathan::memory::allocator_traits specialization.

// Inform that booster_foonathan::memory::memory_stack::min_block_size API is available
#define BOOSTER_FOONATHAN_MEMORY_MEMORY_STACK_HAS_MIN_BLOCK_SIZE
...
namespace booster_foonathan
{
    namespace memory
    {
            ...
            class stack_marker
            {
                ...
                friend bool operator==(const stack_marker& lhs, const stack_marker& rhs) noexcept
                {
                    if (lhs.index != rhs.index)
                        return false;
                    BOOSTER_FOONATHAN_MEMORY_ASSERT_MSG(lhs.end == rhs.end, "you must not compare two "
        ...
        class memory_stack
        : BOOSTER_FOONATHAN_EBO(detail::default_leak_checker<detail::memory_stack_leak_handler>)
        {
        public:
            ...
            using marker = BOOSTER_FOONATHAN_IMPL_DEFINED(detail::stack_marker);
            ...
            {
                BOOSTER_FOONATHAN_MEMORY_ASSERT(m <= top());
        ...
        private:
            ...
            {
                return {BOOSTER_FOONATHAN_MEMORY_LOG_PREFIX "::memory_stack", this};
            }
        ...
        /// like a \ref booster_foonathan::memory::memory_stack
        /// \ingroup allocator
        ...
        public:
            ...
            {
                BOOSTER_FOONATHAN_MEMORY_ASSERT(will_unwind());
                stack_->unwind(marker_);
            }
...
#endif // BOOSTER_FASTDDS_BOOSTER_FOONATHAN_MEMORY_MEMORY_STACK_HPP_INCLUDED
